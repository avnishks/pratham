...
static SFc13_adcs_v15_integral_Power_nom_no_charge_in_detumbInstanceStruct
  chartInstance;

/* Function Declarations */
static void initialize_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb(void);
static void
  initialize_params_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb(void);
static void enable_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb(void);
static void disable_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb(void);
static void c13_update_debugger_state_c13_adcs_v15_integral_Power_nom_no_ch(void);
static void ext_mode_exec_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (void);
static const mxArray
  *get_sim_state_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb(void);
static void set_sim_state_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb(
  const mxArray *c13_st);
static void finalize_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb(void);
static void sf_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb(void);
static void c13_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb(void);
...
static void initialize_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb(void)
{
  uint8_T *c13_is_active_c13_adcs_v15_integral_Power_nom_no_charge_in_detu;
  c13_is_active_c13_adcs_v15_integral_Power_nom_no_charge_in_detu = (uint8_T *)
    ssGetDWork(chartInstance.S, 2);
  _sfTime_ = (real_T)ssGetT(chartInstance.S);
  *c13_is_active_c13_adcs_v15_integral_Power_nom_no_charge_in_detu = 0U;
}
...
static void ext_mode_exec_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (void)
{
  c13_update_debugger_state_c13_adcs_v15_integral_Power_nom_no_ch();
}
  ...
  *get_sim_state_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb(void)
{
  ...
  c13_e_u = *c13_is_active_c13_adcs_v15_integral_Power_nom_no_charge_in_detu;
  c13_f_y = NULL;
  ...
  const mxArray *c13_st)
{
  ...
  real_T c13_d_y[3];
  int32_T c13_i14;
  const mxArray *c13_is_active_c13_adcs_v15_integral_Power_nom_no_charge_in_detu;
  uint8_T c13_u0;
  uint8_T c13_e_y;
  boolean_T *c13_doneDoubleBufferReInit;
  uint8_T *c13_b_is_active_c13_adcs_v15_integral_Power_nom_no_charge_in_de;
  real_T (*c13_e_eu)[3];
  real_T (*c13_ieu)[3];
  real_T (*c13_m)[3];
  real_T (*c13_m_N)[3];
  ...
  c13_ieu = (real_T (*)[3])ssGetOutputPortSignal(chartInstance.S, 1);
  c13_b_is_active_c13_adcs_v15_integral_Power_nom_no_charge_in_de = (uint8_T *)
    ssGetDWork(chartInstance.S, 2);
  c13_m = (real_T (*)[3])ssGetOutputPortSignal(chartInstance.S, 3);
  *c13_doneDoubleBufferReInit = true;
  ...
  c13_is_active_c13_adcs_v15_integral_Power_nom_no_charge_in_detu = sf_mex_dup
    (sf_mex_getcell(c13_u, 4));
  sf_mex_import("is_active_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb",
                sf_mex_dup(
    c13_is_active_c13_adcs_v15_integral_Power_nom_no_charge_in_detu), &c13_u0, 1,
                3, 0U, 0, 0U, 0);
  c13_e_y = c13_u0;
  sf_mex_destroy
    (&c13_is_active_c13_adcs_v15_integral_Power_nom_no_charge_in_detu);
  *c13_b_is_active_c13_adcs_v15_integral_Power_nom_no_charge_in_de = c13_e_y;
...
static void sf_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb(void)
{
  ...
  c13_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb();
...
static void c13_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb(void)
{
  ...
  real_T c13_b_Kd[9] = { 4.5140285315801179E-004, -2.8279830341479114E-006,
    -2.3825309814796236E-006, -2.8279830341479114E-006,
    4.5544946416101032E-004, -9.5703935751105649E-006, -2.3825309814796236E-006,
    -9.5703935751105649E-006,
    4.2090941916178554E-004 };

  real_T c13_b_Kp[9] = { 2.3197473299597561E-007, -1.4532930057355512E-009,
    -1.2243763733808510E-009, -1.4532930057355512E-009,
    2.3405427569357250E-007, -4.9181999597940945E-009, -1.2243763733808510E-009,
    -4.9181999597940945E-009,
  ...
  real_T c13_f_b[3];
  int32_T c13_i58;
  static real_T c13_dv7[9] = { 4.5140285315801179E-004, -2.8279830341479114E-006,
    -2.3825309814796236E-006, -2.8279830341479114E-006,
    4.5544946416101032E-004, -9.5703935751105649E-006, -2.3825309814796236E-006,
    -9.5703935751105649E-006,
    4.2090941916178554E-004 };
  ...
  static real_T c13_dv11[9] = { 2.3197473299597561E-007,
    -1.4532930057355512E-009, -1.2243763733808510E-009, -1.4532930057355512E-009
    , 2.3405427569357250E-007, -4.9181999597940945E-009,
    -1.2243763733808510E-009,
    -4.9181999597940945E-009, 2.1630423787190323E-007 };
...
/* SFunction Glue Code */
void sf_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb_get_check_sum
  (mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1542409855U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(514812196U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3640456181U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1198074267U);
}
  ...
  (void)
{
...

  {
    ...
    pr[0] = (double)(503784782U);
    pr[1] = (double)(4068396584U);
    pr[2] = (double)(4065264741U);
    pr[3] = (double)(2920328456U);
...
static mxArray
  *sf_get_sim_state_info_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (void)
{
  ...
  char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[16],T\"eu\",},{M[1],M[22],T\"ieu\",},{M[1],M[15],T\"m\",},{M[1],M[5],T\"m_N\",},{M[8],M[0],T\"is_active_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb\",}}"
  };
...
static void
  sf_opaque_initialize_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb(void *
  chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb();
  initialize_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb();
}

static void sf_opaque_enable_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (void *chartInstanceVar)
{
  enable_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb();
}

static void
  sf_opaque_disable_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb(void
  *chartInstanceVar)
{
  disable_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb();
}

static void
  sf_opaque_gateway_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb(void
  *chartInstanceVar)
{
  sf_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb();
}

static void
  sf_opaque_ext_mode_exec_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (void *chartInstanceVar)
{
  ext_mode_exec_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb();
}

static mxArray*
  sf_opaque_get_sim_state_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (void *chartInstanceVar)
{
  mxArray *st = (mxArray *)
    get_sim_state_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb();
  return st;
}

static void
  sf_opaque_set_sim_state_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (void *chartInstanceVar, const mxArray *st)
{
  set_sim_state_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb(sf_mex_dup
    (st));
}

static void
  sf_opaque_terminate_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb(void
  *chartInstanceVar)
{
  ...
  finalize_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb();
}

extern unsigned int sf_machine_global_initializer_called(void);
static void
  mdlProcessParameters_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      ...
      "adcs_v15_integral_Power_nom_no_charge_in_detumb",13);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(
                "adcs_v15_integral_Power_nom_no_charge_in_detumb",
                "adcs_v15_integral_Power_nom_no_charge_in_detumb",13,"RTWCG"));
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,
        "adcs_v15_integral_Power_nom_no_charge_in_detumb",
        "adcs_v15_integral_Power_nom_no_charge_in_detumb",13,5);
      sf_mark_chart_reusable_outputs(S,
        "adcs_v15_integral_Power_nom_no_charge_in_detumb",
        "adcs_v15_integral_Power_nom_no_charge_in_detumb",13,4);
    }
  ...
  ssSetChecksum0(S,(491574259U));
  ssSetChecksum1(S,(1883868563U));
  ssSetChecksum2(S,(3414737931U));
  ssSetChecksum3(S,(3778889178U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb(SimStruct
  *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (SimStruct *S)
{
  ...
  chartInstance.chartInfo.sFunctionGateway =
    sf_opaque_gateway_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb;
  chartInstance.chartInfo.initializeChart =
    sf_opaque_initialize_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb;
  chartInstance.chartInfo.terminateChart =
    sf_opaque_terminate_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb;
  chartInstance.chartInfo.enableChart =
    sf_opaque_enable_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb;
  chartInstance.chartInfo.disableChart =
    sf_opaque_disable_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb;
  ...
  chartInstance.chartInfo.mdlRTW =
    mdlRTW_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb;
  chartInstance.chartInfo.mdlStart =
    mdlStart_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb;
  chartInstance.chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb;
...
void c13_adcs_v15_integral_Power_nom_no_charge_in_detumb_method_dispatcher
  (SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c13_adcs_v15_integral_Power_nom_no_charge_in_detumb_method_dispatcher.\n"

...
static SFc20_adcs_v15_integral_Power_nom_no_charge_in_detumbInstanceStruct
  chartInstance;

/* Function Declarations */
static void initialize_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb(void);
static void
  initialize_params_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb(void);
static void enable_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb(void);
static void disable_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb(void);
static void c20_update_debugger_state_c20_adcs_v15_integral_Power_nom_no_ch(void);
static void ext_mode_exec_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (void);
static const mxArray
  *get_sim_state_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb(void);
static void set_sim_state_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb(
  const mxArray *c20_st);
static void finalize_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb(void);
static void sf_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb(void);
static void c20_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb(void);
...
static void initialize_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb(void)
{
  uint8_T *c20_is_active_c20_adcs_v15_integral_Power_nom_no_charge_in_detu;
  c20_is_active_c20_adcs_v15_integral_Power_nom_no_charge_in_detu = (uint8_T *)
    ssGetDWork(chartInstance.S, 2);
  _sfTime_ = (real_T)ssGetT(chartInstance.S);
  *c20_is_active_c20_adcs_v15_integral_Power_nom_no_charge_in_detu = 0U;
}
...
static void ext_mode_exec_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (void)
{
  c20_update_debugger_state_c20_adcs_v15_integral_Power_nom_no_ch();
}
  ...
  *get_sim_state_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb(void)
{
  ...
  c20_b_u = *c20_is_active_c20_adcs_v15_integral_Power_nom_no_charge_in_detu;
  c20_c_y = NULL;
  ...
  const mxArray *c20_st)
{
  ...
  real_T c20_y[3];
  int32_T c20_i2;
  const mxArray *c20_is_active_c20_adcs_v15_integral_Power_nom_no_charge_in_detu;
  uint8_T c20_u0;
  uint8_T c20_b_y;
  boolean_T *c20_doneDoubleBufferReInit;
  uint8_T *c20_b_is_active_c20_adcs_v15_integral_Power_nom_no_charge_in_de;
  real_T (*c20_b_v_B)[3];
  c20_b_is_active_c20_adcs_v15_integral_Power_nom_no_charge_in_de = (uint8_T *)
    ssGetDWork(chartInstance.S, 2);
  ...
  *c20_doneDoubleBufferReInit = true;
  ...
  c20_is_active_c20_adcs_v15_integral_Power_nom_no_charge_in_detu = sf_mex_dup
    (sf_mex_getcell(c20_u, 1));
  sf_mex_import("is_active_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb",
                sf_mex_dup(
    c20_is_active_c20_adcs_v15_integral_Power_nom_no_charge_in_detu), &c20_u0, 1,
                3, 0U, 0, 0U, 0);
  c20_b_y = c20_u0;
  sf_mex_destroy
    (&c20_is_active_c20_adcs_v15_integral_Power_nom_no_charge_in_detu);
  *c20_b_is_active_c20_adcs_v15_integral_Power_nom_no_charge_in_de = c20_b_y;
...
static void sf_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb(void)
{
  ...
  c20_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb();
...
/* SFunction Glue Code */
void sf_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb_get_check_sum
  (mxArray *plhs[])
{
...
static mxArray
  *sf_get_sim_state_info_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (void)
{
  ...
  char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"v_B\",},{M[8],M[0],T\"is_active_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb\",}}"
  };
...
static void
  sf_opaque_initialize_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb(void *
  chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb();
  initialize_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb();
}

static void sf_opaque_enable_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (void *chartInstanceVar)
{
  enable_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb();
}

static void
  sf_opaque_disable_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb(void
  *chartInstanceVar)
{
  disable_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb();
}

static void
  sf_opaque_gateway_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb(void
  *chartInstanceVar)
{
  sf_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb();
}

static void
  sf_opaque_ext_mode_exec_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (void *chartInstanceVar)
{
  ext_mode_exec_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb();
}

static mxArray*
  sf_opaque_get_sim_state_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (void *chartInstanceVar)
{
  mxArray *st = (mxArray *)
    get_sim_state_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb();
  return st;
}

static void
  sf_opaque_set_sim_state_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (void *chartInstanceVar, const mxArray *st)
{
  set_sim_state_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb(sf_mex_dup
    (st));
}

static void
  sf_opaque_terminate_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb(void
  *chartInstanceVar)
{
  ...
  finalize_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb();
}

extern unsigned int sf_machine_global_initializer_called(void);
static void
  mdlProcessParameters_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      ...
      "adcs_v15_integral_Power_nom_no_charge_in_detumb",20);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(
                "adcs_v15_integral_Power_nom_no_charge_in_detumb",
                "adcs_v15_integral_Power_nom_no_charge_in_detumb",20,"RTWCG"));
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,
        "adcs_v15_integral_Power_nom_no_charge_in_detumb",
        "adcs_v15_integral_Power_nom_no_charge_in_detumb",20,2);
      sf_mark_chart_reusable_outputs(S,
        "adcs_v15_integral_Power_nom_no_charge_in_detumb",
        "adcs_v15_integral_Power_nom_no_charge_in_detumb",20,1);
    }
...
static void mdlRTW_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb(SimStruct
  *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (SimStruct *S)
{
  ...
  chartInstance.chartInfo.sFunctionGateway =
    sf_opaque_gateway_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb;
  chartInstance.chartInfo.initializeChart =
    sf_opaque_initialize_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb;
  chartInstance.chartInfo.terminateChart =
    sf_opaque_terminate_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb;
  chartInstance.chartInfo.enableChart =
    sf_opaque_enable_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb;
  chartInstance.chartInfo.disableChart =
    sf_opaque_disable_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb;
  ...
  chartInstance.chartInfo.mdlRTW =
    mdlRTW_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb;
  chartInstance.chartInfo.mdlStart =
    mdlStart_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb;
  chartInstance.chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb;
...
void c20_adcs_v15_integral_Power_nom_no_charge_in_detumb_method_dispatcher
  (SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c20_adcs_v15_integral_Power_nom_no_charge_in_detumb_method_dispatcher.\n"

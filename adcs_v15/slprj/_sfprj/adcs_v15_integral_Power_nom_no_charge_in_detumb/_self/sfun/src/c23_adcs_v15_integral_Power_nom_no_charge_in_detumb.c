...
static SFc23_adcs_v15_integral_Power_nom_no_charge_in_detumbInstanceStruct
  chartInstance;

/* Function Declarations */
static void initialize_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb(void);
static void
  initialize_params_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb(void);
static void enable_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb(void);
static void disable_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb(void);
static void c23_update_debugger_state_c23_adcs_v15_integral_Power_nom_no_ch(void);
static void ext_mode_exec_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (void);
static const mxArray
  *get_sim_state_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb(void);
static void set_sim_state_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb(
  const mxArray *c23_st);
static void finalize_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb(void);
static void sf_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb(void);
static void c23_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb(void);
...
static void initialize_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb(void)
{
  uint8_T *c23_is_active_c23_adcs_v15_integral_Power_nom_no_charge_in_detu;
  c23_is_active_c23_adcs_v15_integral_Power_nom_no_charge_in_detu = (uint8_T *)
    ssGetDWork(chartInstance.S, 2);
  _sfTime_ = (real_T)ssGetT(chartInstance.S);
  *c23_is_active_c23_adcs_v15_integral_Power_nom_no_charge_in_detu = 0U;
}
...
static void ext_mode_exec_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (void)
{
  c23_update_debugger_state_c23_adcs_v15_integral_Power_nom_no_ch();
}
  ...
  *get_sim_state_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb(void)
{
  ...
  c23_b_u = *c23_is_active_c23_adcs_v15_integral_Power_nom_no_charge_in_detu;
  c23_c_y = NULL;
  ...
  const mxArray *c23_st)
{
  ...
  real_T c23_y[3];
  int32_T c23_i3;
  const mxArray *c23_is_active_c23_adcs_v15_integral_Power_nom_no_charge_in_detu;
  uint8_T c23_u0;
  uint8_T c23_b_y;
  boolean_T *c23_doneDoubleBufferReInit;
  uint8_T *c23_b_is_active_c23_adcs_v15_integral_Power_nom_no_charge_in_de;
  real_T (*c23_b_m_D)[3];
  c23_doneDoubleBufferReInit = (boolean_T *)ssGetDWork(chartInstance.S, 1);
  c23_b_is_active_c23_adcs_v15_integral_Power_nom_no_charge_in_de = (uint8_T *)
    ssGetDWork(chartInstance.S, 2);
  ...
  *c23_doneDoubleBufferReInit = true;
  ...
  c23_is_active_c23_adcs_v15_integral_Power_nom_no_charge_in_detu = sf_mex_dup
    (sf_mex_getcell(c23_u, 1));
  sf_mex_import("is_active_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb",
                sf_mex_dup(
    c23_is_active_c23_adcs_v15_integral_Power_nom_no_charge_in_detu), &c23_u0, 1,
                3, 0U, 0, 0U, 0);
  c23_b_y = c23_u0;
  sf_mex_destroy
    (&c23_is_active_c23_adcs_v15_integral_Power_nom_no_charge_in_detu);
  *c23_b_is_active_c23_adcs_v15_integral_Power_nom_no_charge_in_de = c23_b_y;
...
static void sf_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb(void)
{
  ...
  c23_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb();
...
/* SFunction Glue Code */
void sf_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb_get_check_sum
  (mxArray *plhs[])
{
...
static mxArray
  *sf_get_sim_state_info_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (void)
{
  ...
  char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"m_D\",},{M[8],M[0],T\"is_active_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb\",}}"
  };
...
static void
  sf_opaque_initialize_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb(void *
  chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb();
  initialize_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb();
}

static void sf_opaque_enable_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (void *chartInstanceVar)
{
  enable_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb();
}

static void
  sf_opaque_disable_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb(void
  *chartInstanceVar)
{
  disable_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb();
}

static void
  sf_opaque_gateway_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb(void
  *chartInstanceVar)
{
  sf_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb();
}

static void
  sf_opaque_ext_mode_exec_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (void *chartInstanceVar)
{
  ext_mode_exec_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb();
}

static mxArray*
  sf_opaque_get_sim_state_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (void *chartInstanceVar)
{
  mxArray *st = (mxArray *)
    get_sim_state_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb();
  return st;
}

static void
  sf_opaque_set_sim_state_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (void *chartInstanceVar, const mxArray *st)
{
  set_sim_state_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb(sf_mex_dup
    (st));
}

static void
  sf_opaque_terminate_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb(void
  *chartInstanceVar)
{
  ...
  finalize_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb();
}

extern unsigned int sf_machine_global_initializer_called(void);
static void
  mdlProcessParameters_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      ...
      "adcs_v15_integral_Power_nom_no_charge_in_detumb",23);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(
                "adcs_v15_integral_Power_nom_no_charge_in_detumb",
                "adcs_v15_integral_Power_nom_no_charge_in_detumb",23,"RTWCG"));
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,
        "adcs_v15_integral_Power_nom_no_charge_in_detumb",
        "adcs_v15_integral_Power_nom_no_charge_in_detumb",23,2);
      sf_mark_chart_reusable_outputs(S,
        "adcs_v15_integral_Power_nom_no_charge_in_detumb",
        "adcs_v15_integral_Power_nom_no_charge_in_detumb",23,1);
    }
...
static void mdlRTW_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb(SimStruct
  *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (SimStruct *S)
{
  ...
  chartInstance.chartInfo.sFunctionGateway =
    sf_opaque_gateway_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb;
  chartInstance.chartInfo.initializeChart =
    sf_opaque_initialize_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb;
  chartInstance.chartInfo.terminateChart =
    sf_opaque_terminate_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb;
  chartInstance.chartInfo.enableChart =
    sf_opaque_enable_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb;
  chartInstance.chartInfo.disableChart =
    sf_opaque_disable_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb;
  ...
  chartInstance.chartInfo.mdlRTW =
    mdlRTW_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb;
  chartInstance.chartInfo.mdlStart =
    mdlStart_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb;
  chartInstance.chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb;
...
void c23_adcs_v15_integral_Power_nom_no_charge_in_detumb_method_dispatcher
  (SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c23_adcs_v15_integral_Power_nom_no_charge_in_detumb_method_dispatcher.\n"

...
static SFc10_adcs_v15_integral_Power_nom_no_charge_in_detumbInstanceStruct
  chartInstance;

/* Function Declarations */
static void initialize_c10_adcs_v15_integral_Power_nom_no_charge_in_detumb(void);
static void
  initialize_params_c10_adcs_v15_integral_Power_nom_no_charge_in_detumb(void);
static void enable_c10_adcs_v15_integral_Power_nom_no_charge_in_detumb(void);
static void disable_c10_adcs_v15_integral_Power_nom_no_charge_in_detumb(void);
static void c10_update_debugger_state_c10_adcs_v15_integral_Power_nom_no_ch(void);
static void ext_mode_exec_c10_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (void);
static const mxArray
  *get_sim_state_c10_adcs_v15_integral_Power_nom_no_charge_in_detumb(void);
static void set_sim_state_c10_adcs_v15_integral_Power_nom_no_charge_in_detumb(
  const mxArray *c10_st);
static void finalize_c10_adcs_v15_integral_Power_nom_no_charge_in_detumb(void);
static void sf_c10_adcs_v15_integral_Power_nom_no_charge_in_detumb(void);
...
static void initialize_c10_adcs_v15_integral_Power_nom_no_charge_in_detumb(void)
{
  uint8_T *c10_is_active_c10_adcs_v15_integral_Power_nom_no_charge_in_detu;
  c10_is_active_c10_adcs_v15_integral_Power_nom_no_charge_in_detu = (uint8_T *)
    ssGetDWork(chartInstance.S, 2);
  _sfTime_ = (real_T)ssGetT(chartInstance.S);
  *c10_is_active_c10_adcs_v15_integral_Power_nom_no_charge_in_detu = 0U;
}
...
static void ext_mode_exec_c10_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (void)
{
  c10_update_debugger_state_c10_adcs_v15_integral_Power_nom_no_ch();
}
  ...
  *get_sim_state_c10_adcs_v15_integral_Power_nom_no_charge_in_detumb(void)
{
  ...
  c10_c_u = *c10_is_active_c10_adcs_v15_integral_Power_nom_no_charge_in_detu;
  c10_d_y = NULL;
  ...
  const mxArray *c10_st)
{
  ...
  real_T c10_b_y[3];
  int32_T c10_i5;
  const mxArray *c10_is_active_c10_adcs_v15_integral_Power_nom_no_charge_in_detu;
  uint8_T c10_u0;
  uint8_T c10_c_y;
  boolean_T *c10_doneDoubleBufferReInit;
  uint8_T *c10_b_is_active_c10_adcs_v15_integral_Power_nom_no_charge_in_de;
  real_T (*c10_c_B)[3];
  real_T (*c10_dB)[3];
  c10_c_B = (real_T (*)[3])ssGetOutputPortSignal(chartInstance.S, 1);
  c10_dB = (real_T (*)[3])ssGetOutputPortSignal(chartInstance.S, 2);
  c10_b_is_active_c10_adcs_v15_integral_Power_nom_no_charge_in_de = (uint8_T *)
    ssGetDWork(chartInstance.S, 2);
  ...
  *c10_doneDoubleBufferReInit = true;
  ...
  c10_is_active_c10_adcs_v15_integral_Power_nom_no_charge_in_detu = sf_mex_dup
    (sf_mex_getcell(c10_u, 2));
  sf_mex_import("is_active_c10_adcs_v15_integral_Power_nom_no_charge_in_detumb",
                sf_mex_dup(
    c10_is_active_c10_adcs_v15_integral_Power_nom_no_charge_in_detu), &c10_u0, 1,
                3, 0U, 0, 0U, 0);
  c10_c_y = c10_u0;
  sf_mex_destroy
    (&c10_is_active_c10_adcs_v15_integral_Power_nom_no_charge_in_detu);
  *c10_b_is_active_c10_adcs_v15_integral_Power_nom_no_charge_in_de = c10_c_y;
...
/* SFunction Glue Code */
void sf_c10_adcs_v15_integral_Power_nom_no_charge_in_detumb_get_check_sum
  (mxArray *plhs[])
{
...
static mxArray
  *sf_get_sim_state_info_c10_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (void)
{
  ...
  char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[11],T\"B\",},{M[1],M[5],T\"dB\",},{M[8],M[0],T\"is_active_c10_adcs_v15_integral_Power_nom_no_charge_in_detumb\",}}"
  };
...
static void
  sf_opaque_initialize_c10_adcs_v15_integral_Power_nom_no_charge_in_detumb(void *
  chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c10_adcs_v15_integral_Power_nom_no_charge_in_detumb();
  initialize_c10_adcs_v15_integral_Power_nom_no_charge_in_detumb();
}

static void sf_opaque_enable_c10_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (void *chartInstanceVar)
{
  enable_c10_adcs_v15_integral_Power_nom_no_charge_in_detumb();
}

static void
  sf_opaque_disable_c10_adcs_v15_integral_Power_nom_no_charge_in_detumb(void
  *chartInstanceVar)
{
  disable_c10_adcs_v15_integral_Power_nom_no_charge_in_detumb();
}

static void
  sf_opaque_gateway_c10_adcs_v15_integral_Power_nom_no_charge_in_detumb(void
  *chartInstanceVar)
{
  sf_c10_adcs_v15_integral_Power_nom_no_charge_in_detumb();
}

static void
  sf_opaque_ext_mode_exec_c10_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (void *chartInstanceVar)
{
  ext_mode_exec_c10_adcs_v15_integral_Power_nom_no_charge_in_detumb();
}

static mxArray*
  sf_opaque_get_sim_state_c10_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (void *chartInstanceVar)
{
  mxArray *st = (mxArray *)
    get_sim_state_c10_adcs_v15_integral_Power_nom_no_charge_in_detumb();
  return st;
}

static void
  sf_opaque_set_sim_state_c10_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (void *chartInstanceVar, const mxArray *st)
{
  set_sim_state_c10_adcs_v15_integral_Power_nom_no_charge_in_detumb(sf_mex_dup
    (st));
}

static void
  sf_opaque_terminate_c10_adcs_v15_integral_Power_nom_no_charge_in_detumb(void
  *chartInstanceVar)
{
  ...
  finalize_c10_adcs_v15_integral_Power_nom_no_charge_in_detumb();
}

extern unsigned int sf_machine_global_initializer_called(void);
static void
  mdlProcessParameters_c10_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c10_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      ...
      "adcs_v15_integral_Power_nom_no_charge_in_detumb",10);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(
                "adcs_v15_integral_Power_nom_no_charge_in_detumb",
                "adcs_v15_integral_Power_nom_no_charge_in_detumb",10,"RTWCG"));
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,
        "adcs_v15_integral_Power_nom_no_charge_in_detumb",
        "adcs_v15_integral_Power_nom_no_charge_in_detumb",10,2);
...
static void mdlRTW_c10_adcs_v15_integral_Power_nom_no_charge_in_detumb(SimStruct
  *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c10_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (SimStruct *S)
{
  ...
  chartInstance.chartInfo.sFunctionGateway =
    sf_opaque_gateway_c10_adcs_v15_integral_Power_nom_no_charge_in_detumb;
  chartInstance.chartInfo.initializeChart =
    sf_opaque_initialize_c10_adcs_v15_integral_Power_nom_no_charge_in_detumb;
  chartInstance.chartInfo.terminateChart =
    sf_opaque_terminate_c10_adcs_v15_integral_Power_nom_no_charge_in_detumb;
  chartInstance.chartInfo.enableChart =
    sf_opaque_enable_c10_adcs_v15_integral_Power_nom_no_charge_in_detumb;
  chartInstance.chartInfo.disableChart =
    sf_opaque_disable_c10_adcs_v15_integral_Power_nom_no_charge_in_detumb;
  ...
  chartInstance.chartInfo.mdlRTW =
    mdlRTW_c10_adcs_v15_integral_Power_nom_no_charge_in_detumb;
  chartInstance.chartInfo.mdlStart =
    mdlStart_c10_adcs_v15_integral_Power_nom_no_charge_in_detumb;
  chartInstance.chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c10_adcs_v15_integral_Power_nom_no_charge_in_detumb;
...
void c10_adcs_v15_integral_Power_nom_no_charge_in_detumb_method_dispatcher
  (SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c10_adcs_v15_integral_Power_nom_no_charge_in_detumb(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c10_adcs_v15_integral_Power_nom_no_charge_in_detumb(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c10_adcs_v15_integral_Power_nom_no_charge_in_detumb(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c10_adcs_v15_integral_Power_nom_no_charge_in_detumb_method_dispatcher.\n"

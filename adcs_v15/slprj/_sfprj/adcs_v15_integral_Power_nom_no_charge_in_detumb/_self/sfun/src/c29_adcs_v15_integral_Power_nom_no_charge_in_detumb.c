...
static SFc29_adcs_v15_integral_Power_nom_no_charge_in_detumbInstanceStruct
  chartInstance;

/* Function Declarations */
static void initialize_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb(void);
static void
  initialize_params_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb(void);
static void enable_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb(void);
static void disable_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb(void);
static void c29_update_debugger_state_c29_adcs_v15_integral_Power_nom_no_ch(void);
static void ext_mode_exec_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (void);
static const mxArray
  *get_sim_state_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb(void);
static void set_sim_state_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb(
  const mxArray *c29_st);
static void finalize_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb(void);
static void sf_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb(void);
static void c29_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb(void);
...
static void initialize_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb(void)
{
  uint8_T *c29_is_active_c29_adcs_v15_integral_Power_nom_no_charge_in_detu;
  c29_is_active_c29_adcs_v15_integral_Power_nom_no_charge_in_detu = (uint8_T *)
    ssGetDWork(chartInstance.S, 2);
  _sfTime_ = (real_T)ssGetT(chartInstance.S);
  *c29_is_active_c29_adcs_v15_integral_Power_nom_no_charge_in_detu = 0U;
}
...
static void ext_mode_exec_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (void)
{
  c29_update_debugger_state_c29_adcs_v15_integral_Power_nom_no_ch();
}
  ...
  *get_sim_state_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb(void)
{
  ...
  c29_f_u = *c29_is_active_c29_adcs_v15_integral_Power_nom_no_charge_in_detu;
  c29_g_y = NULL;
  ...
  const mxArray *c29_st)
{
  ...
  real_T c29_e_y[3];
  int32_T c29_i11;
  const mxArray *c29_is_active_c29_adcs_v15_integral_Power_nom_no_charge_in_detu;
  uint8_T c29_u0;
  uint8_T c29_f_y;
  boolean_T *c29_doneDoubleBufferReInit;
  real_T *c29_b_modw;
  uint8_T *c29_b_is_active_c29_adcs_v15_integral_Power_nom_no_charge_in_de;
  real_T (*c29_d_euler)[3];
  real_T (*c29_b_q_BO)[4];
  real_T (*c29_w_BIB)[3];
  real_T (*c29_w_BOB)[3];
  c29_w_BIB = (real_T (*)[3])ssGetOutputPortSignal(chartInstance.S, 5);
  c29_b_is_active_c29_adcs_v15_integral_Power_nom_no_charge_in_de = (uint8_T *)
    ssGetDWork(chartInstance.S, 2);
  ...
  *c29_b_modw = c29_b_y;
  ...
  c29_is_active_c29_adcs_v15_integral_Power_nom_no_charge_in_detu = sf_mex_dup
    (sf_mex_getcell(c29_u, 5));
  sf_mex_import("is_active_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb",
                sf_mex_dup(
    c29_is_active_c29_adcs_v15_integral_Power_nom_no_charge_in_detu), &c29_u0, 1,
                3, 0U, 0, 0U, 0);
  c29_f_y = c29_u0;
  sf_mex_destroy
    (&c29_is_active_c29_adcs_v15_integral_Power_nom_no_charge_in_detu);
  *c29_b_is_active_c29_adcs_v15_integral_Power_nom_no_charge_in_de = c29_f_y;
...
static void sf_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb(void)
{
  ...
  c29_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb();
...
/* SFunction Glue Code */
void sf_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb_get_check_sum
  (mxArray *plhs[])
{
...
static mxArray
  *sf_get_sim_state_info_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (void)
{
  ...
  char *infoEncStr[] = {
    "100 S1x6'type','srcId','name','auxInfo'{{M[1],M[9],T\"euler\",},{M[1],M[11],T\"modw\",},{M[1],M[5],T\"q_BO\",},{M[1],M[13],T\"w_BIB\",},{M[1],M[10],T\"w_BOB\",},{M[8],M[0],T\"is_active_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb\",}}"
  };
...
static void
  sf_opaque_initialize_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb(void *
  chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb();
  initialize_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb();
}

static void sf_opaque_enable_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (void *chartInstanceVar)
{
  enable_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb();
}

static void
  sf_opaque_disable_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb(void
  *chartInstanceVar)
{
  disable_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb();
}

static void
  sf_opaque_gateway_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb(void
  *chartInstanceVar)
{
  sf_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb();
}

static void
  sf_opaque_ext_mode_exec_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (void *chartInstanceVar)
{
  ext_mode_exec_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb();
}

static mxArray*
  sf_opaque_get_sim_state_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (void *chartInstanceVar)
{
  mxArray *st = (mxArray *)
    get_sim_state_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb();
  return st;
}

static void
  sf_opaque_set_sim_state_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (void *chartInstanceVar, const mxArray *st)
{
  set_sim_state_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb(sf_mex_dup
    (st));
}

static void
  sf_opaque_terminate_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb(void
  *chartInstanceVar)
{
  ...
  finalize_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb();
}

extern unsigned int sf_machine_global_initializer_called(void);
static void
  mdlProcessParameters_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      ...
      "adcs_v15_integral_Power_nom_no_charge_in_detumb",29);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(
                "adcs_v15_integral_Power_nom_no_charge_in_detumb",
                "adcs_v15_integral_Power_nom_no_charge_in_detumb",29,"RTWCG"));
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,
        "adcs_v15_integral_Power_nom_no_charge_in_detumb",
        "adcs_v15_integral_Power_nom_no_charge_in_detumb",29,2);
      sf_mark_chart_reusable_outputs(S,
        "adcs_v15_integral_Power_nom_no_charge_in_detumb",
        "adcs_v15_integral_Power_nom_no_charge_in_detumb",29,5);
    }
...
static void mdlRTW_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb(SimStruct
  *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (SimStruct *S)
{
  ...
  chartInstance.chartInfo.sFunctionGateway =
    sf_opaque_gateway_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb;
  chartInstance.chartInfo.initializeChart =
    sf_opaque_initialize_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb;
  chartInstance.chartInfo.terminateChart =
    sf_opaque_terminate_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb;
  chartInstance.chartInfo.enableChart =
    sf_opaque_enable_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb;
  chartInstance.chartInfo.disableChart =
    sf_opaque_disable_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb;
  ...
  chartInstance.chartInfo.mdlRTW =
    mdlRTW_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb;
  chartInstance.chartInfo.mdlStart =
    mdlStart_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb;
  chartInstance.chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb;
...
void c29_adcs_v15_integral_Power_nom_no_charge_in_detumb_method_dispatcher
  (SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c29_adcs_v15_integral_Power_nom_no_charge_in_detumb_method_dispatcher.\n"

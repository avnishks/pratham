...
static SFc6_adcs_v15_integral_Power_nom_no_charge_in_detumbInstanceStruct
  chartInstance;

/* Function Declarations */
static void initialize_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb(void);
static void initialize_params_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (void);
static void enable_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb(void);
static void disable_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb(void);
static void c6_update_debugger_state_c6_adcs_v15_integral_Power_nom_no_char(void);
static void ext_mode_exec_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (void);
static const mxArray
  *get_sim_state_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb(void);
static void set_sim_state_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb(
  const mxArray *c6_st);
static void finalize_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb(void);
static void sf_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb(void);
...
static void initialize_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb(void)
{
  uint8_T *c6_is_active_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb;
  c6_is_active_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb = (uint8_T *)
    ssGetDWork(chartInstance.S, 2);
  _sfTime_ = (real_T)ssGetT(chartInstance.S);
  *c6_is_active_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb = 0U;
}
...
static void ext_mode_exec_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (void)
{
  c6_update_debugger_state_c6_adcs_v15_integral_Power_nom_no_char();
}
  ...
  *get_sim_state_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb(void)
{
  ...
  c6_b_u = *c6_is_active_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb;
  c6_c_y = NULL;
  ...
  const mxArray *c6_st)
{
  ...
  real_T c6_d0;
  real_T c6_b_y;
  const mxArray *c6_is_active_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb;
  uint8_T c6_u0;
  uint8_T c6_c_y;
  boolean_T *c6_doneDoubleBufferReInit;
  real_T *c6_d_y;
  uint8_T *c6_b_is_active_c6_adcs_v15_integral_Power_nom_no_charge_in_detu;
  c6_d_y = (real_T *)ssGetOutputPortSignal(chartInstance.S, 1);
  c6_b_is_active_c6_adcs_v15_integral_Power_nom_no_charge_in_detu = (uint8_T *)
    ssGetDWork(chartInstance.S, 2);
  ...
  *c6_doneDoubleBufferReInit = true;
  ...
  sf_mex_destroy(&c6_y);
  *c6_d_y = c6_b_y;
  c6_is_active_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb = sf_mex_dup
    (sf_mex_getcell(c6_u, 1));
  sf_mex_import("is_active_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb",
                sf_mex_dup(
    c6_is_active_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb), &c6_u0, 1,
                3, 0U, 0, 0U, 0);
  c6_c_y = c6_u0;
  sf_mex_destroy
    (&c6_is_active_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb);
  *c6_b_is_active_c6_adcs_v15_integral_Power_nom_no_charge_in_detu = c6_c_y;
  sf_mex_destroy(&c6_u);
  c6_update_debugger_state_c6_adcs_v15_integral_Power_nom_no_char();
...
/* SFunction Glue Code */
void sf_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb_get_check_sum(mxArray
  *plhs[])
{
...
static mxArray
  *sf_get_sim_state_info_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb\",}}"
  };
...
static void
  sf_opaque_initialize_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb(void
  *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb();
  initialize_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb();
}

static void sf_opaque_enable_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (void *chartInstanceVar)
{
  enable_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb();
}

static void sf_opaque_disable_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (void *chartInstanceVar)
{
  disable_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb();
}

static void sf_opaque_gateway_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (void *chartInstanceVar)
{
  sf_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb();
}

static void
  sf_opaque_ext_mode_exec_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (void *chartInstanceVar)
{
  ext_mode_exec_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb();
}

static mxArray*
  sf_opaque_get_sim_state_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (void *chartInstanceVar)
{
  mxArray *st = (mxArray *)
    get_sim_state_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb();
  return st;
}

static void
  sf_opaque_set_sim_state_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (void *chartInstanceVar, const mxArray *st)
{
  set_sim_state_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb(sf_mex_dup(st));
}

static void
  sf_opaque_terminate_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb(void
  *chartInstanceVar)
{
  ...
  finalize_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb();
}

extern unsigned int sf_machine_global_initializer_called(void);
static void
  mdlProcessParameters_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (SimStruct *S)
{
  int i;
  ...
  (SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      ...
      "adcs_v15_integral_Power_nom_no_charge_in_detumb",6);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(
                "adcs_v15_integral_Power_nom_no_charge_in_detumb",
                "adcs_v15_integral_Power_nom_no_charge_in_detumb",6,"RTWCG"));
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,
        "adcs_v15_integral_Power_nom_no_charge_in_detumb",
        "adcs_v15_integral_Power_nom_no_charge_in_detumb",6,2);
      sf_mark_chart_reusable_outputs(S,
        "adcs_v15_integral_Power_nom_no_charge_in_detumb",
        "adcs_v15_integral_Power_nom_no_charge_in_detumb",6,1);
    }
...
static void mdlRTW_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb(SimStruct *
  S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb
  (SimStruct *S)
{
  ...
  chartInstance.chartInfo.sFunctionGateway =
    sf_opaque_gateway_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb;
  chartInstance.chartInfo.initializeChart =
    sf_opaque_initialize_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb;
  chartInstance.chartInfo.terminateChart =
    sf_opaque_terminate_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb;
  chartInstance.chartInfo.enableChart =
    sf_opaque_enable_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb;
  chartInstance.chartInfo.disableChart =
    sf_opaque_disable_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb;
  chartInstance.chartInfo.getSimState =
    sf_opaque_get_sim_state_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb;
  chartInstance.chartInfo.setSimState =
    sf_opaque_set_sim_state_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb;
  chartInstance.chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW =
    mdlRTW_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb;
  chartInstance.chartInfo.mdlStart =
    mdlStart_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb;
  chartInstance.chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb;

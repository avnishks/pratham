...
static SFc10_adcs_v15_integral_Power_nomInstanceStruct chartInstance;

/* Function Declarations */
static void initialize_c10_adcs_v15_integral_Power_nom(void);
static void initialize_params_c10_adcs_v15_integral_Power_nom(void);
static void enable_c10_adcs_v15_integral_Power_nom(void);
static void disable_c10_adcs_v15_integral_Power_nom(void);
static void c10_update_debugger_state_c10_adcs_v15_integral_Power_nom(void);
static void ext_mode_exec_c10_adcs_v15_integral_Power_nom(void);
static const mxArray *get_sim_state_c10_adcs_v15_integral_Power_nom(void);
static void set_sim_state_c10_adcs_v15_integral_Power_nom(const mxArray *c10_st);
static void finalize_c10_adcs_v15_integral_Power_nom(void);
...
static void initialize_c10_adcs_v15_integral_Power_nom(void)
{
  uint8_T *c10_is_active_c10_adcs_v15_integral_Power_nom;
  c10_is_active_c10_adcs_v15_integral_Power_nom = (uint8_T *)ssGetDWork
    (chartInstance.S, 2);
  _sfTime_ = (real_T)ssGetT(chartInstance.S);
  *c10_is_active_c10_adcs_v15_integral_Power_nom = 0U;
}
...
static void ext_mode_exec_c10_adcs_v15_integral_Power_nom(void)
{
  c10_update_debugger_state_c10_adcs_v15_integral_Power_nom();
}
...
static const mxArray *get_sim_state_c10_adcs_v15_integral_Power_nom(void)
{
  ...
  c10_c_u = *c10_is_active_c10_adcs_v15_integral_Power_nom;
  c10_d_y = NULL;
...
static void set_sim_state_c10_adcs_v15_integral_Power_nom(const mxArray *c10_st)
{
  ...
  real_T c10_b_y[3];
  int32_T c10_i5;
  const mxArray *c10_is_active_c10_adcs_v15_integral_Power_nom;
  uint8_T c10_u0;
  uint8_T c10_c_y;
  boolean_T *c10_doneDoubleBufferReInit;
  uint8_T *c10_b_is_active_c10_adcs_v15_integral_Power_nom;
  real_T (*c10_c_B)[3];
  real_T (*c10_dB)[3];
  c10_b_is_active_c10_adcs_v15_integral_Power_nom = (uint8_T *)ssGetDWork
    (chartInstance.S, 2);
  ...
  *c10_doneDoubleBufferReInit = true;
  ...
  c10_is_active_c10_adcs_v15_integral_Power_nom = sf_mex_dup(sf_mex_getcell
    (c10_u, 2));
  sf_mex_import("is_active_c10_adcs_v15_integral_Power_nom", sf_mex_dup
                (c10_is_active_c10_adcs_v15_integral_Power_nom), &c10_u0, 1, 3
                , 0U, 0, 0U, 0);
  c10_c_y = c10_u0;
  sf_mex_destroy(&c10_is_active_c10_adcs_v15_integral_Power_nom);
  *c10_b_is_active_c10_adcs_v15_integral_Power_nom = c10_c_y;
...
const mxArray
  *sf_c10_adcs_v15_integral_Power_nom_get_eml_resolved_functions_info(void)
{
...
/* SFunction Glue Code */
void sf_c10_adcs_v15_integral_Power_nom_get_check_sum(mxArray *plhs[])
{
...
static mxArray *sf_get_sim_state_info_c10_adcs_v15_integral_Power_nom(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[11],T\"B\",},{M[1],M[5],T\"dB\",},{M[8],M[0],T\"is_active_c10_adcs_v15_integral_Power_nom\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c10_adcs_v15_integral_Power_nom_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c10_adcs_v15_integral_Power_nom(void
  *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c10_adcs_v15_integral_Power_nom();
  initialize_c10_adcs_v15_integral_Power_nom();
}

static void sf_opaque_enable_c10_adcs_v15_integral_Power_nom(void
  *chartInstanceVar)
{
  enable_c10_adcs_v15_integral_Power_nom();
}

static void sf_opaque_disable_c10_adcs_v15_integral_Power_nom(void
  *chartInstanceVar)
{
  disable_c10_adcs_v15_integral_Power_nom();
}

static void sf_opaque_gateway_c10_adcs_v15_integral_Power_nom(void
  *chartInstanceVar)
{
  sf_c10_adcs_v15_integral_Power_nom();
}

static void sf_opaque_ext_mode_exec_c10_adcs_v15_integral_Power_nom(void
  *chartInstanceVar)
{
  ext_mode_exec_c10_adcs_v15_integral_Power_nom();
}

static mxArray* sf_opaque_get_sim_state_c10_adcs_v15_integral_Power_nom(void
  *chartInstanceVar)
{
  mxArray *st = (mxArray *) get_sim_state_c10_adcs_v15_integral_Power_nom();
  return st;
}

static void sf_opaque_set_sim_state_c10_adcs_v15_integral_Power_nom(void
  *chartInstanceVar, const mxArray *st)
{
  set_sim_state_c10_adcs_v15_integral_Power_nom(sf_mex_dup(st));
}

static void sf_opaque_terminate_c10_adcs_v15_integral_Power_nom(void
  *chartInstanceVar)
{
  ...
  finalize_c10_adcs_v15_integral_Power_nom();
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c10_adcs_v15_integral_Power_nom(SimStruct *S)
{
  int i;
...
static void mdlRTW_c10_adcs_v15_integral_Power_nom(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c10_adcs_v15_integral_Power_nom(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 1;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway =
    sf_opaque_gateway_c10_adcs_v15_integral_Power_nom;
  chartInstance.chartInfo.initializeChart =
    sf_opaque_initialize_c10_adcs_v15_integral_Power_nom;
  chartInstance.chartInfo.terminateChart =
    sf_opaque_terminate_c10_adcs_v15_integral_Power_nom;
  chartInstance.chartInfo.enableChart =
    sf_opaque_enable_c10_adcs_v15_integral_Power_nom;
  chartInstance.chartInfo.disableChart =
    sf_opaque_disable_c10_adcs_v15_integral_Power_nom;
  chartInstance.chartInfo.getSimState =
    sf_opaque_get_sim_state_c10_adcs_v15_integral_Power_nom;
  chartInstance.chartInfo.setSimState =
    sf_opaque_set_sim_state_c10_adcs_v15_integral_Power_nom;
  chartInstance.chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c10_adcs_v15_integral_Power_nom;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW = mdlRTW_c10_adcs_v15_integral_Power_nom;
  chartInstance.chartInfo.mdlStart = mdlStart_c10_adcs_v15_integral_Power_nom;
  chartInstance.chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c10_adcs_v15_integral_Power_nom;
  chartInstance.chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c10_adcs_v15_integral_Power_nom;
...
void c10_adcs_v15_integral_Power_nom_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c10_adcs_v15_integral_Power_nom(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c10_adcs_v15_integral_Power_nom(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c10_adcs_v15_integral_Power_nom(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c10_adcs_v15_integral_Power_nom_method_dispatcher.\n"

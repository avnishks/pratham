...
static SFc26_adcs_v15_integral_Power_nomInstanceStruct chartInstance;

/* Function Declarations */
static void initialize_c26_adcs_v15_integral_Power_nom(void);
static void initialize_params_c26_adcs_v15_integral_Power_nom(void);
static void enable_c26_adcs_v15_integral_Power_nom(void);
static void disable_c26_adcs_v15_integral_Power_nom(void);
static void c26_update_debugger_state_c26_adcs_v15_integral_Power_nom(void);
static void ext_mode_exec_c26_adcs_v15_integral_Power_nom(void);
static const mxArray *get_sim_state_c26_adcs_v15_integral_Power_nom(void);
static void set_sim_state_c26_adcs_v15_integral_Power_nom(const mxArray *c26_st);
static void finalize_c26_adcs_v15_integral_Power_nom(void);
static void sf_c26_adcs_v15_integral_Power_nom(void);
...
static void initialize_c26_adcs_v15_integral_Power_nom(void)
{
  uint8_T *c26_is_active_c26_adcs_v15_integral_Power_nom;
  c26_is_active_c26_adcs_v15_integral_Power_nom = (uint8_T *)ssGetDWork
    (chartInstance.S, 2);
  _sfTime_ = (real_T)ssGetT(chartInstance.S);
  *c26_is_active_c26_adcs_v15_integral_Power_nom = 0U;
}
...
static void ext_mode_exec_c26_adcs_v15_integral_Power_nom(void)
{
  c26_update_debugger_state_c26_adcs_v15_integral_Power_nom();
}
...
static const mxArray *get_sim_state_c26_adcs_v15_integral_Power_nom(void)
{
  ...
  c26_g_u = *c26_is_active_c26_adcs_v15_integral_Power_nom;
  c26_h_y = NULL;
...
static void set_sim_state_c26_adcs_v15_integral_Power_nom(const mxArray *c26_st)
{
  ...
  real_T c26_d6;
  real_T c26_f_y;
  const mxArray *c26_is_active_c26_adcs_v15_integral_Power_nom;
  uint8_T c26_u0;
  uint8_T c26_g_y;
  ...
  real_T *c26_current;
  real_T *c26_frac_Batt_cap;
  uint8_T *c26_b_is_active_c26_adcs_v15_integral_Power_nom;
  ...
  c26_current = (real_T *)ssGetOutputPortSignal(chartInstance.S, 6);
  c26_b_is_active_c26_adcs_v15_integral_Power_nom = (uint8_T *)ssGetDWork
    (chartInstance.S, 2);
  c26_Flag_charge = (real_T *)ssGetOutputPortSignal(chartInstance.S, 3);
  ...
  *c26_frac_Batt_cap = c26_f_y;
  c26_is_active_c26_adcs_v15_integral_Power_nom = sf_mex_dup(sf_mex_getcell
    (c26_u, 6));
  sf_mex_import("is_active_c26_adcs_v15_integral_Power_nom", sf_mex_dup
                (c26_is_active_c26_adcs_v15_integral_Power_nom), &c26_u0, 1, 3
                , 0U, 0, 0U, 0);
  c26_g_y = c26_u0;
  sf_mex_destroy(&c26_is_active_c26_adcs_v15_integral_Power_nom);
  *c26_b_is_active_c26_adcs_v15_integral_Power_nom = c26_g_y;
...
const mxArray
  *sf_c26_adcs_v15_integral_Power_nom_get_eml_resolved_functions_info(void)
{
...
/* SFunction Glue Code */
void sf_c26_adcs_v15_integral_Power_nom_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c26_adcs_v15_integral_Power_nom_get_autoinheritance_info(void)
{
...
static mxArray *sf_get_sim_state_info_c26_adcs_v15_integral_Power_nom(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  char *infoEncStr[] = {
    "100 S1x7'type','srcId','name','auxInfo'{{M[1],M[5],T\"Batt_cap\",},{M[1],M[10],T\"Flag_charge\",},{M[1],M[13],T\"Flag_discharge\",},{M[1],M[8],T\"VBat\",},{M[1],M[16],T\"current\",},{M[1],M[11],T\"frac_Batt_cap\",},{M[8],M[0],T\"is_active_c26_adcs_v15_integral_Power_nom\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 7, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c26_adcs_v15_integral_Power_nom_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c26_adcs_v15_integral_Power_nom(void
  *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c26_adcs_v15_integral_Power_nom();
  initialize_c26_adcs_v15_integral_Power_nom();
}

static void sf_opaque_enable_c26_adcs_v15_integral_Power_nom(void
  *chartInstanceVar)
{
  enable_c26_adcs_v15_integral_Power_nom();
}

static void sf_opaque_disable_c26_adcs_v15_integral_Power_nom(void
  *chartInstanceVar)
{
  disable_c26_adcs_v15_integral_Power_nom();
}

static void sf_opaque_gateway_c26_adcs_v15_integral_Power_nom(void
  *chartInstanceVar)
{
  sf_c26_adcs_v15_integral_Power_nom();
}

static void sf_opaque_ext_mode_exec_c26_adcs_v15_integral_Power_nom(void
  *chartInstanceVar)
{
  ext_mode_exec_c26_adcs_v15_integral_Power_nom();
}

static mxArray* sf_opaque_get_sim_state_c26_adcs_v15_integral_Power_nom(void
  *chartInstanceVar)
{
  mxArray *st = (mxArray *) get_sim_state_c26_adcs_v15_integral_Power_nom();
  return st;
}

static void sf_opaque_set_sim_state_c26_adcs_v15_integral_Power_nom(void
  *chartInstanceVar, const mxArray *st)
{
  set_sim_state_c26_adcs_v15_integral_Power_nom(sf_mex_dup(st));
}

static void sf_opaque_terminate_c26_adcs_v15_integral_Power_nom(void
  *chartInstanceVar)
{
  ...
  finalize_c26_adcs_v15_integral_Power_nom();
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c26_adcs_v15_integral_Power_nom(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c26_adcs_v15_integral_Power_nom(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      ...
      "adcs_v15_integral_Power_nom",26);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop("adcs_v15_integral_Power_nom",
                "adcs_v15_integral_Power_nom",26,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(
      "adcs_v15_integral_Power_nom","adcs_v15_integral_Power_nom",26,
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,"adcs_v15_integral_Power_nom",
        "adcs_v15_integral_Power_nom",26,6);
...
static void mdlRTW_c26_adcs_v15_integral_Power_nom(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c26_adcs_v15_integral_Power_nom(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 1;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway =
    sf_opaque_gateway_c26_adcs_v15_integral_Power_nom;
  chartInstance.chartInfo.initializeChart =
    sf_opaque_initialize_c26_adcs_v15_integral_Power_nom;
  chartInstance.chartInfo.terminateChart =
    sf_opaque_terminate_c26_adcs_v15_integral_Power_nom;
  chartInstance.chartInfo.enableChart =
    sf_opaque_enable_c26_adcs_v15_integral_Power_nom;
  chartInstance.chartInfo.disableChart =
    sf_opaque_disable_c26_adcs_v15_integral_Power_nom;
  chartInstance.chartInfo.getSimState =
    sf_opaque_get_sim_state_c26_adcs_v15_integral_Power_nom;
  chartInstance.chartInfo.setSimState =
    sf_opaque_set_sim_state_c26_adcs_v15_integral_Power_nom;
  chartInstance.chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c26_adcs_v15_integral_Power_nom;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW = mdlRTW_c26_adcs_v15_integral_Power_nom;
  chartInstance.chartInfo.mdlStart = mdlStart_c26_adcs_v15_integral_Power_nom;
  chartInstance.chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c26_adcs_v15_integral_Power_nom;
  chartInstance.chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c26_adcs_v15_integral_Power_nom;
...
void c26_adcs_v15_integral_Power_nom_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c26_adcs_v15_integral_Power_nom(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c26_adcs_v15_integral_Power_nom(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c26_adcs_v15_integral_Power_nom(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c26_adcs_v15_integral_Power_nom_method_dispatcher.\n"

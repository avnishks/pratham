...
static SFc5_adcs_v15_integral_Power_no_charge_in_detumbInstanceStruct
  chartInstance;

/* Function Declarations */
static void initialize_c5_adcs_v15_integral_Power_no_charge_in_detumb(void);
static void initialize_params_c5_adcs_v15_integral_Power_no_charge_in_detumb
  (void);
static void enable_c5_adcs_v15_integral_Power_no_charge_in_detumb(void);
static void disable_c5_adcs_v15_integral_Power_no_charge_in_detumb(void);
static void c5_update_debugger_state_c5_adcs_v15_integral_Power_no_charge_i(void);
static void ext_mode_exec_c5_adcs_v15_integral_Power_no_charge_in_detumb(void);
static const mxArray
  *get_sim_state_c5_adcs_v15_integral_Power_no_charge_in_detumb(void);
static void set_sim_state_c5_adcs_v15_integral_Power_no_charge_in_detumb(const
  mxArray *c5_st);
static void finalize_c5_adcs_v15_integral_Power_no_charge_in_detumb(void);
static void sf_c5_adcs_v15_integral_Power_no_charge_in_detumb(void);
static void c5_c5_adcs_v15_integral_Power_no_charge_in_detumb(void);
...
static void initialize_c5_adcs_v15_integral_Power_no_charge_in_detumb(void)
{
  uint8_T *c5_is_active_c5_adcs_v15_integral_Power_no_charge_in_detumb;
  c5_is_active_c5_adcs_v15_integral_Power_no_charge_in_detumb = (uint8_T *)
    ssGetDWork(chartInstance.S, 2);
  _sfTime_ = (real_T)ssGetT(chartInstance.S);
  *c5_is_active_c5_adcs_v15_integral_Power_no_charge_in_detumb = 0U;
}
...
static void ext_mode_exec_c5_adcs_v15_integral_Power_no_charge_in_detumb(void)
{
  c5_update_debugger_state_c5_adcs_v15_integral_Power_no_charge_i();
}
  ...
  *get_sim_state_c5_adcs_v15_integral_Power_no_charge_in_detumb(void)
{
  ...
  c5_b_u = *c5_is_active_c5_adcs_v15_integral_Power_no_charge_in_detumb;
  c5_c_y = NULL;
  ...
  mxArray *c5_st)
{
  ...
  real_T c5_y[3];
  int32_T c5_i2;
  const mxArray *c5_is_active_c5_adcs_v15_integral_Power_no_charge_in_detumb;
  uint8_T c5_u0;
  uint8_T c5_b_y;
  boolean_T *c5_doneDoubleBufferReInit;
  uint8_T *c5_b_is_active_c5_adcs_v15_integral_Power_no_charge_in_detumb;
  real_T (*c5_b_v_B)[3];
  ...
  c5_b_is_active_c5_adcs_v15_integral_Power_no_charge_in_detumb = (uint8_T *)
    ssGetDWork(chartInstance.S, 2);
  *c5_doneDoubleBufferReInit = true;
  ...
  c5_is_active_c5_adcs_v15_integral_Power_no_charge_in_detumb = sf_mex_dup
    (sf_mex_getcell(c5_u, 1));
  sf_mex_import("is_active_c5_adcs_v15_integral_Power_no_charge_in_detumb",
                sf_mex_dup(
    c5_is_active_c5_adcs_v15_integral_Power_no_charge_in_detumb), &c5_u0, 1, 3,
                0U, 0, 0U, 0);
  c5_b_y = c5_u0;
  sf_mex_destroy(&c5_is_active_c5_adcs_v15_integral_Power_no_charge_in_detumb);
  *c5_b_is_active_c5_adcs_v15_integral_Power_no_charge_in_detumb = c5_b_y;
  sf_mex_destroy(&c5_u);
  c5_update_debugger_state_c5_adcs_v15_integral_Power_no_charge_i();
...
static void sf_c5_adcs_v15_integral_Power_no_charge_in_detumb(void)
{
  ...
  c5_c5_adcs_v15_integral_Power_no_charge_in_detumb();
...
/* SFunction Glue Code */
void sf_c5_adcs_v15_integral_Power_no_charge_in_detumb_get_check_sum(mxArray
  *plhs[])
{
...
static mxArray
  *sf_get_sim_state_info_c5_adcs_v15_integral_Power_no_charge_in_detumb(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"v_B\",},{M[8],M[0],T\"is_active_c5_adcs_v15_integral_Power_no_charge_in_detumb\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_adcs_v15_integral_Power_no_charge_in_detumb_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c5_adcs_v15_integral_Power_no_charge_in_detumb
  (void *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c5_adcs_v15_integral_Power_no_charge_in_detumb();
  initialize_c5_adcs_v15_integral_Power_no_charge_in_detumb();
}

static void sf_opaque_enable_c5_adcs_v15_integral_Power_no_charge_in_detumb(void
  *chartInstanceVar)
{
  enable_c5_adcs_v15_integral_Power_no_charge_in_detumb();
}

static void sf_opaque_disable_c5_adcs_v15_integral_Power_no_charge_in_detumb
  (void *chartInstanceVar)
{
  disable_c5_adcs_v15_integral_Power_no_charge_in_detumb();
}

static void sf_opaque_gateway_c5_adcs_v15_integral_Power_no_charge_in_detumb
  (void *chartInstanceVar)
{
  sf_c5_adcs_v15_integral_Power_no_charge_in_detumb();
}

static void
  sf_opaque_ext_mode_exec_c5_adcs_v15_integral_Power_no_charge_in_detumb(void
  *chartInstanceVar)
{
  ext_mode_exec_c5_adcs_v15_integral_Power_no_charge_in_detumb();
}

static mxArray*
  sf_opaque_get_sim_state_c5_adcs_v15_integral_Power_no_charge_in_detumb(void
  *chartInstanceVar)
{
  mxArray *st = (mxArray *)
    get_sim_state_c5_adcs_v15_integral_Power_no_charge_in_detumb();
  return st;
}

static void
  sf_opaque_set_sim_state_c5_adcs_v15_integral_Power_no_charge_in_detumb(void
  *chartInstanceVar, const mxArray *st)
{
  set_sim_state_c5_adcs_v15_integral_Power_no_charge_in_detumb(sf_mex_dup(st));
}

static void sf_opaque_terminate_c5_adcs_v15_integral_Power_no_charge_in_detumb
  (void *chartInstanceVar)
{
  ...
  finalize_c5_adcs_v15_integral_Power_no_charge_in_detumb();
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_adcs_v15_integral_Power_no_charge_in_detumb
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c5_adcs_v15_integral_Power_no_charge_in_detumb
  (SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("adcs_v15_integral_Power_no_charge_in_detumb",
      "adcs_v15_integral_Power_no_charge_in_detumb",5);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(
                "adcs_v15_integral_Power_no_charge_in_detumb",
                "adcs_v15_integral_Power_no_charge_in_detumb",5,"RTWCG"));
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,
        "adcs_v15_integral_Power_no_charge_in_detumb",
        "adcs_v15_integral_Power_no_charge_in_detumb",5,2);
      sf_mark_chart_reusable_outputs(S,
        "adcs_v15_integral_Power_no_charge_in_detumb",
        "adcs_v15_integral_Power_no_charge_in_detumb",5,1);
    }
...
static void mdlRTW_c5_adcs_v15_integral_Power_no_charge_in_detumb(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c5_adcs_v15_integral_Power_no_charge_in_detumb(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 1;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway =
    sf_opaque_gateway_c5_adcs_v15_integral_Power_no_charge_in_detumb;
  chartInstance.chartInfo.initializeChart =
    sf_opaque_initialize_c5_adcs_v15_integral_Power_no_charge_in_detumb;
  chartInstance.chartInfo.terminateChart =
    sf_opaque_terminate_c5_adcs_v15_integral_Power_no_charge_in_detumb;
  chartInstance.chartInfo.enableChart =
    sf_opaque_enable_c5_adcs_v15_integral_Power_no_charge_in_detumb;
  chartInstance.chartInfo.disableChart =
    sf_opaque_disable_c5_adcs_v15_integral_Power_no_charge_in_detumb;
  chartInstance.chartInfo.getSimState =
    sf_opaque_get_sim_state_c5_adcs_v15_integral_Power_no_charge_in_detumb;
  chartInstance.chartInfo.setSimState =
    sf_opaque_set_sim_state_c5_adcs_v15_integral_Power_no_charge_in_detumb;
  chartInstance.chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c5_adcs_v15_integral_Power_no_charge_in_detumb;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW =
    mdlRTW_c5_adcs_v15_integral_Power_no_charge_in_detumb;
  chartInstance.chartInfo.mdlStart =
    mdlStart_c5_adcs_v15_integral_Power_no_charge_in_detumb;
  chartInstance.chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c5_adcs_v15_integral_Power_no_charge_in_detumb;
  chartInstance.chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c5_adcs_v15_integral_Power_no_charge_in_detumb;
...
void c5_adcs_v15_integral_Power_no_charge_in_detumb_method_dispatcher(SimStruct *
  S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_adcs_v15_integral_Power_no_charge_in_detumb(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_adcs_v15_integral_Power_no_charge_in_detumb(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_adcs_v15_integral_Power_no_charge_in_detumb(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_adcs_v15_integral_Power_no_charge_in_detumb_method_dispatcher.\n"

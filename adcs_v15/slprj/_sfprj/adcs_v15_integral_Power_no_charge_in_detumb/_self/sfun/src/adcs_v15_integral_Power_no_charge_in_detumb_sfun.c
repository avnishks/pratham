...
#include "c1_adcs_v15_integral_Power_no_charge_in_detumb.h"
#include "c2_adcs_v15_integral_Power_no_charge_in_detumb.h"
#include "c4_adcs_v15_integral_Power_no_charge_in_detumb.h"
#include "c5_adcs_v15_integral_Power_no_charge_in_detumb.h"
#include "c6_adcs_v15_integral_Power_no_charge_in_detumb.h"
#include "c7_adcs_v15_integral_Power_no_charge_in_detumb.h"
#include "c8_adcs_v15_integral_Power_no_charge_in_detumb.h"
#include "c9_adcs_v15_integral_Power_no_charge_in_detumb.h"
#include "c10_adcs_v15_integral_Power_no_charge_in_detumb.h"
...
#include "c19_adcs_v15_integral_Power_no_charge_in_detumb.h"
#include "c20_adcs_v15_integral_Power_no_charge_in_detumb.h"
#include "c22_adcs_v15_integral_Power_no_charge_in_detumb.h"
...
#include "c31_adcs_v15_integral_Power_no_charge_in_detumb.h"
...
int32_T _sfEvent_;
uint32_T _adcs_v15_integral_Power_no_charge_in_detumbMachineNumber_;
real_T _sfTime_;

/* Function Declarations */

/* Function Definitions */
void adcs_v15_integral_Power_no_charge_in_detumb_initializer(void)
{
  _sfEvent_ = CALL_EVENT;
}

void adcs_v15_integral_Power_no_charge_in_detumb_terminator(void)
{
}

/* SFunction Glue Code */
unsigned int sf_adcs_v15_integral_Power_no_charge_in_detumb_method_dispatcher
  (SimStruct *simstructPtr, unsigned int chartFileNumber, int_T method, void
   *data)
{
  if (chartFileNumber==1) {
    c1_adcs_v15_integral_Power_no_charge_in_detumb_method_dispatcher
      (simstructPtr, method, data);
    return 1;
  }

  if (chartFileNumber==2) {
    c2_adcs_v15_integral_Power_no_charge_in_detumb_method_dispatcher
      (simstructPtr, method, data);
    return 1;
  }

  if (chartFileNumber==4) {
    c4_adcs_v15_integral_Power_no_charge_in_detumb_method_dispatcher
      (simstructPtr, method, data);
    return 1;
  }

  if (chartFileNumber==5) {
    c5_adcs_v15_integral_Power_no_charge_in_detumb_method_dispatcher
      (simstructPtr, method, data);
    return 1;
  }

  if (chartFileNumber==6) {
    c6_adcs_v15_integral_Power_no_charge_in_detumb_method_dispatcher
      (simstructPtr, method, data);
    return 1;
  }

  if (chartFileNumber==7) {
    c7_adcs_v15_integral_Power_no_charge_in_detumb_method_dispatcher
      (simstructPtr, method, data);
    return 1;
  }

  if (chartFileNumber==8) {
    c8_adcs_v15_integral_Power_no_charge_in_detumb_method_dispatcher
      (simstructPtr, method, data);
    return 1;
  }

  if (chartFileNumber==9) {
    c9_adcs_v15_integral_Power_no_charge_in_detumb_method_dispatcher
      (simstructPtr, method, data);
    return 1;
  }

  if (chartFileNumber==10) {
    c10_adcs_v15_integral_Power_no_charge_in_detumb_method_dispatcher
      (simstructPtr, method, data);
    return 1;
  }

  if (chartFileNumber==11) {
    c11_adcs_v15_integral_Power_no_charge_in_detumb_method_dispatcher
      (simstructPtr, method, data);
    return 1;
  }

  if (chartFileNumber==12) {
    c12_adcs_v15_integral_Power_no_charge_in_detumb_method_dispatcher
      (simstructPtr, method, data);
    return 1;
  }

  if (chartFileNumber==13) {
    c13_adcs_v15_integral_Power_no_charge_in_detumb_method_dispatcher
      (simstructPtr, method, data);
    return 1;
  }

  if (chartFileNumber==16) {
    c16_adcs_v15_integral_Power_no_charge_in_detumb_method_dispatcher
      (simstructPtr, method, data);
    return 1;
  }

  if (chartFileNumber==19) {
    c19_adcs_v15_integral_Power_no_charge_in_detumb_method_dispatcher
      (simstructPtr, method, data);
    return 1;
  }

  if (chartFileNumber==20) {
    c20_adcs_v15_integral_Power_no_charge_in_detumb_method_dispatcher
      (simstructPtr, method, data);
    return 1;
  }

  if (chartFileNumber==22) {
    c22_adcs_v15_integral_Power_no_charge_in_detumb_method_dispatcher
      (simstructPtr, method, data);
    return 1;
  }

  if (chartFileNumber==23) {
    c23_adcs_v15_integral_Power_no_charge_in_detumb_method_dispatcher
      (simstructPtr, method, data);
    return 1;
  }

  if (chartFileNumber==24) {
    c24_adcs_v15_integral_Power_no_charge_in_detumb_method_dispatcher
      (simstructPtr, method, data);
    return 1;
  }

  if (chartFileNumber==25) {
    c25_adcs_v15_integral_Power_no_charge_in_detumb_method_dispatcher
      (simstructPtr, method, data);
    return 1;
  }

  if (chartFileNumber==26) {
    c26_adcs_v15_integral_Power_no_charge_in_detumb_method_dispatcher
      (simstructPtr, method, data);
    return 1;
  }

  if (chartFileNumber==27) {
    c27_adcs_v15_integral_Power_no_charge_in_detumb_method_dispatcher
      (simstructPtr, method, data);
    return 1;
  }

  if (chartFileNumber==28) {
    c28_adcs_v15_integral_Power_no_charge_in_detumb_method_dispatcher
      (simstructPtr, method, data);
    return 1;
  }

  if (chartFileNumber==29) {
    c29_adcs_v15_integral_Power_no_charge_in_detumb_method_dispatcher
      (simstructPtr, method, data);
    return 1;
  }

  if (chartFileNumber==30) {
    c30_adcs_v15_integral_Power_no_charge_in_detumb_method_dispatcher
      (simstructPtr, method, data);
    return 1;
  }

  if (chartFileNumber==31) {
    c31_adcs_v15_integral_Power_no_charge_in_detumb_method_dispatcher
      (simstructPtr, method, data);
    return 1;
  }
...
unsigned int sf_adcs_v15_integral_Power_no_charge_in_detumb_autoinheritance_info
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        extern mxArray
          *sf_c1_adcs_v15_integral_Power_no_charge_in_detumb_get_autoinheritance_info
          (void);
        plhs[0] =
          sf_c1_adcs_v15_integral_Power_no_charge_in_detumb_get_autoinheritance_info
          ();
     ...
     case 4:
      {
        extern mxArray
          *sf_c4_adcs_v15_integral_Power_no_charge_in_detumb_get_autoinheritance_info
          (void);
        plhs[0] =
          sf_c4_adcs_v15_integral_Power_no_charge_in_detumb_get_autoinheritance_info
          ();
     ...
     case 5:
      {
        extern mxArray
          *sf_c5_adcs_v15_integral_Power_no_charge_in_detumb_get_autoinheritance_info
          (void);
        plhs[0] =
          sf_c5_adcs_v15_integral_Power_no_charge_in_detumb_get_autoinheritance_info
          ();
     ...
     case 6:
      {
        extern mxArray
          *sf_c6_adcs_v15_integral_Power_no_charge_in_detumb_get_autoinheritance_info
          (void);
        plhs[0] =
          sf_c6_adcs_v15_integral_Power_no_charge_in_detumb_get_autoinheritance_info
          ();
     ...
     case 7:
      {
        extern mxArray
          *sf_c7_adcs_v15_integral_Power_no_charge_in_detumb_get_autoinheritance_info
          (void);
        plhs[0] =
          sf_c7_adcs_v15_integral_Power_no_charge_in_detumb_get_autoinheritance_info
          ();
     ...
     case 10:
      {
        extern mxArray
          *sf_c10_adcs_v15_integral_Power_no_charge_in_detumb_get_autoinheritance_info
          (void);
        plhs[0] =
          sf_c10_adcs_v15_integral_Power_no_charge_in_detumb_get_autoinheritance_info
          ();
     ...
     case 22:
      {
        extern mxArray
          *sf_c22_adcs_v15_integral_Power_no_charge_in_detumb_get_autoinheritance_info
          (void);
        plhs[0] =
          sf_c22_adcs_v15_integral_Power_no_charge_in_detumb_get_autoinheritance_info
          ();
...
void adcs_v15_integral_Power_no_charge_in_detumb_debug_initialize(void)
{
  _adcs_v15_integral_Power_no_charge_in_detumbMachineNumber_ =
    sf_debug_initialize_machine("adcs_v15_integral_Power_no_charge_in_detumb",
    "sfun",0,25,0,0,0);
  sf_debug_set_machine_event_thresholds
    (_adcs_v15_integral_Power_no_charge_in_detumbMachineNumber_,0,0);
  sf_debug_set_machine_data_thresholds
    (_adcs_v15_integral_Power_no_charge_in_detumbMachineNumber_,0);
}

void adcs_v15_integral_Power_no_charge_in_detumb_register_exported_symbols
  (SimStruct* S)
{
}

  ...
  const mxArray * prhs[] )
{
  ...
  if (sf_adcs_v15_integral_Power_no_charge_in_detumb_process_check_sum_call(nlhs,
       plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int
    sf_adcs_v15_integral_Power_no_charge_in_detumb_autoinheritance_info( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_adcs_v15_integral_Power_no_charge_in_detumb_autoinheritance_info(nlhs,
       plhs,nrhs,prhs))
    return 1;
  return 0;
}
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (strcmp(machineName, "adcs_v15_integral_Power_no_charge_in_detumb") == 0) {
...
extern unsigned int
  sf_adcs_v15_integral_Power_no_charge_in_detumb_method_dispatcher(SimStruct *S,
...
{
  if (!strcmp(machineName,"adcs_v15_integral_Power_no_charge_in_detumb")) {
    return(sf_adcs_v15_integral_Power_no_charge_in_detumb_method_dispatcher
...
extern void adcs_v15_integral_Power_no_charge_in_detumb_terminator(void);
void sf_machine_global_terminator(void)
{
  if (sfMachineGlobalTerminatorCallable) {
    ...
    adcs_v15_integral_Power_no_charge_in_detumb_terminator();
    sf_debug_terminate();
  }
...
extern void adcs_v15_integral_Power_no_charge_in_detumb_initializer(void);
extern void
  adcs_v15_integral_Power_no_charge_in_detumb_register_exported_symbols
  (SimStruct* S);
extern void adcs_v15_integral_Power_no_charge_in_detumb_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  adcs_v15_integral_Power_no_charge_in_detumb_register_exported_symbols(S);
}

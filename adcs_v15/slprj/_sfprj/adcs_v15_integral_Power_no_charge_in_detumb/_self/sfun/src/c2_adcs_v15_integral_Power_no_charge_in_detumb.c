...
#include "c2_adcs_v15_integral_Power_no_charge_in_detumb.h"
...
static SFc2_adcs_v15_integral_Power_no_charge_in_detumbInstanceStruct
  chartInstance;

/* Function Declarations */
static void initialize_c2_adcs_v15_integral_Power_no_charge_in_detumb(void);
static void initialize_params_c2_adcs_v15_integral_Power_no_charge_in_detumb
  (void);
static void enable_c2_adcs_v15_integral_Power_no_charge_in_detumb(void);
static void disable_c2_adcs_v15_integral_Power_no_charge_in_detumb(void);
static void c2_update_debugger_state_c2_adcs_v15_integral_Power_no_charge_i(void);
static void ext_mode_exec_c2_adcs_v15_integral_Power_no_charge_in_detumb(void);
static const mxArray
  *get_sim_state_c2_adcs_v15_integral_Power_no_charge_in_detumb(void);
static void set_sim_state_c2_adcs_v15_integral_Power_no_charge_in_detumb(const
  mxArray *c2_st);
static void finalize_c2_adcs_v15_integral_Power_no_charge_in_detumb(void);
static void sf_c2_adcs_v15_integral_Power_no_charge_in_detumb(void);
static void c2_c2_adcs_v15_integral_Power_no_charge_in_detumb(void);
...
static void initialize_c2_adcs_v15_integral_Power_no_charge_in_detumb(void)
{
  uint8_T *c2_is_active_c2_adcs_v15_integral_Power_no_charge_in_detumb;
  c2_is_active_c2_adcs_v15_integral_Power_no_charge_in_detumb = (uint8_T *)
    ssGetDWork(chartInstance.S, 2);
  _sfTime_ = (real_T)ssGetT(chartInstance.S);
  *c2_is_active_c2_adcs_v15_integral_Power_no_charge_in_detumb = 0U;
}
...
static void ext_mode_exec_c2_adcs_v15_integral_Power_no_charge_in_detumb(void)
{
  c2_update_debugger_state_c2_adcs_v15_integral_Power_no_charge_i();
}
  ...
  *get_sim_state_c2_adcs_v15_integral_Power_no_charge_in_detumb(void)
{
  ...
  c2_b_u = *c2_is_active_c2_adcs_v15_integral_Power_no_charge_in_detumb;
  c2_c_y = NULL;
  ...
  mxArray *c2_st)
{
  ...
  real_T c2_y[7];
  int32_T c2_i3;
  const mxArray *c2_is_active_c2_adcs_v15_integral_Power_no_charge_in_detumb;
  uint8_T c2_u0;
  uint8_T c2_b_y;
  boolean_T *c2_doneDoubleBufferReInit;
  uint8_T *c2_b_is_active_c2_adcs_v15_integral_Power_no_charge_in_detumb;
  real_T (*c2_b_xdot)[7];
  c2_doneDoubleBufferReInit = (boolean_T *)ssGetDWork(chartInstance.S, 1);
  c2_b_is_active_c2_adcs_v15_integral_Power_no_charge_in_detumb = (uint8_T *)
    ssGetDWork(chartInstance.S, 2);
  ...
  *c2_doneDoubleBufferReInit = true;
  ...
  c2_is_active_c2_adcs_v15_integral_Power_no_charge_in_detumb = sf_mex_dup
    (sf_mex_getcell(c2_u, 1));
  sf_mex_import("is_active_c2_adcs_v15_integral_Power_no_charge_in_detumb",
                sf_mex_dup(
    c2_is_active_c2_adcs_v15_integral_Power_no_charge_in_detumb), &c2_u0, 1, 3,
                0U, 0, 0U, 0);
  c2_b_y = c2_u0;
  sf_mex_destroy(&c2_is_active_c2_adcs_v15_integral_Power_no_charge_in_detumb);
  *c2_b_is_active_c2_adcs_v15_integral_Power_no_charge_in_detumb = c2_b_y;
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_adcs_v15_integral_Power_no_charge_i();
...
static void sf_c2_adcs_v15_integral_Power_no_charge_in_detumb(void)
{
  ...
  c2_c2_adcs_v15_integral_Power_no_charge_in_detumb();
...
/* SFunction Glue Code */
void sf_c2_adcs_v15_integral_Power_no_charge_in_detumb_get_check_sum(mxArray
  *plhs[])
{
...
mxArray
  *sf_c2_adcs_v15_integral_Power_no_charge_in_detumb_get_autoinheritance_info
  (void)
{
...
static mxArray
  *sf_get_sim_state_info_c2_adcs_v15_integral_Power_no_charge_in_detumb(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"xdot\",},{M[8],M[0],T\"is_active_c2_adcs_v15_integral_Power_no_charge_in_detumb\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_adcs_v15_integral_Power_no_charge_in_detumb_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c2_adcs_v15_integral_Power_no_charge_in_detumb
  (void *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c2_adcs_v15_integral_Power_no_charge_in_detumb();
  initialize_c2_adcs_v15_integral_Power_no_charge_in_detumb();
}

static void sf_opaque_enable_c2_adcs_v15_integral_Power_no_charge_in_detumb(void
  *chartInstanceVar)
{
  enable_c2_adcs_v15_integral_Power_no_charge_in_detumb();
}

static void sf_opaque_disable_c2_adcs_v15_integral_Power_no_charge_in_detumb
  (void *chartInstanceVar)
{
  disable_c2_adcs_v15_integral_Power_no_charge_in_detumb();
}

static void sf_opaque_gateway_c2_adcs_v15_integral_Power_no_charge_in_detumb
  (void *chartInstanceVar)
{
  sf_c2_adcs_v15_integral_Power_no_charge_in_detumb();
}

static void
  sf_opaque_ext_mode_exec_c2_adcs_v15_integral_Power_no_charge_in_detumb(void
  *chartInstanceVar)
{
  ext_mode_exec_c2_adcs_v15_integral_Power_no_charge_in_detumb();
}

static mxArray*
  sf_opaque_get_sim_state_c2_adcs_v15_integral_Power_no_charge_in_detumb(void
  *chartInstanceVar)
{
  mxArray *st = (mxArray *)
    get_sim_state_c2_adcs_v15_integral_Power_no_charge_in_detumb();
  return st;
}

static void
  sf_opaque_set_sim_state_c2_adcs_v15_integral_Power_no_charge_in_detumb(void
  *chartInstanceVar, const mxArray *st)
{
  set_sim_state_c2_adcs_v15_integral_Power_no_charge_in_detumb(sf_mex_dup(st));
}

static void sf_opaque_terminate_c2_adcs_v15_integral_Power_no_charge_in_detumb
  (void *chartInstanceVar)
{
  ...
  finalize_c2_adcs_v15_integral_Power_no_charge_in_detumb();
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_adcs_v15_integral_Power_no_charge_in_detumb
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_adcs_v15_integral_Power_no_charge_in_detumb
  (SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      ...
      "adcs_v15_integral_Power_no_charge_in_detumb",2);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(
                "adcs_v15_integral_Power_no_charge_in_detumb",
                "adcs_v15_integral_Power_no_charge_in_detumb",2,"RTWCG"));
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,
        "adcs_v15_integral_Power_no_charge_in_detumb",
        "adcs_v15_integral_Power_no_charge_in_detumb",2,2);
      sf_mark_chart_reusable_outputs(S,
        "adcs_v15_integral_Power_no_charge_in_detumb",
        "adcs_v15_integral_Power_no_charge_in_detumb",2,1);
    }
...
static void mdlRTW_c2_adcs_v15_integral_Power_no_charge_in_detumb(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_adcs_v15_integral_Power_no_charge_in_detumb(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 1;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_adcs_v15_integral_Power_no_charge_in_detumb;
  chartInstance.chartInfo.initializeChart =
    sf_opaque_initialize_c2_adcs_v15_integral_Power_no_charge_in_detumb;
  chartInstance.chartInfo.terminateChart =
    sf_opaque_terminate_c2_adcs_v15_integral_Power_no_charge_in_detumb;
  chartInstance.chartInfo.enableChart =
    sf_opaque_enable_c2_adcs_v15_integral_Power_no_charge_in_detumb;
  chartInstance.chartInfo.disableChart =
    sf_opaque_disable_c2_adcs_v15_integral_Power_no_charge_in_detumb;
  chartInstance.chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_adcs_v15_integral_Power_no_charge_in_detumb;
  chartInstance.chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_adcs_v15_integral_Power_no_charge_in_detumb;
  chartInstance.chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_adcs_v15_integral_Power_no_charge_in_detumb;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW =
    mdlRTW_c2_adcs_v15_integral_Power_no_charge_in_detumb;
  chartInstance.chartInfo.mdlStart =
    mdlStart_c2_adcs_v15_integral_Power_no_charge_in_detumb;
  chartInstance.chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_adcs_v15_integral_Power_no_charge_in_detumb;
  chartInstance.chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c2_adcs_v15_integral_Power_no_charge_in_detumb;
...
void c2_adcs_v15_integral_Power_no_charge_in_detumb_method_dispatcher(SimStruct *
  S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_adcs_v15_integral_Power_no_charge_in_detumb(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_adcs_v15_integral_Power_no_charge_in_detumb(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_adcs_v15_integral_Power_no_charge_in_detumb(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_adcs_v15_integral_Power_no_charge_in_detumb_method_dispatcher.\n"

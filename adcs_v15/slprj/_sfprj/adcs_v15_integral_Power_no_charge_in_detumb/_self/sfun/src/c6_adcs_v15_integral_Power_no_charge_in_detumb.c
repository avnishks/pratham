...
static SFc6_adcs_v15_integral_Power_no_charge_in_detumbInstanceStruct
  chartInstance;

/* Function Declarations */
static void initialize_c6_adcs_v15_integral_Power_no_charge_in_detumb(void);
static void initialize_params_c6_adcs_v15_integral_Power_no_charge_in_detumb
  (void);
static void enable_c6_adcs_v15_integral_Power_no_charge_in_detumb(void);
static void disable_c6_adcs_v15_integral_Power_no_charge_in_detumb(void);
static void c6_update_debugger_state_c6_adcs_v15_integral_Power_no_charge_i(void);
static void ext_mode_exec_c6_adcs_v15_integral_Power_no_charge_in_detumb(void);
...
static void set_sim_state_c6_adcs_v15_integral_Power_no_charge_in_detumb(const
  mxArray *c6_st);
static void finalize_c6_adcs_v15_integral_Power_no_charge_in_detumb(void);
...
/* SFunction Glue Code */
void sf_c6_adcs_v15_integral_Power_no_charge_in_detumb_get_check_sum(mxArray
  *plhs[])
{
...
static mxArray
  *sf_get_sim_state_info_c6_adcs_v15_integral_Power_no_charge_in_detumb(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c6_adcs_v15_integral_Power_no_charge_in_detumb\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c6_adcs_v15_integral_Power_no_charge_in_detumb_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c6_adcs_v15_integral_Power_no_charge_in_detumb
  (void *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c6_adcs_v15_integral_Power_no_charge_in_detumb();
  initialize_c6_adcs_v15_integral_Power_no_charge_in_detumb();
}

static void sf_opaque_enable_c6_adcs_v15_integral_Power_no_charge_in_detumb(void
  *chartInstanceVar)
{
  enable_c6_adcs_v15_integral_Power_no_charge_in_detumb();
}

static void sf_opaque_disable_c6_adcs_v15_integral_Power_no_charge_in_detumb
  (void *chartInstanceVar)
{
  disable_c6_adcs_v15_integral_Power_no_charge_in_detumb();
}

static void sf_opaque_gateway_c6_adcs_v15_integral_Power_no_charge_in_detumb
  (void *chartInstanceVar)
{
  sf_c6_adcs_v15_integral_Power_no_charge_in_detumb();
}

static void
  sf_opaque_ext_mode_exec_c6_adcs_v15_integral_Power_no_charge_in_detumb(void
  *chartInstanceVar)
{
  ext_mode_exec_c6_adcs_v15_integral_Power_no_charge_in_detumb();
}

static mxArray*
  sf_opaque_get_sim_state_c6_adcs_v15_integral_Power_no_charge_in_detumb(void
  *chartInstanceVar)
{
  mxArray *st = (mxArray *)
    get_sim_state_c6_adcs_v15_integral_Power_no_charge_in_detumb();
  return st;
}

static void
  sf_opaque_set_sim_state_c6_adcs_v15_integral_Power_no_charge_in_detumb(void
  *chartInstanceVar, const mxArray *st)
{
  set_sim_state_c6_adcs_v15_integral_Power_no_charge_in_detumb(sf_mex_dup(st));
}
...
static void mdlProcessParameters_c6_adcs_v15_integral_Power_no_charge_in_detumb
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c6_adcs_v15_integral_Power_no_charge_in_detumb
  (SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("adcs_v15_integral_Power_no_charge_in_detumb",
      "adcs_v15_integral_Power_no_charge_in_detumb",6);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(
                "adcs_v15_integral_Power_no_charge_in_detumb",
                "adcs_v15_integral_Power_no_charge_in_detumb",6,"RTWCG"));
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,
        "adcs_v15_integral_Power_no_charge_in_detumb",
        "adcs_v15_integral_Power_no_charge_in_detumb",6,2);
      sf_mark_chart_reusable_outputs(S,
        "adcs_v15_integral_Power_no_charge_in_detumb",
        "adcs_v15_integral_Power_no_charge_in_detumb",6,1);
    }
...
static void mdlRTW_c6_adcs_v15_integral_Power_no_charge_in_detumb(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c6_adcs_v15_integral_Power_no_charge_in_detumb(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 1;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway =
    sf_opaque_gateway_c6_adcs_v15_integral_Power_no_charge_in_detumb;
  chartInstance.chartInfo.initializeChart =
    sf_opaque_initialize_c6_adcs_v15_integral_Power_no_charge_in_detumb;
  chartInstance.chartInfo.terminateChart =
    sf_opaque_terminate_c6_adcs_v15_integral_Power_no_charge_in_detumb;
  chartInstance.chartInfo.enableChart =
    sf_opaque_enable_c6_adcs_v15_integral_Power_no_charge_in_detumb;
  chartInstance.chartInfo.disableChart =
    sf_opaque_disable_c6_adcs_v15_integral_Power_no_charge_in_detumb;
  chartInstance.chartInfo.getSimState =
    sf_opaque_get_sim_state_c6_adcs_v15_integral_Power_no_charge_in_detumb;
  chartInstance.chartInfo.setSimState =
    sf_opaque_set_sim_state_c6_adcs_v15_integral_Power_no_charge_in_detumb;
  chartInstance.chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c6_adcs_v15_integral_Power_no_charge_in_detumb;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW =
    mdlRTW_c6_adcs_v15_integral_Power_no_charge_in_detumb;
  chartInstance.chartInfo.mdlStart =
    mdlStart_c6_adcs_v15_integral_Power_no_charge_in_detumb;
  chartInstance.chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c6_adcs_v15_integral_Power_no_charge_in_detumb;
  chartInstance.chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c6_adcs_v15_integral_Power_no_charge_in_detumb;
...
void c6_adcs_v15_integral_Power_no_charge_in_detumb_method_dispatcher(SimStruct *
  S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c6_adcs_v15_integral_Power_no_charge_in_detumb(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c6_adcs_v15_integral_Power_no_charge_in_detumb(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c6_adcs_v15_integral_Power_no_charge_in_detumb(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c6_adcs_v15_integral_Power_no_charge_in_detumb_method_dispatcher.\n"

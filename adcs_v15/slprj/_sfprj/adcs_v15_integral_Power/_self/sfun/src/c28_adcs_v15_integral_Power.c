...
static SFc28_adcs_v15_integral_PowerInstanceStruct chartInstance;

/* Function Declarations */
static void initialize_c28_adcs_v15_integral_Power(void);
static void initialize_params_c28_adcs_v15_integral_Power(void);
static void enable_c28_adcs_v15_integral_Power(void);
static void disable_c28_adcs_v15_integral_Power(void);
static void c28_update_debugger_state_c28_adcs_v15_integral_Power(void);
static void ext_mode_exec_c28_adcs_v15_integral_Power(void);
static const mxArray *get_sim_state_c28_adcs_v15_integral_Power(void);
static void set_sim_state_c28_adcs_v15_integral_Power(const mxArray *c28_st);
static void finalize_c28_adcs_v15_integral_Power(void);
static void sf_c28_adcs_v15_integral_Power(void);
...
static void initialize_c28_adcs_v15_integral_Power(void)
{
  uint8_T *c28_is_active_c28_adcs_v15_integral_Power;
  c28_is_active_c28_adcs_v15_integral_Power = (uint8_T *)ssGetDWork
    (chartInstance.S, 2);
  _sfTime_ = (real_T)ssGetT(chartInstance.S);
  *c28_is_active_c28_adcs_v15_integral_Power = 0U;
}
...
static void ext_mode_exec_c28_adcs_v15_integral_Power(void)
{
  c28_update_debugger_state_c28_adcs_v15_integral_Power();
}
...
static const mxArray *get_sim_state_c28_adcs_v15_integral_Power(void)
{
  ...
  c28_d_u = *c28_is_active_c28_adcs_v15_integral_Power;
  c28_e_y = NULL;
...
static void set_sim_state_c28_adcs_v15_integral_Power(const mxArray *c28_st)
{
  ...
  real_T c28_d2;
  real_T c28_c_y;
  const mxArray *c28_is_active_c28_adcs_v15_integral_Power;
  uint8_T c28_u0;
  uint8_T c28_d_y;
  ...
  real_T *c28_Latitutde;
  real_T *c28_Longitude;
  uint8_T *c28_b_is_active_c28_adcs_v15_integral_Power;
  c28_Latitutde = (real_T *)ssGetOutputPortSignal(chartInstance.S, 1);
  c28_b_is_active_c28_adcs_v15_integral_Power = (uint8_T *)ssGetDWork
    (chartInstance.S, 2);
  ...
  *c28_Longitude = c28_c_y;
  c28_is_active_c28_adcs_v15_integral_Power = sf_mex_dup(sf_mex_getcell(c28_u, 3));
  sf_mex_import("is_active_c28_adcs_v15_integral_Power", sf_mex_dup
                (c28_is_active_c28_adcs_v15_integral_Power), &c28_u0, 1, 3, 0U,
                0,
                0U, 0);
  c28_d_y = c28_u0;
  sf_mex_destroy(&c28_is_active_c28_adcs_v15_integral_Power);
  *c28_b_is_active_c28_adcs_v15_integral_Power = c28_d_y;
...
const mxArray *sf_c28_adcs_v15_integral_Power_get_eml_resolved_functions_info
  (void)
{
...
/* SFunction Glue Code */
void sf_c28_adcs_v15_integral_Power_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c28_adcs_v15_integral_Power_get_autoinheritance_info(void)
{
...
static mxArray *sf_get_sim_state_info_c28_adcs_v15_integral_Power(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[7],T\"Altitude\",},{M[1],M[5],T\"Latitutde\",},{M[1],M[6],T\"Longitude\",},{M[8],M[0],T\"is_active_c28_adcs_v15_integral_Power\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c28_adcs_v15_integral_Power_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c28_adcs_v15_integral_Power(void
  *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c28_adcs_v15_integral_Power();
  initialize_c28_adcs_v15_integral_Power();
}

static void sf_opaque_enable_c28_adcs_v15_integral_Power(void *chartInstanceVar)
{
  enable_c28_adcs_v15_integral_Power();
}

static void sf_opaque_disable_c28_adcs_v15_integral_Power(void *chartInstanceVar)
{
  disable_c28_adcs_v15_integral_Power();
}

static void sf_opaque_gateway_c28_adcs_v15_integral_Power(void *chartInstanceVar)
{
  sf_c28_adcs_v15_integral_Power();
}

static void sf_opaque_ext_mode_exec_c28_adcs_v15_integral_Power(void
  *chartInstanceVar)
{
  ext_mode_exec_c28_adcs_v15_integral_Power();
}

static mxArray* sf_opaque_get_sim_state_c28_adcs_v15_integral_Power(void
  *chartInstanceVar)
{
  mxArray *st = (mxArray *) get_sim_state_c28_adcs_v15_integral_Power();
  return st;
}

static void sf_opaque_set_sim_state_c28_adcs_v15_integral_Power(void
  *chartInstanceVar, const mxArray *st)
{
  set_sim_state_c28_adcs_v15_integral_Power(sf_mex_dup(st));
}

static void sf_opaque_terminate_c28_adcs_v15_integral_Power(void
  *chartInstanceVar)
{
  ...
  finalize_c28_adcs_v15_integral_Power();
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c28_adcs_v15_integral_Power(SimStruct *S)
{
  int i;
...
static void mdlRTW_c28_adcs_v15_integral_Power(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c28_adcs_v15_integral_Power(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 1;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway =
    sf_opaque_gateway_c28_adcs_v15_integral_Power;
  chartInstance.chartInfo.initializeChart =
    sf_opaque_initialize_c28_adcs_v15_integral_Power;
  chartInstance.chartInfo.terminateChart =
    sf_opaque_terminate_c28_adcs_v15_integral_Power;
  chartInstance.chartInfo.enableChart =
    sf_opaque_enable_c28_adcs_v15_integral_Power;
  chartInstance.chartInfo.disableChart =
    sf_opaque_disable_c28_adcs_v15_integral_Power;
  chartInstance.chartInfo.getSimState =
    sf_opaque_get_sim_state_c28_adcs_v15_integral_Power;
  chartInstance.chartInfo.setSimState =
    sf_opaque_set_sim_state_c28_adcs_v15_integral_Power;
  chartInstance.chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c28_adcs_v15_integral_Power;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW = mdlRTW_c28_adcs_v15_integral_Power;
  chartInstance.chartInfo.mdlStart = mdlStart_c28_adcs_v15_integral_Power;
  chartInstance.chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c28_adcs_v15_integral_Power;
  chartInstance.chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c28_adcs_v15_integral_Power;
...
void c28_adcs_v15_integral_Power_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c28_adcs_v15_integral_Power(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c28_adcs_v15_integral_Power(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c28_adcs_v15_integral_Power(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c28_adcs_v15_integral_Power_method_dispatcher.\n"

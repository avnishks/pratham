...
static SFc19_adcs_v15_integral_PowerInstanceStruct chartInstance;

/* Function Declarations */
static void initialize_c19_adcs_v15_integral_Power(void);
static void initialize_params_c19_adcs_v15_integral_Power(void);
static void enable_c19_adcs_v15_integral_Power(void);
static void disable_c19_adcs_v15_integral_Power(void);
static void c19_update_debugger_state_c19_adcs_v15_integral_Power(void);
static void ext_mode_exec_c19_adcs_v15_integral_Power(void);
static const mxArray *get_sim_state_c19_adcs_v15_integral_Power(void);
static void set_sim_state_c19_adcs_v15_integral_Power(const mxArray *c19_st);
static void finalize_c19_adcs_v15_integral_Power(void);
...
static void initialize_c19_adcs_v15_integral_Power(void)
{
  uint8_T *c19_is_active_c19_adcs_v15_integral_Power;
  c19_is_active_c19_adcs_v15_integral_Power = (uint8_T *)ssGetDWork
    (chartInstance.S, 2);
  _sfTime_ = (real_T)ssGetT(chartInstance.S);
  *c19_is_active_c19_adcs_v15_integral_Power = 0U;
}
...
static void ext_mode_exec_c19_adcs_v15_integral_Power(void)
{
  c19_update_debugger_state_c19_adcs_v15_integral_Power();
}
...
static const mxArray *get_sim_state_c19_adcs_v15_integral_Power(void)
{
  ...
  c19_e_u = *c19_is_active_c19_adcs_v15_integral_Power;
  c19_f_y = NULL;
...
static void set_sim_state_c19_adcs_v15_integral_Power(const mxArray *c19_st)
{
  ...
  real_T c19_d3;
  real_T c19_d_y;
  const mxArray *c19_is_active_c19_adcs_v15_integral_Power;
  uint8_T c19_u0;
  uint8_T c19_e_y;
  ...
  real_T *c19_flag_france;
  real_T *c19_flag_india;
  uint8_T *c19_b_is_active_c19_adcs_v15_integral_Power;
  c19_flag_downlink = (real_T *)ssGetOutputPortSignal(chartInstance.S, 2);
  ...
  c19_b_is_active_c19_adcs_v15_integral_Power = (uint8_T *)ssGetDWork
    (chartInstance.S, 2);
  c19_flag_india = (real_T *)ssGetOutputPortSignal(chartInstance.S, 4);
  c19_flag_france = (real_T *)ssGetOutputPortSignal(chartInstance.S, 3);
  ...
  *c19_flag_india = c19_d_y;
  c19_is_active_c19_adcs_v15_integral_Power = sf_mex_dup(sf_mex_getcell(c19_u, 4));
  sf_mex_import("is_active_c19_adcs_v15_integral_Power", sf_mex_dup
                (c19_is_active_c19_adcs_v15_integral_Power), &c19_u0, 1, 3, 0U,
                0,
                0U, 0);
  c19_e_y = c19_u0;
  sf_mex_destroy(&c19_is_active_c19_adcs_v15_integral_Power);
  *c19_b_is_active_c19_adcs_v15_integral_Power = c19_e_y;
...
const mxArray *sf_c19_adcs_v15_integral_Power_get_eml_resolved_functions_info
  (void)
{
...
/* SFunction Glue Code */
void sf_c19_adcs_v15_integral_Power_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c19_adcs_v15_integral_Power_get_autoinheritance_info(void)
{
...
static void sf_opaque_initialize_c19_adcs_v15_integral_Power(void
  *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c19_adcs_v15_integral_Power();
  initialize_c19_adcs_v15_integral_Power();
}

static void sf_opaque_enable_c19_adcs_v15_integral_Power(void *chartInstanceVar)
{
  enable_c19_adcs_v15_integral_Power();
}

static void sf_opaque_disable_c19_adcs_v15_integral_Power(void *chartInstanceVar)
{
  disable_c19_adcs_v15_integral_Power();
}

static void sf_opaque_gateway_c19_adcs_v15_integral_Power(void *chartInstanceVar)
{
  sf_c19_adcs_v15_integral_Power();
}

static void sf_opaque_ext_mode_exec_c19_adcs_v15_integral_Power(void
  *chartInstanceVar)
{
  ext_mode_exec_c19_adcs_v15_integral_Power();
}

static mxArray* sf_opaque_get_sim_state_c19_adcs_v15_integral_Power(void
  *chartInstanceVar)
{
  mxArray *st = (mxArray *) get_sim_state_c19_adcs_v15_integral_Power();
  return st;
}

static void sf_opaque_set_sim_state_c19_adcs_v15_integral_Power(void
  *chartInstanceVar, const mxArray *st)
{
  set_sim_state_c19_adcs_v15_integral_Power(sf_mex_dup(st));
}

static void sf_opaque_terminate_c19_adcs_v15_integral_Power(void
  *chartInstanceVar)
{
  ...
  finalize_c19_adcs_v15_integral_Power();
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c19_adcs_v15_integral_Power(SimStruct *S)
{
  int i;
...
static void mdlRTW_c19_adcs_v15_integral_Power(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c19_adcs_v15_integral_Power(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 1;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway =
    sf_opaque_gateway_c19_adcs_v15_integral_Power;
  chartInstance.chartInfo.initializeChart =
    sf_opaque_initialize_c19_adcs_v15_integral_Power;
  chartInstance.chartInfo.terminateChart =
    sf_opaque_terminate_c19_adcs_v15_integral_Power;
  chartInstance.chartInfo.enableChart =
    sf_opaque_enable_c19_adcs_v15_integral_Power;
  chartInstance.chartInfo.disableChart =
    sf_opaque_disable_c19_adcs_v15_integral_Power;
  chartInstance.chartInfo.getSimState =
    sf_opaque_get_sim_state_c19_adcs_v15_integral_Power;
  chartInstance.chartInfo.setSimState =
    sf_opaque_set_sim_state_c19_adcs_v15_integral_Power;
  chartInstance.chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c19_adcs_v15_integral_Power;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW = mdlRTW_c19_adcs_v15_integral_Power;
  chartInstance.chartInfo.mdlStart = mdlStart_c19_adcs_v15_integral_Power;
  chartInstance.chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c19_adcs_v15_integral_Power;
  chartInstance.chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c19_adcs_v15_integral_Power;
...
void c19_adcs_v15_integral_Power_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c19_adcs_v15_integral_Power(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c19_adcs_v15_integral_Power(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c19_adcs_v15_integral_Power(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c19_adcs_v15_integral_Power_method_dispatcher.\n"

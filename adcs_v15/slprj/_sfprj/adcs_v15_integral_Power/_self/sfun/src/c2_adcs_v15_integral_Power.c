...
static SFc2_adcs_v15_integral_PowerInstanceStruct chartInstance;

/* Function Declarations */
static void initialize_c2_adcs_v15_integral_Power(void);
static void initialize_params_c2_adcs_v15_integral_Power(void);
static void enable_c2_adcs_v15_integral_Power(void);
static void disable_c2_adcs_v15_integral_Power(void);
static void c2_update_debugger_state_c2_adcs_v15_integral_Power(void);
static void ext_mode_exec_c2_adcs_v15_integral_Power(void);
static const mxArray *get_sim_state_c2_adcs_v15_integral_Power(void);
static void set_sim_state_c2_adcs_v15_integral_Power(const mxArray *c2_st);
static void finalize_c2_adcs_v15_integral_Power(void);
static void sf_c2_adcs_v15_integral_Power(void);
static void c2_c2_adcs_v15_integral_Power(void);
...
static void initialize_c2_adcs_v15_integral_Power(void)
{
  uint8_T *c2_is_active_c2_adcs_v15_integral_Power;
  c2_is_active_c2_adcs_v15_integral_Power = (uint8_T *)ssGetDWork
    (chartInstance.S, 2);
  _sfTime_ = (real_T)ssGetT(chartInstance.S);
  *c2_is_active_c2_adcs_v15_integral_Power = 0U;
}
...
static void ext_mode_exec_c2_adcs_v15_integral_Power(void)
{
  c2_update_debugger_state_c2_adcs_v15_integral_Power();
}
...
static const mxArray *get_sim_state_c2_adcs_v15_integral_Power(void)
{
  ...
  c2_b_u = *c2_is_active_c2_adcs_v15_integral_Power;
  c2_c_y = NULL;
...
static void set_sim_state_c2_adcs_v15_integral_Power(const mxArray *c2_st)
{
  ...
  real_T c2_y[7];
  int32_T c2_i3;
  const mxArray *c2_is_active_c2_adcs_v15_integral_Power;
  uint8_T c2_u0;
  uint8_T c2_b_y;
  boolean_T *c2_doneDoubleBufferReInit;
  uint8_T *c2_b_is_active_c2_adcs_v15_integral_Power;
  real_T (*c2_b_xdot)[7];
  ...
  c2_b_is_active_c2_adcs_v15_integral_Power = (uint8_T *)ssGetDWork
    (chartInstance.S, 2);
  *c2_doneDoubleBufferReInit = true;
  ...
  c2_is_active_c2_adcs_v15_integral_Power = sf_mex_dup(sf_mex_getcell(c2_u, 1));
  sf_mex_import("is_active_c2_adcs_v15_integral_Power", sf_mex_dup
                (c2_is_active_c2_adcs_v15_integral_Power), &c2_u0, 1, 3, 0U, 0,
                0U,
                0);
  c2_b_y = c2_u0;
  sf_mex_destroy(&c2_is_active_c2_adcs_v15_integral_Power);
  *c2_b_is_active_c2_adcs_v15_integral_Power = c2_b_y;
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_adcs_v15_integral_Power();
...
static void c2_c2_adcs_v15_integral_Power(void)
{
  ...
  real_T c2_b_m_INERTIA[9] = { 2.5511206283999999E-001, -1.5982455149999998E-003,
    -0.00134649657, -1.5982455149999998E-003,
    2.5739902064999998E-001, -5.4087448275000000E-003, -0.00134649657,
    -5.4087448275000000E-003,
  ...
  real_T c2_c_b[3];
  int32_T c2_i27;
  static real_T c2_dv2[9] = { 2.5511206283999999E-001, -1.5982455149999998E-003,
    -0.00134649657, -1.5982455149999998E-003,
    2.5739902064999998E-001, -5.4087448275000000E-003, -0.00134649657,
    -5.4087448275000000E-003,
    2.3787858104999998E-001 };
  ...
  real_T c2_l_b[3];
  int32_T c2_i31;
  static real_T c2_dv5[9] = { 3.9201215881351366E+000, 2.4819002306591301E-002,
    2.2753918822219242E-002, 2.4819002306591301E-002,
    3.8870328836814432E+000, 8.8521579422844221E-002, 2.2753918822219242E-002,
    8.8521579422844235E-002,
...
const mxArray *sf_c2_adcs_v15_integral_Power_get_eml_resolved_functions_info
  (void)
{
...
/* SFunction Glue Code */
void sf_c2_adcs_v15_integral_Power_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(805173904U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1565136848U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(102559288U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1556710455U);
}

mxArray *sf_c2_adcs_v15_integral_Power_get_autoinheritance_info(void)
{
...

  {
    ...
    pr[0] = (double)(3632819638U);
    pr[1] = (double)(1291507787U);
    pr[2] = (double)(4271865708U);
    pr[3] = (double)(1578745218U);
...
static mxArray *sf_get_sim_state_info_c2_adcs_v15_integral_Power(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"xdot\",},{M[8],M[0],T\"is_active_c2_adcs_v15_integral_Power\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_adcs_v15_integral_Power_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c2_adcs_v15_integral_Power(void
  *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c2_adcs_v15_integral_Power();
  initialize_c2_adcs_v15_integral_Power();
}

static void sf_opaque_enable_c2_adcs_v15_integral_Power(void *chartInstanceVar)
{
  enable_c2_adcs_v15_integral_Power();
}

static void sf_opaque_disable_c2_adcs_v15_integral_Power(void *chartInstanceVar)
{
  disable_c2_adcs_v15_integral_Power();
}

static void sf_opaque_gateway_c2_adcs_v15_integral_Power(void *chartInstanceVar)
{
  sf_c2_adcs_v15_integral_Power();
}

static void sf_opaque_ext_mode_exec_c2_adcs_v15_integral_Power(void
  *chartInstanceVar)
{
  ext_mode_exec_c2_adcs_v15_integral_Power();
}

static mxArray* sf_opaque_get_sim_state_c2_adcs_v15_integral_Power(void
  *chartInstanceVar)
{
  mxArray *st = (mxArray *) get_sim_state_c2_adcs_v15_integral_Power();
  return st;
}

static void sf_opaque_set_sim_state_c2_adcs_v15_integral_Power(void
  *chartInstanceVar, const mxArray *st)
{
  set_sim_state_c2_adcs_v15_integral_Power(sf_mex_dup(st));
}

static void sf_opaque_terminate_c2_adcs_v15_integral_Power(void
  *chartInstanceVar)
{
  ...
  finalize_c2_adcs_v15_integral_Power();
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_adcs_v15_integral_Power(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_adcs_v15_integral_Power(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2588281477U));
  ssSetChecksum1(S,(4134252779U));
  ssSetChecksum2(S,(3540517212U));
  ssSetChecksum3(S,(3110894887U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c2_adcs_v15_integral_Power(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_adcs_v15_integral_Power(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 1;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_adcs_v15_integral_Power;
  chartInstance.chartInfo.initializeChart =
    sf_opaque_initialize_c2_adcs_v15_integral_Power;
  chartInstance.chartInfo.terminateChart =
    sf_opaque_terminate_c2_adcs_v15_integral_Power;
  chartInstance.chartInfo.enableChart =
    sf_opaque_enable_c2_adcs_v15_integral_Power;
  chartInstance.chartInfo.disableChart =
    sf_opaque_disable_c2_adcs_v15_integral_Power;
  chartInstance.chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_adcs_v15_integral_Power;
  chartInstance.chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_adcs_v15_integral_Power;
  chartInstance.chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_adcs_v15_integral_Power;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW = mdlRTW_c2_adcs_v15_integral_Power;
  chartInstance.chartInfo.mdlStart = mdlStart_c2_adcs_v15_integral_Power;
  chartInstance.chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_adcs_v15_integral_Power;
  chartInstance.chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c2_adcs_v15_integral_Power;
...
void c2_adcs_v15_integral_Power_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_adcs_v15_integral_Power(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_adcs_v15_integral_Power(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_adcs_v15_integral_Power(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_adcs_v15_integral_Power_method_dispatcher.\n"

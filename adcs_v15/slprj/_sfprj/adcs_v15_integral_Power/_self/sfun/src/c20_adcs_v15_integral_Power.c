...
static SFc20_adcs_v15_integral_PowerInstanceStruct chartInstance;

/* Function Declarations */
static void initialize_c20_adcs_v15_integral_Power(void);
static void initialize_params_c20_adcs_v15_integral_Power(void);
static void enable_c20_adcs_v15_integral_Power(void);
static void disable_c20_adcs_v15_integral_Power(void);
static void c20_update_debugger_state_c20_adcs_v15_integral_Power(void);
static void ext_mode_exec_c20_adcs_v15_integral_Power(void);
static const mxArray *get_sim_state_c20_adcs_v15_integral_Power(void);
static void set_sim_state_c20_adcs_v15_integral_Power(const mxArray *c20_st);
static void finalize_c20_adcs_v15_integral_Power(void);
static void sf_c20_adcs_v15_integral_Power(void);
static void c20_c20_adcs_v15_integral_Power(void);
...
static void initialize_c20_adcs_v15_integral_Power(void)
{
  uint8_T *c20_is_active_c20_adcs_v15_integral_Power;
  c20_is_active_c20_adcs_v15_integral_Power = (uint8_T *)ssGetDWork
    (chartInstance.S, 2);
  _sfTime_ = (real_T)ssGetT(chartInstance.S);
  *c20_is_active_c20_adcs_v15_integral_Power = 0U;
}
...
static void ext_mode_exec_c20_adcs_v15_integral_Power(void)
{
  c20_update_debugger_state_c20_adcs_v15_integral_Power();
}
...
static const mxArray *get_sim_state_c20_adcs_v15_integral_Power(void)
{
  ...
  c20_b_u = *c20_is_active_c20_adcs_v15_integral_Power;
  c20_c_y = NULL;
...
static void set_sim_state_c20_adcs_v15_integral_Power(const mxArray *c20_st)
{
  ...
  real_T c20_y[3];
  int32_T c20_i2;
  const mxArray *c20_is_active_c20_adcs_v15_integral_Power;
  uint8_T c20_u0;
  uint8_T c20_b_y;
  boolean_T *c20_doneDoubleBufferReInit;
  uint8_T *c20_b_is_active_c20_adcs_v15_integral_Power;
  real_T (*c20_b_v_B)[3];
  c20_doneDoubleBufferReInit = (boolean_T *)ssGetDWork(chartInstance.S, 1);
  c20_b_is_active_c20_adcs_v15_integral_Power = (uint8_T *)ssGetDWork
    (chartInstance.S, 2);
  ...
  *c20_doneDoubleBufferReInit = true;
  ...
  c20_is_active_c20_adcs_v15_integral_Power = sf_mex_dup(sf_mex_getcell(c20_u, 1));
  sf_mex_import("is_active_c20_adcs_v15_integral_Power", sf_mex_dup
                (c20_is_active_c20_adcs_v15_integral_Power), &c20_u0, 1, 3, 0U,
                0,
                0U, 0);
  c20_b_y = c20_u0;
  sf_mex_destroy(&c20_is_active_c20_adcs_v15_integral_Power);
  *c20_b_is_active_c20_adcs_v15_integral_Power = c20_b_y;
...
static void sf_c20_adcs_v15_integral_Power(void)
{
  ...
  c20_c20_adcs_v15_integral_Power();
...
const mxArray *sf_c20_adcs_v15_integral_Power_get_eml_resolved_functions_info
  (void)
{
...
/* SFunction Glue Code */
void sf_c20_adcs_v15_integral_Power_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c20_adcs_v15_integral_Power_get_autoinheritance_info(void)
{
...
static mxArray *sf_get_sim_state_info_c20_adcs_v15_integral_Power(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"v_B\",},{M[8],M[0],T\"is_active_c20_adcs_v15_integral_Power\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c20_adcs_v15_integral_Power_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c20_adcs_v15_integral_Power(void
  *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c20_adcs_v15_integral_Power();
  initialize_c20_adcs_v15_integral_Power();
}

static void sf_opaque_enable_c20_adcs_v15_integral_Power(void *chartInstanceVar)
{
  enable_c20_adcs_v15_integral_Power();
}

static void sf_opaque_disable_c20_adcs_v15_integral_Power(void *chartInstanceVar)
{
  disable_c20_adcs_v15_integral_Power();
}

static void sf_opaque_gateway_c20_adcs_v15_integral_Power(void *chartInstanceVar)
{
  sf_c20_adcs_v15_integral_Power();
}

static void sf_opaque_ext_mode_exec_c20_adcs_v15_integral_Power(void
  *chartInstanceVar)
{
  ext_mode_exec_c20_adcs_v15_integral_Power();
}

static mxArray* sf_opaque_get_sim_state_c20_adcs_v15_integral_Power(void
  *chartInstanceVar)
{
  mxArray *st = (mxArray *) get_sim_state_c20_adcs_v15_integral_Power();
  return st;
}

static void sf_opaque_set_sim_state_c20_adcs_v15_integral_Power(void
  *chartInstanceVar, const mxArray *st)
{
  set_sim_state_c20_adcs_v15_integral_Power(sf_mex_dup(st));
}

static void sf_opaque_terminate_c20_adcs_v15_integral_Power(void
  *chartInstanceVar)
{
  ...
  finalize_c20_adcs_v15_integral_Power();
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c20_adcs_v15_integral_Power(SimStruct *S)
{
  int i;
...
static void mdlRTW_c20_adcs_v15_integral_Power(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c20_adcs_v15_integral_Power(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 1;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway =
    sf_opaque_gateway_c20_adcs_v15_integral_Power;
  chartInstance.chartInfo.initializeChart =
    sf_opaque_initialize_c20_adcs_v15_integral_Power;
  chartInstance.chartInfo.terminateChart =
    sf_opaque_terminate_c20_adcs_v15_integral_Power;
  chartInstance.chartInfo.enableChart =
    sf_opaque_enable_c20_adcs_v15_integral_Power;
  chartInstance.chartInfo.disableChart =
    sf_opaque_disable_c20_adcs_v15_integral_Power;
  chartInstance.chartInfo.getSimState =
    sf_opaque_get_sim_state_c20_adcs_v15_integral_Power;
  chartInstance.chartInfo.setSimState =
    sf_opaque_set_sim_state_c20_adcs_v15_integral_Power;
  chartInstance.chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c20_adcs_v15_integral_Power;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW = mdlRTW_c20_adcs_v15_integral_Power;
  chartInstance.chartInfo.mdlStart = mdlStart_c20_adcs_v15_integral_Power;
  chartInstance.chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c20_adcs_v15_integral_Power;
  chartInstance.chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c20_adcs_v15_integral_Power;
...
void c20_adcs_v15_integral_Power_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c20_adcs_v15_integral_Power(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c20_adcs_v15_integral_Power(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c20_adcs_v15_integral_Power(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c20_adcs_v15_integral_Power_method_dispatcher.\n"

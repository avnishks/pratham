...
static SFc8_adcs_v15_integral_Power_distInstanceStruct chartInstance;

/* Function Declarations */
static void initialize_c8_adcs_v15_integral_Power_dist(void);
static void initialize_params_c8_adcs_v15_integral_Power_dist(void);
static void enable_c8_adcs_v15_integral_Power_dist(void);
static void disable_c8_adcs_v15_integral_Power_dist(void);
static void c8_update_debugger_state_c8_adcs_v15_integral_Power_dist(void);
static void ext_mode_exec_c8_adcs_v15_integral_Power_dist(void);
static const mxArray *get_sim_state_c8_adcs_v15_integral_Power_dist(void);
static void set_sim_state_c8_adcs_v15_integral_Power_dist(const mxArray *c8_st);
static void finalize_c8_adcs_v15_integral_Power_dist(void);
static void sf_c8_adcs_v15_integral_Power_dist(void);
static void c8_c8_adcs_v15_integral_Power_dist(void);
...
static void initialize_c8_adcs_v15_integral_Power_dist(void)
{
  uint8_T *c8_is_active_c8_adcs_v15_integral_Power_dist;
  c8_is_active_c8_adcs_v15_integral_Power_dist = (uint8_T *)ssGetDWork
    (chartInstance.S, 2);
  _sfTime_ = (real_T)ssGetT(chartInstance.S);
  *c8_is_active_c8_adcs_v15_integral_Power_dist = 0U;
}
...
static void ext_mode_exec_c8_adcs_v15_integral_Power_dist(void)
{
  c8_update_debugger_state_c8_adcs_v15_integral_Power_dist();
}
...
static const mxArray *get_sim_state_c8_adcs_v15_integral_Power_dist(void)
{
  ...
  c8_b_u = *c8_is_active_c8_adcs_v15_integral_Power_dist;
  c8_c_y = NULL;
...
static void set_sim_state_c8_adcs_v15_integral_Power_dist(const mxArray *c8_st)
{
  ...
  real_T c8_y[3];
  int32_T c8_i2;
  const mxArray *c8_is_active_c8_adcs_v15_integral_Power_dist;
  uint8_T c8_u0;
  uint8_T c8_b_y;
  boolean_T *c8_doneDoubleBufferReInit;
  uint8_T *c8_b_is_active_c8_adcs_v15_integral_Power_dist;
  ...
  c8_b_is_active_c8_adcs_v15_integral_Power_dist = (uint8_T *)ssGetDWork
    (chartInstance.S, 2);
  *c8_doneDoubleBufferReInit = true;
  ...
  c8_is_active_c8_adcs_v15_integral_Power_dist = sf_mex_dup(sf_mex_getcell(c8_u,
    1));
  sf_mex_import("is_active_c8_adcs_v15_integral_Power_dist", sf_mex_dup
                (c8_is_active_c8_adcs_v15_integral_Power_dist), &c8_u0, 1, 3,
                0U, 0, 0U, 0);
  c8_b_y = c8_u0;
  sf_mex_destroy(&c8_is_active_c8_adcs_v15_integral_Power_dist);
  *c8_b_is_active_c8_adcs_v15_integral_Power_dist = c8_b_y;
  sf_mex_destroy(&c8_u);
  c8_update_debugger_state_c8_adcs_v15_integral_Power_dist();
...
static void sf_c8_adcs_v15_integral_Power_dist(void)
{
  ...
  c8_c8_adcs_v15_integral_Power_dist();
...
const mxArray
  *sf_c8_adcs_v15_integral_Power_dist_get_eml_resolved_functions_info(void)
{
...
/* SFunction Glue Code */
void sf_c8_adcs_v15_integral_Power_dist_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c8_adcs_v15_integral_Power_dist_get_autoinheritance_info(void)
{
...
static mxArray *sf_get_sim_state_info_c8_adcs_v15_integral_Power_dist(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"solar_drag\",},{M[8],M[0],T\"is_active_c8_adcs_v15_integral_Power_dist\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c8_adcs_v15_integral_Power_dist_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c8_adcs_v15_integral_Power_dist(void
  *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c8_adcs_v15_integral_Power_dist();
  initialize_c8_adcs_v15_integral_Power_dist();
}

static void sf_opaque_enable_c8_adcs_v15_integral_Power_dist(void
  *chartInstanceVar)
{
  enable_c8_adcs_v15_integral_Power_dist();
}

static void sf_opaque_disable_c8_adcs_v15_integral_Power_dist(void
  *chartInstanceVar)
{
  disable_c8_adcs_v15_integral_Power_dist();
}

static void sf_opaque_gateway_c8_adcs_v15_integral_Power_dist(void
  *chartInstanceVar)
{
  sf_c8_adcs_v15_integral_Power_dist();
}

static void sf_opaque_ext_mode_exec_c8_adcs_v15_integral_Power_dist(void
  *chartInstanceVar)
{
  ext_mode_exec_c8_adcs_v15_integral_Power_dist();
}

static mxArray* sf_opaque_get_sim_state_c8_adcs_v15_integral_Power_dist(void
  *chartInstanceVar)
{
  mxArray *st = (mxArray *) get_sim_state_c8_adcs_v15_integral_Power_dist();
  return st;
}

static void sf_opaque_set_sim_state_c8_adcs_v15_integral_Power_dist(void
  *chartInstanceVar, const mxArray *st)
{
  set_sim_state_c8_adcs_v15_integral_Power_dist(sf_mex_dup(st));
}

static void sf_opaque_terminate_c8_adcs_v15_integral_Power_dist(void
  *chartInstanceVar)
{
  ...
  finalize_c8_adcs_v15_integral_Power_dist();
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c8_adcs_v15_integral_Power_dist(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c8_adcs_v15_integral_Power_dist(SimStruct *S)
{
...
static void mdlRTW_c8_adcs_v15_integral_Power_dist(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c8_adcs_v15_integral_Power_dist(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 1;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway =
    sf_opaque_gateway_c8_adcs_v15_integral_Power_dist;
  chartInstance.chartInfo.initializeChart =
    sf_opaque_initialize_c8_adcs_v15_integral_Power_dist;
  chartInstance.chartInfo.terminateChart =
    sf_opaque_terminate_c8_adcs_v15_integral_Power_dist;
  chartInstance.chartInfo.enableChart =
    sf_opaque_enable_c8_adcs_v15_integral_Power_dist;
  chartInstance.chartInfo.disableChart =
    sf_opaque_disable_c8_adcs_v15_integral_Power_dist;
  chartInstance.chartInfo.getSimState =
    sf_opaque_get_sim_state_c8_adcs_v15_integral_Power_dist;
  chartInstance.chartInfo.setSimState =
    sf_opaque_set_sim_state_c8_adcs_v15_integral_Power_dist;
  chartInstance.chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c8_adcs_v15_integral_Power_dist;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW = mdlRTW_c8_adcs_v15_integral_Power_dist;
  chartInstance.chartInfo.mdlStart = mdlStart_c8_adcs_v15_integral_Power_dist;
  chartInstance.chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c8_adcs_v15_integral_Power_dist;
  chartInstance.chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c8_adcs_v15_integral_Power_dist;
...
void c8_adcs_v15_integral_Power_dist_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c8_adcs_v15_integral_Power_dist(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c8_adcs_v15_integral_Power_dist(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c8_adcs_v15_integral_Power_dist(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c8_adcs_v15_integral_Power_dist_method_dispatcher.\n"

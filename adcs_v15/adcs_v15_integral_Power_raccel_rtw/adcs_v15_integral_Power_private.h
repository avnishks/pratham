#ifndef RTW_HEADER_adcs_v15_integral_Power_private_h_
#define RTW_HEADER_adcs_v15_integral_Power_private_h_
#include "rtwtypes.h"
#define CALL_EVENT                     (-1)
...
int_T rt_WriteMat4FileHeader(FILE *fp,
  ...
  int32_T n,
  const char_T *name);
extern void adcs_v15_integral_Power_QuEST_Init(void);
extern void adcs_v15_integral_Power_QuEST(void);

#if !defined(MULTITASKING) && !defined(NRT)
#  error Model (adcs_v15_integral_Power) was built \

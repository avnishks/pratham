...
#include "adcs_v15_integral_Power_dt.h"
...
FrFInfo adcs_v15_integral_Power_gblFrFInfo[7];

#include "simstruc.h"
#include "fixedpoint.h"

#define adcs_v15_integral_Power_Snum   (6.0)
#define adcs_v15_integral_Power_s_MAGMETER_WEIGHT (0.9)

#define adcs_v15_integral_Power_check_time (10000.0)
#define adcs_v15_integral_Power_tol_q4 (0.85)
#define adcs_v15_integral_Power_tol_w  (0.004)
#define adcs_v15_integral_Power_tolw_n2d (0.01)

#define adcs_v15_integral_Power_s_FRAME_SIZE (2.0)
...
static real_T adcs_v15_integral_Power_norm(const real_T eml_x[3]);
static real_T adcs_v15_integral_Power_dot(const real_T eml_a[3], const real_T
  eml_b[3]);
static real_T adcs_v15_integral_Power_norm_k(const real_T eml_x[3]);
static void adcs_v15_integral_Power_c11_adcs_v15_integral_Power(void);
static real_T adcs_v15_integral_Power_dot_b(const real_T eml_a[3], const real_T
  eml_b[3]);
static real_T adcs_v15_integral_Power_dot_l(const real_T eml_a[3], const real_T
  eml_b[3]);
static real_T adcs_v15_integral_Power_dot_o(const real_T eml_a[3], const real_T
  eml_b[3]);
static real_T adcs_v15_integral_Power_dot_g(const real_T eml_a[3], const real_T
  eml_b[3]);
static real_T adcs_v15_integral_Power_norm_l(const real_T eml_x[3]);
static real_T adcs_v15_integral_Power_norm_j(const real_T eml_x[3]);
static real_T adcs_v15_integral_Power_isro_battery(real_T eml_x, real_T
...
static void adcs_v15_integral_Power_c11_adcs_v15_integral_Power(void)
{
  ...
  memcpy((void *)&eml_m_SUN[0], (void *)&rtB.TmpRTBAtQuESTInport2[0], 30U *
         sizeof(real_T));
  eml_b_0 = muDoubleScalarCos(rtP.SFunction_p4_d * 3.1415926535897931E+000 /
    180.0);
  ...
  eml_b_0 = 0.0;
  for (eml_i = 1; eml_i <= (int32_T)adcs_v15_integral_Power_Snum; eml_i++) {
    if (eml_values[eml_i - 1] < 2.5) {
      eml_b_0++;
    }
  }

  if (eml_b_0 == adcs_v15_integral_Power_Snum) {
    eml_i = 0;
  } else {
    eml_i = 1;
  }
  ...
  if (eml_i == 1) {
    ...
    while (1) {
      ...
      if (!(adcs_v15_integral_Power_norm(eml_m_SUN_2) == 0.0)) {
        break;
      }

      eml_b_0++;
      eml_i = (int32_T)eml_idx[(int32_T)(adcs_v15_integral_Power_Snum - eml_b_0)
        - 1];
    }
    ...
    while (1) {
      ...
      if (!((adcs_v15_integral_Power_norm(eml_m_SUN_0) == 0.0) ||
            (adcs_v15_integral_Power_norm(eml_m_SUN_1) == 0.0))) {
        break;
      }
    ...
    eml_b_0 = muDoubleScalarSqrt(adcs_v15_integral_Power_dot(&rtB.v_Sun1[0],
      &rtB.v_Sun1[0]));
    ...
    eml_b_0 = adcs_v15_integral_Power_norm_k(eml_b);
    eml_b[0] /= eml_b_0;
    eml_b[1] /= eml_b_0;
    eml_b[2] /= eml_b_0;
    eml_r[0] = rtB.v_O_l[1] * rtB.v_O[2] - rtB.v_O_l[2] * rtB.v_O[1];
    eml_r[1] = rtB.v_O_l[2] * rtB.v_O[0] - rtB.v_O_l[0] * rtB.v_O[2];
    eml_r[2] = rtB.v_O_l[0] * rtB.v_O[1] - rtB.v_O_l[1] * rtB.v_O[0];
    eml_b_0 = adcs_v15_integral_Power_norm_k(eml_r);
    eml_r[0] /= eml_b_0;
    eml_r[1] /= eml_b_0;
    eml_r[2] /= eml_b_0;
    ...
    tmp_0[0] = (rtB.TmpRTBAtQuESTInport1[1] * rtB.v_O_l[2] -
                rtB.TmpRTBAtQuESTInport1[2] * rtB.v_O_l[1]) *
      adcs_v15_integral_Power_s_MAGMETER_WEIGHT + (eml_ssvalues[1] * rtB.v_O[2]
      - eml_ssvalues[2] * rtB.v_O[1]) * 9.9999999999999978E-002;
    eml_b_1[0] = eml_b[0] + eml_r[0];
    tmp_0[1] = (rtB.TmpRTBAtQuESTInport1[2] * rtB.v_O_l[0] -
                rtB.TmpRTBAtQuESTInport1[0] * rtB.v_O_l[2]) *
      adcs_v15_integral_Power_s_MAGMETER_WEIGHT + (eml_ssvalues[2] * rtB.v_O[0]
      - eml_ssvalues[0] * rtB.v_O[2]) * 9.9999999999999978E-002;
    eml_b_1[1] = eml_b[1] + eml_r[1];
    tmp_0[2] = (rtB.TmpRTBAtQuESTInport1[0] * rtB.v_O_l[1] -
                rtB.TmpRTBAtQuESTInport1[1] * rtB.v_O_l[0]) *
      adcs_v15_integral_Power_s_MAGMETER_WEIGHT + (eml_ssvalues[0] * rtB.v_O[1]
      - eml_ssvalues[1] * rtB.v_O[0]) * 9.9999999999999978E-002;
    eml_b_1[2] = eml_b[2] + eml_r[2];
    eml_b_0 = (0.9 * adcs_v15_integral_Power_dot(&rtB.TmpRTBAtQuESTInport1[0],
                &rtB.v_O_l[0]) + 9.9999999999999978E-002 *
               adcs_v15_integral_Power_dot(eml_ssvalues, &rtB.v_O[0])) * (1.0 +
      adcs_v15_integral_Power_dot(eml_b, eml_r)) + adcs_v15_integral_Power_dot
      (eml_b_2, tmp_0);
    tmp[0] = (rtB.TmpRTBAtQuESTInport1[1] * rtB.v_O_l[2] -
              rtB.TmpRTBAtQuESTInport1[2] * rtB.v_O_l[1]) *
      adcs_v15_integral_Power_s_MAGMETER_WEIGHT + (eml_ssvalues[1] * rtB.v_O[2]
      - eml_ssvalues[2] * rtB.v_O[1]) * 9.9999999999999978E-002;
    tmp[1] = (rtB.TmpRTBAtQuESTInport1[2] * rtB.v_O_l[0] -
              rtB.TmpRTBAtQuESTInport1[0] * rtB.v_O_l[2]) *
      adcs_v15_integral_Power_s_MAGMETER_WEIGHT + (eml_ssvalues[2] * rtB.v_O[0]
      - eml_ssvalues[0] * rtB.v_O[2]) * 9.9999999999999978E-002;
    tmp[2] = (rtB.TmpRTBAtQuESTInport1[0] * rtB.v_O_l[1] -
              rtB.TmpRTBAtQuESTInport1[1] * rtB.v_O_l[0]) *
      adcs_v15_integral_Power_s_MAGMETER_WEIGHT + (eml_ssvalues[0] * rtB.v_O[1]
      - eml_ssvalues[1] * rtB.v_O[0]) * 9.9999999999999978E-002;
    eml_nu = adcs_v15_integral_Power_dot(eml_b_1, tmp);
    eml_maxval = muDoubleScalarSqrt(eml_b_0 * eml_b_0 + eml_nu * eml_nu);
    if (eml_b_0 > 0.0) {
      eml_k_q_triad = 1.0 / (muDoubleScalarSqrt((eml_maxval + eml_b_0) *
        eml_maxval * (1.0 + adcs_v15_integral_Power_dot(eml_b, eml_r))) * 2.0);
      ...
      rtB.q_BO_est[3] = (eml_maxval + eml_b_0) * (1.0 +
        adcs_v15_integral_Power_dot(eml_b, eml_r)) * eml_k_q_triad;
    } else {
      eml_k_q_triad = 1.0 / (muDoubleScalarSqrt((eml_maxval - eml_b_0) *
        eml_maxval * (1.0 + adcs_v15_integral_Power_dot(eml_b, eml_r))) * 2.0);
      ...
      rtB.q_BO_est[3] = (1.0 + adcs_v15_integral_Power_dot(eml_b, eml_r)) *
...
void adcs_v15_integral_Power_QuEST_Init(void)
{
  rtDWork.is_active_c11_adcs_v15_integral_Power = 0U;
}

void adcs_v15_integral_Power_QuEST(void)
{
  adcs_v15_integral_Power_c11_adcs_v15_integral_Power();
}
...
{
  {
    ...
    rtDWork.is_active_c7_adcs_v15_integral_Power = 0U;
    rtDWork.is_active_c29_adcs_v15_integral_Power = 0U;
    rtDWork.is_active_c5_adcs_v15_integral_Power = 0U;
    rtDWork.is_active_c4_adcs_v15_integral_Power = 0U;
    rtDWork.is_active_c22_adcs_v15_integral_Power = 0U;
    rtDWork.is_active_c25_adcs_v15_integral_Power = 0U;
    rtDWork.is_active_c12_adcs_v15_integral_Power = 0U;
    adcs_v15_integral_Power_QuEST_Init();
    rtDWork.IntegerDelay1_X_a[0] = rtP.IntegerDelay1_InitialCondition_a[0];
    rtDWork.IntegerDelay1_X_a[1] = rtP.IntegerDelay1_InitialCondition_a[1];
    rtDWork.IntegerDelay1_X_a[2] = rtP.IntegerDelay1_InitialCondition_a[2];
    rtDWork.IntegerDelay_X_n[0] = rtP.IntegerDelay_InitialCondition_b;
    rtDWork.IntegerDelay_X_n[1] = rtP.IntegerDelay_InitialCondition_b;
    rtDWork.IntegerDelay_X_n[2] = rtP.IntegerDelay_InitialCondition_b;
    rtDWork.IntegerDelay_X_n[3] = rtP.IntegerDelay_InitialCondition_b;
    rtDWork.is_active_c27_adcs_v15_integral_Power = 0U;
    for (i = 0; i < 300; i++) {
      rtDWork.IntegerDelay_X_c[i] = rtP.IntegerDelay_InitialCondition_d;
    }

    rtDWork.is_active_c6_adcs_v15_integral_Power = 0U;
    rtDWork.is_active_c10_adcs_v15_integral_Power = 0U;
    rtDWork.is_active_c23_adcs_v15_integral_Power = 0U;
    rtDWork.is_active_c13_adcs_v15_integral_Power = 0U;
    rtDWork.UnitDelay1_DSTATE_p = rtP.UnitDelay1_X0_c;
    rtDWork.UnitDelay_DSTATE = rtP.UnitDelay_X0;
    rtDWork.is_active_c24_adcs_v15_integral_Power = 0U;
    rtDWork.is_active_c1_adcs_v15_integral_Power = 0U;
    rtDWork.IntegerDelay_X_c4[0] = rtP.IntegerDelay_InitialCondition_o;
    rtDWork.UnitDelay1_DSTATE[0] = rtP.UnitDelay1_X0[0];
    rtDWork.TmpRTBAtProductInport2_Buffer0[0] = rtP.TmpRTBAtProductInport2_X0;
    rtDWork.IntegerDelay_X_c4[1] = rtP.IntegerDelay_InitialCondition_o;
    rtDWork.UnitDelay1_DSTATE[1] = rtP.UnitDelay1_X0[1];
    rtDWork.TmpRTBAtProductInport2_Buffer0[1] = rtP.TmpRTBAtProductInport2_X0;
    rtDWork.IntegerDelay_X_c4[2] = rtP.IntegerDelay_InitialCondition_o;
    rtDWork.UnitDelay1_DSTATE[2] = rtP.UnitDelay1_X0[2];
    rtDWork.TmpRTBAtProductInport2_Buffer0[2] = rtP.TmpRTBAtProductInport2_X0;
    rtDWork.is_active_c9_adcs_v15_integral_Power = 0U;
    rtDWork.is_active_c20_adcs_v15_integral_Power = 0U;
    rtDWork.is_active_c16_adcs_v15_integral_Power = 0U;
    rtDWork.is_active_c8_adcs_v15_integral_Power = 0U;
    rtDWork.is_active_c2_adcs_v15_integral_Power = 0U;
    ...
    rtDWork.is_active_c30_adcs_v15_integral_Power = 0U;
    rtDWork.is_active_c28_adcs_v15_integral_Power = 0U;
    rtDWork.is_active_c19_adcs_v15_integral_Power = 0U;
    rtDWork.is_active_c31_adcs_v15_integral_Power = 0U;
    ...
    rtDWork.is_active_c26_adcs_v15_integral_Power = 0U;
    rtX.Integrator_CSTATE_c = rtP.Integrator_IC_e;
  }
}
...
{
  {
...

    {
      ...
      if ((result=rt_ReadFromfileMatFile("SGP_120k.mat",7,
            &adcs_v15_integral_Power_gblFrFInfo[0])) != (NULL)) {
        ssSetErrorStatus(rtS, result);
        return;
      }

      rtDWork.FromFile_PWORK.PrevTimePtr = (void *)
        adcs_v15_integral_Power_gblFrFInfo[0].tuDataMatrix;
    }
...

    {
      ...
      if ((result=rt_ReadFromfileMatFile("Bi_120k.mat",4,
            &adcs_v15_integral_Power_gblFrFInfo[1])) != (NULL)) {
        ssSetErrorStatus(rtS, result);
        return;
      }

      rtDWork.FromFile1_PWORK.PrevTimePtr = (void *)
        adcs_v15_integral_Power_gblFrFInfo[1].tuDataMatrix;
    }

    rtB.Constant_l[0] = rtP.Constant_Value_e[0];
    rtB.Constant_l[1] = rtP.Constant_Value_e[1];
    rtB.Constant_l[2] = rtP.Constant_Value_e[2];

    {
      const char *result;
      if ((result=rt_ReadFromfileMatFile("Si_120k.mat",4,
            &adcs_v15_integral_Power_gblFrFInfo[2])) != (NULL)) {
        ssSetErrorStatus(rtS, result);
        return;
      }

      rtDWork.FromFile_PWORK_f.PrevTimePtr = (void *)
        adcs_v15_integral_Power_gblFrFInfo[2].tuDataMatrix;
    }

    {
      const char *result;
      if ((result=rt_ReadFromfileMatFile("light_120k.mat",2,
            &adcs_v15_integral_Power_gblFrFInfo[3])) != (NULL)) {
        ssSetErrorStatus(rtS, result);
        return;
      }

      rtDWork.FromFile2_PWORK.PrevTimePtr = (void *)
        adcs_v15_integral_Power_gblFrFInfo[3].tuDataMatrix;
    }
    ...
    rtDWork.NextOutput_e = rt_NormalRand(&rtDWork.RandSeed_g) *
      rtP.RandomNumber_StdDev_l + rtP.RandomNumber_Mean_f;
    rtB.Constant_o[0] = rtP.Constant_Value_j[0];
    rtB.Constant_o[1] = rtP.Constant_Value_j[1];
    rtB.Constant_o[2] = rtP.Constant_Value_j[2];
    ...
    rtDWork.NextOutput_l = rt_NormalRand(&rtDWork.RandSeed_e) *
      rtP.RandomNumber_StdDev_e + rtP.RandomNumber_Mean_g;
    rtB.Constant_k[0] = rtP.Constant_Value_a[0];
    rtB.Constant_k[1] = rtP.Constant_Value_a[1];
    rtB.Constant_k[2] = rtP.Constant_Value_a[2];
    if (rtIsNaN(rtP.RandomNumber_Seed_d) || rtIsInf(rtP.RandomNumber_Seed_d)) {
      tmp = 0.0;
    } else {
      tmp = muDoubleScalarRem(muDoubleScalarFloor(rtP.RandomNumber_Seed_d),
        4.294967296E+009);
    }
    ...
    rtDWork.RandSeed_h = tseed;
    rtDWork.NextOutput_lr = rt_NormalRand(&rtDWork.RandSeed_h) *
      rtP.RandomNumber_StdDev_b + rtP.RandomNumber_Mean_l;
    rtB.Constant_lf[0] = rtP.Constant_Value_i[0];
    rtB.Constant_lf[1] = rtP.Constant_Value_i[1];
    rtB.Constant_lf[2] = rtP.Constant_Value_i[2];
    if (rtIsNaN(rtP.RandomNumber_Seed_a) || rtIsInf(rtP.RandomNumber_Seed_a)) {
      tmp = 0.0;
    } else {
      tmp = muDoubleScalarRem(muDoubleScalarFloor(rtP.RandomNumber_Seed_a),
        4.294967296E+009);
    }
    ...
    rtDWork.NextOutput_d = rt_NormalRand(&rtDWork.RandSeed_b) *
      rtP.RandomNumber_StdDev_lg + rtP.RandomNumber_Mean_j;
    rtB.Constant_n[0] = rtP.Constant_Value_n3[0];
    rtB.Constant_n[1] = rtP.Constant_Value_n3[1];
    rtB.Constant_n[2] = rtP.Constant_Value_n3[2];
    if (rtIsNaN(rtP.RandomNumber_Seed_j) || rtIsInf(rtP.RandomNumber_Seed_j)) {
      tmp = 0.0;
    } else {
      tmp = muDoubleScalarRem(muDoubleScalarFloor(rtP.RandomNumber_Seed_j),
        4.294967296E+009);
    }
    ...
    rtDWork.RandSeed_gf = tseed;
    rtDWork.NextOutput_c = rt_NormalRand(&rtDWork.RandSeed_gf) *
      rtP.RandomNumber_StdDev_a + rtP.RandomNumber_Mean_d;
    rtB.Constant_oh[0] = rtP.Constant_Value_o[0];
    rtB.Constant_oh[1] = rtP.Constant_Value_o[1];
    rtB.Constant_oh[2] = rtP.Constant_Value_o[2];
    if (rtIsNaN(rtP.RandomNumber_Seed_i) || rtIsInf(rtP.RandomNumber_Seed_i)) {
      tmp = 0.0;
    } else {
      tmp = muDoubleScalarRem(muDoubleScalarFloor(rtP.RandomNumber_Seed_i),
        4.294967296E+009);
    }
    ...
    rtDWork.RandSeed_hg = tseed;
    rtDWork.NextOutput_i = rt_NormalRand(&rtDWork.RandSeed_hg) *
      rtP.RandomNumber_StdDev_d + rtP.RandomNumber_Mean_c;

    {
      const char *result;
      if ((result=rt_ReadFromfileMatFile("Si_120k.mat",4,
            &adcs_v15_integral_Power_gblFrFInfo[4])) != (NULL)) {
        ssSetErrorStatus(rtS, result);
        return;
      }

      rtDWork.FromFile_PWORK_i.PrevTimePtr = (void *)
        adcs_v15_integral_Power_gblFrFInfo[4].tuDataMatrix;
    }

    {
      const char *result;
      if ((result=rt_ReadFromfileMatFile("SGP_est_120k.mat",7,
            &adcs_v15_integral_Power_gblFrFInfo[5])) != (NULL)) {
        ssSetErrorStatus(rtS, result);
        return;
      }

      rtDWork.FromFile2_PWORK_n.PrevTimePtr = (void *)
        adcs_v15_integral_Power_gblFrFInfo[5].tuDataMatrix;
    }

    {
      const char *result;
      if ((result=rt_ReadFromfileMatFile("Bi8_est_120k.mat",4,
            &adcs_v15_integral_Power_gblFrFInfo[6])) != (NULL)) {
        ssSetErrorStatus(rtS, result);
        return;
      }

      rtDWork.FromFile3_PWORK.PrevTimePtr = (void *)
        adcs_v15_integral_Power_gblFrFInfo[6].tuDataMatrix;
    }
    ...
    rtB.Constant_p = rtP.Constant_Value_d;
...
void MdlOutputs(int_T tid)
{
...

  {
    ...
    static real_T tmp_5[9] = { 6.7710427973701772E-004, -4.2419745512218675E-006,
      -3.5737964722194352E-006, -4.2419745512218675E-006,
      6.8317419624151548E-004, -1.4355590362665846E-005,
      -3.5737964722194352E-006, -1.4355590362665846E-005,
      6.3136412874267845E-004 };

    static real_T tmp_6[9] = { 3.9201215881351366E+000, 2.4819002306591301E-002,
      2.2753918822219242E-002, 2.4819002306591301E-002, 3.8870328836814432E+000,
      8.8521579422844221E-002, 2.2753918822219242E-002, 8.8521579422844235E-002,
      4.2059668604554830E+000 };

    static real_T tmp_7[9] = { 2.5511206283999999E-001, -1.5982455149999998E-003,
      -0.00134649657, -1.5982455149999998E-003, 2.5739902064999998E-001,
      -5.4087448275000000E-003, -0.00134649657, -5.4087448275000000E-003,
      2.3787858104999998E-001 };

    static real_T tmp_8[9] = { 3.4796209949396335E-007, -2.1799395086033269E-009,
      -1.8365645600712765E-009, -2.1799395086033269E-009,
      3.5108141354035872E-007, -7.3772999396911418E-009,
      -1.8365645600712765E-009, -7.3772999396911418E-009,
    ...
    if (ssIsContinuousTask(rtS, tid)) {
...

      {
        ...
        if (adcs_v15_integral_Power_gblFrFInfo[0].nptsPerSignal == 1) {
          {
            int_T i1;
          ...
          pU = pStart + adcs_v15_integral_Power_gblFrFInfo[0].nptsPerSignal - 2;
          if (time <= pStart[0]) {
            pT = pStart;
          } else if (time >= pU[0]) {
            pT = pU;
          ...
          pU = pT + adcs_v15_integral_Power_gblFrFInfo[0].nptsPerSignal;
          if (pT[0] == pT[1]) {
            {
              int_T i1;
              real_T *y0 = rtB.FromFile;
              for (i1=0; i1 < 6; i1++) {
                ...
                pU += adcs_v15_integral_Power_gblFrFInfo[0].nptsPerSignal;
              }
            }
          } else {
      ...
      eml_B = muDoubleScalarSqrt(adcs_v15_integral_Power_dot_b(eml_oy, eml_oy));
      eml_oy[0] /= eml_B;
      eml_oy[1] /= eml_B;
      eml_oy[2] /= eml_B;
      eml_B = muDoubleScalarSqrt(adcs_v15_integral_Power_dot_b(eml_r, eml_r));
      ...
      eml_B = muDoubleScalarSqrt(adcs_v15_integral_Power_dot_b(eml_v, eml_v));
      ...
      rtB.modw = muDoubleScalarSqrt(adcs_v15_integral_Power_dot_b(&rtB.w_BOB[0],
        &rtB.w_BOB[0]));
    ...
    if (ssIsContinuousTask(rtS, tid)) {
      {
        ...
        if (adcs_v15_integral_Power_gblFrFInfo[1].nptsPerSignal == 1) {
          rtb_Product[0] = pT[1];
          rtb_Product[1] = pT[2];
          rtb_Product[2] = pT[3];
        } else {
          pU = pStart + adcs_v15_integral_Power_gblFrFInfo[1].nptsPerSignal - 2;
          if (time <= pStart[0]) {
            pT = pStart;
          } else if (time >= pU[0]) {
            pT = pU;
          ...
          pU = pT + adcs_v15_integral_Power_gblFrFInfo[1].nptsPerSignal;
          if (pT[0] == pT[1]) {
            rtb_Product[0] = pU[ (time < pT[0]) ? 0 : 1 ];
            pU += adcs_v15_integral_Power_gblFrFInfo[1].nptsPerSignal;
      ...
      for (i = 0; i < 3; i++) {
        rtB.v_B_n[i] = 0.0;
        rtB.v_B_n[i] = eml_v_0[i] * rtB.Gain[0] + rtB.v_B_n[i];
        rtB.v_B_n[i] = eml_v_0[i + 3] * rtB.Gain[1] + rtB.v_B_n[i];
        rtB.v_B_n[i] = eml_v_0[i + 6] * rtB.Gain[2] + rtB.v_B_n[i];
      }
    }

    if (ssIsSampleHit(rtS, 1, tid)) {
      rtB.Constant = rtP.Constant_Value_n;
    }

    if (ssIsContinuousTask(rtS, tid)) {
      rtB.Sum1[0] = (rtB.Buffer + rtB.v_B_n[0]) + rtB.Constant;
      rtB.Sum1[1] = (rtB.Buffer + rtB.v_B_n[1]) + rtB.Constant;
      rtB.Sum1[2] = (rtB.Buffer + rtB.v_B_n[2]) + rtB.Constant;
    ...
    if (ssIsContinuousTask(rtS, tid)) {
      {
        ...
        real_T time = ssGetTaskTime(rtS,tid);
        const real_T *pU = (NULL);
        const real_T *pT = (const real_T *) rtDWork.FromFile_PWORK_f.PrevTimePtr;
        if (initBasePtr == TRUE) {
          pStart = (real_T *) rtDWork.FromFile_PWORK_f.PrevTimePtr;
          initBasePtr = FALSE;
        }

        if (adcs_v15_integral_Power_gblFrFInfo[2].nptsPerSignal == 1) {
          rtB.FromFile_e[0] = pT[1];
          rtB.FromFile_e[1] = pT[2];
          rtB.FromFile_e[2] = pT[3];
        } else {
          pU = pStart + adcs_v15_integral_Power_gblFrFInfo[2].nptsPerSignal - 2;
          if (time <= pStart[0]) {
            pT = pStart;
          } else if (time >= pU[0]) {
            pT = pU;
          ...
          rtDWork.FromFile_PWORK_f.PrevTimePtr = (void *) pT;
          pU = pT + adcs_v15_integral_Power_gblFrFInfo[2].nptsPerSignal;
          if (pT[0] == pT[1]) {
            rtB.FromFile_e[0] = pU[ (time < pT[0]) ? 0 : 1 ];
            pU += adcs_v15_integral_Power_gblFrFInfo[2].nptsPerSignal;
...

      {
        ...
        if (adcs_v15_integral_Power_gblFrFInfo[3].nptsPerSignal == 1) {
          rtB.FromFile2 = pT[1];
        } else {
          pU = pStart + adcs_v15_integral_Power_gblFrFInfo[3].nptsPerSignal - 2;
          if (time <= pStart[0]) {
            pT = pStart;
          } else if (time >= pU[0]) {
            pT = pU;
          ...
          pU = pT + adcs_v15_integral_Power_gblFrFInfo[3].nptsPerSignal;
          if (pT[0] == pT[1]) {
      ...
      rtb_Gain = rtP.Gain_Gain_p * rt_SATURATE(rtb_jxi, rtP.Saturation_LowerSat,
        rtP.Saturation_UpperSat);
    }

    if (ssIsSampleHit(rtS, 1, tid)) {
      rtB.Sum_e = rtP.MatrixGain_Gain_m * rtDWork.NextOutput_e +
        rtP.Constant_Value_l;

      {
        rtB.Buffer_o = rtB.Sum_e;
      }
    }

    if (ssIsContinuousTask(rtS, tid)) {
      rtb_jxi = rtb_Gain + rtB.Buffer_o;
    ...
    if (ssIsContinuousTask(rtS, tid)) {
      rtb_jxi = (rtB.Constant_o[0] * rtB.v_B[0] + rtB.Constant_o[1] * rtB.v_B[1])
        + rtB.Constant_o[2] * rtB.v_B[2];
      rtb_jxi *= rtB.FromFile2;
      rtb_Gain_c = rtP.Gain_Gain_o * rt_SATURATE(rtb_jxi,
        rtP.Saturation_LowerSat_f, rtP.Saturation_UpperSat_d);
    }

    if (ssIsSampleHit(rtS, 1, tid)) {
      rtB.Sum_a = rtP.MatrixGain_Gain_a * rtDWork.NextOutput_l +
        rtP.Constant_Value_c;

      {
        rtB.Buffer_a = rtB.Sum_a;
      }
    }

    if (ssIsContinuousTask(rtS, tid)) {
      rtb_jxi = rtb_Gain_c + rtB.Buffer_a;
      rtB.ADC_m = rtP.ADC_Interval_k * muDoubleScalarRound((rtb_jxi/
        (rtP.ADC_Interval_k)));
    }
    ...
    if (ssIsContinuousTask(rtS, tid)) {
      ...
      rtb_jxi *= rtB.FromFile2;
      rtb_Gain_k = rtP.Gain_Gain_o3 * rt_SATURATE(rtb_jxi,
        rtP.Saturation_LowerSat_e, rtP.Saturation_UpperSat_h);
    }

    if (ssIsSampleHit(rtS, 1, tid)) {
      rtB.Sum_d = rtP.MatrixGain_Gain_j * rtDWork.NextOutput_lr +
        rtP.Constant_Value_eb;

      {
        rtB.Buffer_k = rtB.Sum_d;
      }
    }

    if (ssIsContinuousTask(rtS, tid)) {
      rtb_jxi = rtb_Gain_k + rtB.Buffer_k;
      rtB.ADC_i = rtP.ADC_Interval_n * muDoubleScalarRound((rtb_jxi/
        (rtP.ADC_Interval_n)));
    }
    ...
    if (ssIsContinuousTask(rtS, tid)) {
      rtb_jxi = (rtB.Constant_lf[0] * rtB.v_B[0] + rtB.Constant_lf[1] * rtB.v_B
                 [1]) + rtB.Constant_lf[2] * rtB.v_B[2];
      rtb_jxi *= rtB.FromFile2;
      rtb_Gain_g = rtP.Gain_Gain_a * rt_SATURATE(rtb_jxi,
        rtP.Saturation_LowerSat_p, rtP.Saturation_UpperSat_a);
    }

    if (ssIsSampleHit(rtS, 1, tid)) {
      rtB.Sum_m = rtP.MatrixGain_Gain_b * rtDWork.NextOutput_d +
        rtP.Constant_Value_g;

      {
        rtB.Buffer_p = rtB.Sum_m;
      }
    }

    if (ssIsContinuousTask(rtS, tid)) {
      rtb_jxi = rtb_Gain_g + rtB.Buffer_p;
      rtB.ADC_d = rtP.ADC_Interval_d * muDoubleScalarRound((rtb_jxi/
        (rtP.ADC_Interval_d)));
    }
    ...
    if (ssIsContinuousTask(rtS, tid)) {
      rtb_jxi = (rtB.Constant_n[0] * rtB.v_B[0] + rtB.Constant_n[1] * rtB.v_B[1])
        + rtB.Constant_n[2] * rtB.v_B[2];
      rtb_jxi *= rtB.FromFile2;
      rtb_Gain_p = rtP.Gain_Gain_i * rt_SATURATE(rtb_jxi,
        rtP.Saturation_LowerSat_h, rtP.Saturation_UpperSat_b);
    }

    if (ssIsSampleHit(rtS, 1, tid)) {
      rtB.Sum_ak = rtP.MatrixGain_Gain_e * rtDWork.NextOutput_c +
        rtP.Constant_Value_b;

      {
        rtB.Buffer_b = rtB.Sum_ak;
      }
    }

    if (ssIsContinuousTask(rtS, tid)) {
      rtb_jxi = rtb_Gain_p + rtB.Buffer_b;
    ...
    if (ssIsContinuousTask(rtS, tid)) {
      rtb_jxi = (rtB.Constant_oh[0] * rtB.v_B[0] + rtB.Constant_oh[1] * rtB.v_B
                 [1]) + rtB.Constant_oh[2] * rtB.v_B[2];
      rtb_jxi *= rtB.FromFile2;
      rtb_Gain_pw = rtP.Gain_Gain_c * rt_SATURATE(rtb_jxi,
        rtP.Saturation_LowerSat_m, rtP.Saturation_UpperSat_c);
    }

    if (ssIsSampleHit(rtS, 1, tid)) {
      rtB.Sum_ml = rtP.MatrixGain_Gain_eo * rtDWork.NextOutput_i +
        rtP.Constant_Value_p;

      {
        rtB.Buffer_c = rtB.Sum_ml;
      }
    }

    if (ssIsContinuousTask(rtS, tid)) {
      rtb_jxi = rtb_Gain_pw + rtB.Buffer_c;
      rtB.ADC_ic = rtP.ADC_Interval_i * muDoubleScalarRound((rtb_jxi/
        (rtP.ADC_Interval_i)));
      rtB.m_SUN[0] = rtB.Constant_l[0];
      rtB.m_SUN[1] = rtB.Constant_l[1];
      rtB.m_SUN[2] = rtB.Constant_l[2];
      rtB.m_SUN[5] = rtB.Constant_o[0];
      rtB.m_SUN[6] = rtB.Constant_o[1];
      rtB.m_SUN[7] = rtB.Constant_o[2];
      rtB.m_SUN[10] = rtB.Constant_k[0];
      rtB.m_SUN[11] = rtB.Constant_k[1];
      rtB.m_SUN[12] = rtB.Constant_k[2];
      rtB.m_SUN[15] = rtB.Constant_lf[0];
      rtB.m_SUN[16] = rtB.Constant_lf[1];
      rtB.m_SUN[17] = rtB.Constant_lf[2];
      rtB.m_SUN[20] = rtB.Constant_n[0];
      rtB.m_SUN[21] = rtB.Constant_n[1];
      rtB.m_SUN[22] = rtB.Constant_n[2];
      rtB.m_SUN[25] = rtB.Constant_oh[0];
      rtB.m_SUN[26] = rtB.Constant_oh[1];
      rtB.m_SUN[27] = rtB.Constant_oh[2];
      for (i = 0; i < 6; i++) {
        rtB.m_SUN[3 + 5 * i] = 0.0;
      }

      rtB.m_SUN[4] = rtB.ADC;
      rtB.m_SUN[9] = rtB.ADC_m;
      rtB.m_SUN[14] = rtB.ADC_i;
      rtB.m_SUN[19] = rtB.ADC_d;
      rtB.m_SUN[24] = rtB.ADC_e;
      rtB.m_SUN[29] = rtB.ADC_ic;
      for (i = 0; i < 6; i++) {
    ...
    if (ssIsSampleHit(rtS, 2, tid)) {
      {
        ...
        real_T time = ssGetTaskTime(rtS,tid);
        const real_T *pU = (NULL);
        const real_T *pT = (const real_T *) rtDWork.FromFile_PWORK_i.PrevTimePtr;
        if (initBasePtr == TRUE) {
          pStart = (real_T *) rtDWork.FromFile_PWORK_i.PrevTimePtr;
          initBasePtr = FALSE;
        }

        if (adcs_v15_integral_Power_gblFrFInfo[4].nptsPerSignal == 1) {
          rtB.FromFile_j[0] = pT[1];
          rtB.FromFile_j[1] = pT[2];
          rtB.FromFile_j[2] = pT[3];
        } else {
          pU = pStart + adcs_v15_integral_Power_gblFrFInfo[4].nptsPerSignal - 2;
          if (time <= pStart[0]) {
            pT = pStart;
          } else if (time >= pU[0]) {
            pT = pU;
          ...
          rtDWork.FromFile_PWORK_i.PrevTimePtr = (void *) pT;
          pU = pT + adcs_v15_integral_Power_gblFrFInfo[4].nptsPerSignal;
          if (pT[0] == pT[1]) {
            rtB.FromFile_j[0] = pU[ (time < pT[0]) ? 0 : 1 ];
            pU += adcs_v15_integral_Power_gblFrFInfo[4].nptsPerSignal;
            rtB.FromFile_j[1] = pU[ (time < pT[0]) ? 0 : 1 ];
            pU += adcs_v15_integral_Power_gblFrFInfo[4].nptsPerSignal;
            rtB.FromFile_j[2] = pU[ (time < pT[0]) ? 0 : 1 ];
          } else {
            real_T f = (pT[1]-time)/(pT[1]-pT[0]);
            if (pU[0] == pU[1]) {
              rtB.FromFile_j[0] = pU[0];
            } else {
              rtB.FromFile_j[0] = f*pU[0]+(1.0-f)*pU[1];
            }

            pU += adcs_v15_integral_Power_gblFrFInfo[4].nptsPerSignal;
            if (pU[0] == pU[1]) {
              rtB.FromFile_j[1] = pU[0];
            } else {
              rtB.FromFile_j[1] = f*pU[0]+(1.0-f)*pU[1];
            }

            pU += adcs_v15_integral_Power_gblFrFInfo[4].nptsPerSignal;
            if (pU[0] == pU[1]) {
              rtB.FromFile_j[2] = pU[0];
            } else {
              rtB.FromFile_j[2] = f*pU[0]+(1.0-f)*pU[1];
            }
          }
        }
      }

      {
        ...
        const real_T *pT = (const real_T *)
          rtDWork.FromFile2_PWORK_n.PrevTimePtr;
        if (initBasePtr == TRUE) {
          pStart = (real_T *) rtDWork.FromFile2_PWORK_n.PrevTimePtr;
          initBasePtr = FALSE;
        }

        if (adcs_v15_integral_Power_gblFrFInfo[5].nptsPerSignal == 1) {
          {
            int_T i1;
          ...
          pU = pStart + adcs_v15_integral_Power_gblFrFInfo[5].nptsPerSignal - 2;
          if (time <= pStart[0]) {
            pT = pStart;
          } else if (time >= pU[0]) {
            pT = pU;
          ...
          rtDWork.FromFile2_PWORK_n.PrevTimePtr = (void *) pT;
          pU = pT + adcs_v15_integral_Power_gblFrFInfo[5].nptsPerSignal;
          if (pT[0] == pT[1]) {
            {
              int_T i1;
              real_T *y0 = rtB.FromFile2_g;
              for (i1=0; i1 < 6; i1++) {
                y0[i1] = pU[ (time < pT[0]) ? 0 : 1 ];
                pU += adcs_v15_integral_Power_gblFrFInfo[5].nptsPerSignal;
              }
            }
          } else {
            real_T f = (pT[1]-time)/(pT[1]-pT[0]);
...

      {
        ...
        if (adcs_v15_integral_Power_gblFrFInfo[6].nptsPerSignal == 1) {
          rtB.FromFile3[0] = pT[1];
          rtB.FromFile3[1] = pT[2];
          rtB.FromFile3[2] = pT[3];
        } else {
          pU = pStart + adcs_v15_integral_Power_gblFrFInfo[6].nptsPerSignal - 2;
          if (time <= pStart[0]) {
            pT = pStart;
          } else if (time >= pU[0]) {
            pT = pU;
          ...
          pU = pT + adcs_v15_integral_Power_gblFrFInfo[6].nptsPerSignal;
          if (pT[0] == pT[1]) {
            rtB.FromFile3[0] = pU[ (time < pT[0]) ? 0 : 1 ];
            pU += adcs_v15_integral_Power_gblFrFInfo[6].nptsPerSignal;
      ...
      eml_oy[1] = eml_v[2] * eml_r[0] - eml_v[0] * eml_r[2];
      eml_oy[2] = eml_v[0] * eml_r[1] - eml_v[1] * eml_r[0];
      eml_TIO_idx = muDoubleScalarSqrt(adcs_v15_integral_Power_dot_l(eml_oy,
        eml_oy));
      eml_oy[0] /= eml_TIO_idx;
      eml_oy[1] /= eml_TIO_idx;
      eml_oy[2] /= eml_TIO_idx;
      eml_TIO_idx = muDoubleScalarSqrt(adcs_v15_integral_Power_dot_l(eml_r,
        eml_r));
      ...
      eml_v[1] = eml_oy[2] * eml_r[0] - eml_oy[0] * eml_r[2];
      eml_v[2] = eml_oy[0] * eml_r[1] - eml_oy[1] * eml_r[0];
      eml_TIO_idx = muDoubleScalarSqrt(adcs_v15_integral_Power_dot_l(eml_v,
        eml_v));
      eml_v[0] /= eml_TIO_idx;
      eml_v[1] /= eml_TIO_idx;
      eml_v[2] /= eml_TIO_idx;
      ...
      for (i = 0; i < 3; i++) {
        rtB.v_O_l[i] = 0.0;
        rtB.v_O_l[i] = eml_v_0[i] * rtB.FromFile3[0] + rtB.v_O_l[i];
        rtB.v_O_l[i] = eml_v_0[i + 3] * rtB.FromFile3[1] + rtB.v_O_l[i];
        rtB.v_O_l[i] = eml_v_0[i + 6] * rtB.FromFile3[2] + rtB.v_O_l[i];
      ...
      eml_oy[1] = eml_v[2] * eml_r[0] - eml_v[0] * eml_r[2];
      eml_oy[2] = eml_v[0] * eml_r[1] - eml_v[1] * eml_r[0];
      eml_TIO_idx = muDoubleScalarSqrt(adcs_v15_integral_Power_dot_o(eml_oy,
        eml_oy));
      eml_oy[0] /= eml_TIO_idx;
      eml_oy[1] /= eml_TIO_idx;
      eml_oy[2] /= eml_TIO_idx;
      eml_TIO_idx = muDoubleScalarSqrt(adcs_v15_integral_Power_dot_o(eml_r,
        eml_r));
      eml_r[0] = (-eml_r[0]) / eml_TIO_idx;
      eml_r[1] = (-eml_r[1]) / eml_TIO_idx;
      eml_r[2] = (-eml_r[2]) / eml_TIO_idx;
      ...
      eml_v[1] = eml_oy[2] * eml_r[0] - eml_oy[0] * eml_r[2];
      eml_v[2] = eml_oy[0] * eml_r[1] - eml_oy[1] * eml_r[0];
      eml_TIO_idx = muDoubleScalarSqrt(adcs_v15_integral_Power_dot_o(eml_v,
        eml_v));
      eml_v[0] /= eml_TIO_idx;
      eml_v[1] /= eml_TIO_idx;
      eml_v[2] /= eml_TIO_idx;
      ...
      for (i = 0; i < 3; i++) {
        rtB.v_O[i] = 0.0;
        rtB.v_O[i] = eml_v_0[i] * rtB.FromFile_j[0] + rtB.v_O[i];
        rtB.v_O[i] = eml_v_0[i + 3] * rtB.FromFile_j[1] + rtB.v_O[i];
        rtB.v_O[i] = eml_v_0[i + 6] * rtB.FromFile_j[2] + rtB.v_O[i];
      }

      adcs_v15_integral_Power_QuEST();
    ...
    if (ssIsSampleHit(rtS, 2, tid)) {
      rtB.IntegerDelay1_g[0] = rtDWork.IntegerDelay1_X_a[0];
      rtB.IntegerDelay1_g[1] = rtDWork.IntegerDelay1_X_a[1];
      rtB.IntegerDelay1_g[2] = rtDWork.IntegerDelay1_X_a[2];
      rtB.IntegerDelay_h[0] = rtDWork.IntegerDelay_X_n[0];
      eml_q_idx = (rtB.q_BO_est[0] + rtB.IntegerDelay_h[0]) / 2.0;
      rtB.IntegerDelay_h[1] = rtDWork.IntegerDelay_X_n[1];
      eml_TIO_idx_0 = (rtB.q_BO_est[1] + rtB.IntegerDelay_h[1]) / 2.0;
      rtB.IntegerDelay_h[2] = rtDWork.IntegerDelay_X_n[2];
      eml_q_idx_0 = (rtB.q_BO_est[2] + rtB.IntegerDelay_h[2]) / 2.0;
      rtB.IntegerDelay_h[3] = rtDWork.IntegerDelay_X_n[3];
      eml_B = (rtB.q_BO_est[3] + rtB.IntegerDelay_h[3]) / 2.0;
      eml_r[0] = eml_q_idx;
      ...
      eml_TIO_idx_0 = (rtB.q_BO_est[0] - rtB.IntegerDelay_h[0]) /
        adcs_v15_integral_Power_s_FRAME_SIZE;
      eml_q_idx_0 = (rtB.q_BO_est[1] - rtB.IntegerDelay_h[1]) /
        adcs_v15_integral_Power_s_FRAME_SIZE;
      eml_TIO_idx = (rtB.q_BO_est[2] - rtB.IntegerDelay_h[2]) /
        adcs_v15_integral_Power_s_FRAME_SIZE;
      for (i = 0; i < 3; i++) {
      ...
      eml_x = 2.0 / (adcs_v15_integral_Power_s_FRAME_SIZE + rtP.SFunction_p2_e);
      eml_TIO_idx = 1.0 - eml_x;
      rtB.w_l[0] = eml_x * rtB.w[0] + eml_TIO_idx * rtB.IntegerDelay1_g[0];
      rtB.w_l[1] = eml_x * rtB.w[1] + eml_TIO_idx * rtB.IntegerDelay1_g[1];
      rtB.w_l[2] = eml_x * rtB.w[2] + eml_TIO_idx * rtB.IntegerDelay1_g[2];
      rtB.IntegerDelay_p = rtDWork.IntegerDelay_X_c[0];
      rtB.y = (1.0 - rtB.light_est) + rtB.IntegerDelay_p;
      if (rtB.y > 1.0) {
        rtB.y = 1.0;
      }
    ...
    if (ssIsSampleHit(rtS, 2, tid)) {
      ...
      rtB.IntegerDelay_i[0] = rtDWork.IntegerDelay_X_c4[0];
      rtB.dB[0] = (rtB.TmpRTBAtControlLawInport1[0] - rtB.IntegerDelay_i[0]) /
        adcs_v15_integral_Power_s_FRAME_SIZE;
      rtB.B[0] = (rtB.TmpRTBAtControlLawInport1[0] + rtB.IntegerDelay_i[0]) /
        2.0;
      rtB.IntegerDelay_i[1] = rtDWork.IntegerDelay_X_c4[1];
      rtB.dB[1] = (rtB.TmpRTBAtControlLawInport1[1] - rtB.IntegerDelay_i[1]) /
        adcs_v15_integral_Power_s_FRAME_SIZE;
      rtB.B[1] = (rtB.TmpRTBAtControlLawInport1[1] + rtB.IntegerDelay_i[1]) /
        2.0;
      rtB.IntegerDelay_i[2] = rtDWork.IntegerDelay_X_c4[2];
      rtB.dB[2] = (rtB.TmpRTBAtControlLawInport1[2] - rtB.IntegerDelay_i[2]) /
        adcs_v15_integral_Power_s_FRAME_SIZE;
      rtB.B[2] = (rtB.TmpRTBAtControlLawInport1[2] + rtB.IntegerDelay_i[2]) /
        2.0;
      ...
      rtB.UnitDelay1_p = rtDWork.UnitDelay1_DSTATE_p;
    }
    ...
    if (ssIsSampleHit(rtS, 2, tid)) {
      ...
      eml_TIO_idx = (rtB.Product[0] * rtB.Product[0] + rtB.Product[1] *
                     rtB.Product[1]) + rtB.Product[2] * rtB.Product[2];
      eml_TIO_idx = muDoubleScalarSqrt(eml_TIO_idx);
      if ((eml_TIO_idx < adcs_v15_integral_Power_tol_w) && (rtB.light_est *
           rtB.y == 1.0)) {
        eml_b_2 = true;
      } else {
        eml_b_2 = false;
      ...
      rtB.P[0] = (real_T)(muDoubleScalarAbs(rtB.q_BO_est[3]) >
                          adcs_v15_integral_Power_tol_q4) + 0.1;
      rtB.P[1] = (real_T)(eml_TIO_idx < adcs_v15_integral_Power_tol_w);
      rtB.P[2] = (real_T)(rtB.light_est * rtB.y == 1.0) + 0.3;
      rtB.N = rtB.UnitDelay1_p;
      ...
      if ((eml_b_2 == 1) && (rtB.UnitDelay1_p == 0.0)) {
        rtB.N = 1.0;
        rtB.t_now = rtB.TmpRTBAtgatepulseInport4;
      }

      if (((eml_TIO_idx > adcs_v15_integral_Power_tolw_n2d) == 1) &&
          (rtB.UnitDelay1_p == 1.0) && (rtB.TmpRTBAtgatepulseInport4 >
           rtB.UnitDelay + adcs_v15_integral_Power_check_time)) {
        rtB.N = 0.0;
        rtB.t_now = rtB.TmpRTBAtgatepulseInport4;
      }
      ...
      eml_TIO_idx_0 = rtP.Gain1_Gain_a * rt_SATURATE(eml_r[0],
      ...
      eml_TIO_idx_0 = rtP.Gain1_Gain_a * rt_SATURATE(eml_r[1],
        rtP.MomentSaturation_LowerSat, rtP.MomentSaturation_UpperSat);
      eml_TIO_idx_0 = rt_SATURATE(eml_TIO_idx_0, rtP.PowerSaturation_LowerSat,
        rtP.PowerSaturation_UpperSat);
      eml_r[1] = eml_TIO_idx_0;
      eml_TIO_idx_0 = rtP.Gain1_Gain_a * rt_SATURATE(eml_r[2],
        rtP.MomentSaturation_LowerSat, rtP.MomentSaturation_UpperSat);
      eml_TIO_idx_0 = rt_SATURATE(eml_TIO_idx_0, rtP.PowerSaturation_LowerSat,
        rtP.PowerSaturation_UpperSat);
    ...
    if (ssIsContinuousTask(rtS, tid) && ssIsSpecialSampleHit(rtS,4,0,tid)) {
      rtB.TmpRTBAtToWorkspace12Inport1[0] = rtB.v_B_n[0];
      rtB.TmpRTBAtToWorkspace12Inport1[1] = rtB.v_B_n[1];
      rtB.TmpRTBAtToWorkspace12Inport1[2] = rtB.v_B_n[2];
    }
    ...
    if (ssIsSampleHit(rtS, 2, tid) && ssIsSpecialSampleHit(rtS,4,2,tid)) {
      rtB.TmpRTBAtToWorkspace8Inport1[0] = rtB.v_O_l[0];
      rtB.TmpRTBAtToWorkspace8Inport1[1] = rtB.v_O_l[1];
      rtB.TmpRTBAtToWorkspace8Inport1[2] = rtB.v_O_l[2];
    }
    ...
    if (ssIsSampleHit(rtS, 1, tid)) {
      rtB.Gain_e[0] = rtP.Gain_Gain_i0 * rtP.Constant_Value_au[0];
      rtB.Gain_e[1] = rtP.Gain_Gain_i0 * rtP.Constant_Value_au[1];
      rtB.Gain_e[2] = rtP.Gain_Gain_i0 * rtP.Constant_Value_au[2];
    ...
    if (ssIsContinuousTask(rtS, tid)) {
      ...
      rtb_jxi = rtb_Product[1] * rtB.v_B_n[2];
      rtB.Sum_b[0] = rtb_jxi - rtb_Product[2] * rtB.v_B_n[1];
      rtB.Sum_b[1] = rtb_Product[2] * rtB.v_B_n[0] - rtb_Product[0] * rtB.v_B_n
        [2];
      rtB.Sum_b[2] = rtb_Product[0] * rtB.v_B_n[1] - rtb_Product[1] * rtB.v_B_n
        [0];
      if (ssIsSpecialSampleHit(rtS,4,0,tid)) {
        rtB.TmpRTBAtToWorkspace9Inport1[0] = rtB.Sum_b[0];
        rtB.TmpRTBAtToWorkspace9Inport1[1] = rtB.Sum_b[1];
        rtB.TmpRTBAtToWorkspace9Inport1[2] = rtB.Sum_b[2];
      }
    }
    ...
    if (ssIsContinuousTask(rtS, tid)) {
      ...
      for (i = 0; i < 3; i++) {
        rtB.v_B_p[i] = 0.0;
        rtB.v_B_p[i] = eml_v_0[i] * rtB.FromFile[3] + rtB.v_B_p[i];
        rtB.v_B_p[i] = eml_v_0[i + 3] * rtB.FromFile[4] + rtB.v_B_p[i];
        rtB.v_B_p[i] = eml_v_0[i + 6] * rtB.FromFile[5] + rtB.v_B_p[i];
      }

      eml_TIO_idx = muDoubleScalarSqrt(adcs_v15_integral_Power_dot_g(&rtB.v_B_p
        [0], &rtB.v_B_p[0]));
      eml_r[0] = rtB.v_B_p[0] / eml_TIO_idx;
      eml_r[1] = rtB.v_B_p[1] / eml_TIO_idx;
      eml_r[2] = rtB.v_B_p[2] / eml_TIO_idx;
      eml_x = 0.0;
      ...
      for (i = 0; i < 6; i++) {
        ...
        eml_B = adcs_v15_integral_Power_dot_g(eml_b_3, eml_r);
        if (eml_B > 0.0) {
          eml_x += eml_B;
        }
      }

      eml_TIO_idx = -0.5 * rtP.SFunction_p1 * rtB.Constant_p * eml_x *
    ...
    if (ssIsContinuousTask(rtS, tid)) {
      if (adcs_v15_integral_Power_norm_l(&rtB.v_B[0]) == 0.0) {
        rtB.solar_drag[0] = 1.0;
        rtB.solar_drag[1] = 0.0;
        rtB.solar_drag[2] = 0.0;
      } else {
        eml_TIO_idx = adcs_v15_integral_Power_norm_l(&rtB.v_B[0]);
      ...
      rtb_jxi = rtB.VectorfromCoMtoCoP_inBodyframeyettobefinalized2[1] *
        rtB.solar_drag[0];
      rtB.Sum_af[0] = rtB.VectorfromCoMtoCoP_inBodyframeyettobefinalized2[1] *
        rtB.solar_drag[2] - rtB.VectorfromCoMtoCoP_inBodyframeyettobefinalized2
        [2] * rtB.solar_drag[1];
      rtB.Sum_af[1] = rtB.VectorfromCoMtoCoP_inBodyframeyettobefinalized2[2] *
        rtB.solar_drag[0] - rtB.VectorfromCoMtoCoP_inBodyframeyettobefinalized2
        [0] * rtB.solar_drag[2];
      rtB.Sum_af[2] = rtB.VectorfromCoMtoCoP_inBodyframeyettobefinalized2[0] *
        rtB.solar_drag[1] - rtb_jxi;
      rtB.Sum_n[0] = (rtB.tau[0] + rtB.u_aero[0]) + rtB.Sum_af[0];
      rtB.Sum_h[0] = rtB.Sum_n[0] + rtB.Sum_b[0];
      eml_r[0] = rtB.xN[4];
      rtB.Sum_n[1] = (rtB.tau[1] + rtB.u_aero[1]) + rtB.Sum_af[1];
      rtB.Sum_h[1] = rtB.Sum_n[1] + rtB.Sum_b[1];
      eml_r[1] = rtB.xN[5];
      rtB.Sum_n[2] = (rtB.tau[2] + rtB.u_aero[2]) + rtB.Sum_af[2];
      rtB.Sum_h[2] = rtB.Sum_n[2] + rtB.Sum_b[2];
      eml_r[2] = rtB.xN[6];
      for (i = 0; i < 3; i++) {
      ...
      eml_TIO_idx_0 = rtB.Sum_h[0] - (eml_r[1] * eml_b_1[2] - eml_r[2] *
        eml_b_1[1]);
      eml_q_idx_0 = rtB.Sum_h[1] - (eml_r[2] * eml_b_1[0] - eml_r[0] * eml_b_1[2]);
      eml_TIO_idx = rtB.Sum_h[2] - (eml_r[0] * eml_b_1[1] - eml_r[1] * eml_b_1[0]);
      for (i = 0; i < 4; i++) {
    ...
    if (ssIsContinuousTask(rtS, tid) && ssIsSpecialSampleHit(rtS,3,0,tid)) {
      rtB.TmpRTBAtw_real2Inport1[0] = rtB.Sum_n[0];
      rtB.TmpRTBAtw_real2Inport1[1] = rtB.Sum_n[1];
      rtB.TmpRTBAtw_real2Inport1[2] = rtB.Sum_n[2];
    }
    ...
    if (ssIsContinuousTask(rtS, tid) && ssIsSpecialSampleHit(rtS,3,0,tid)) {
      rtB.TmpRTBAtw_real4Inport1[0] = rtB.Sum_af[0];
      rtB.TmpRTBAtw_real4Inport1[1] = rtB.Sum_af[1];
      rtB.TmpRTBAtw_real4Inport1[2] = rtB.Sum_af[2];
    }
    ...
    if (ssIsSampleHit(rtS, 1, tid)) {
      rtB.Constant_pd[0] = rtP.Constant_Value_gd[0];
      rtB.Constant_pd[1] = rtP.Constant_Value_gd[1];
      rtB.Constant_pd[2] = rtP.Constant_Value_gd[2];
    }

    if (ssIsContinuousTask(rtS, tid)) {
      eml_TIO_idx = ((rtB.Constant_pd[0] * rtB.v_B[0] + rtB.Constant_pd[1] *
                      rtB.v_B[1]) + rtB.Constant_pd[2] * rtB.v_B[2]) *
        rtB.FromFile2;
      rtB.Gain_g = rtP.Gain1_Gain * rt_SATURATE(eml_TIO_idx,
        rtP.Saturation_LowerSat_k, rtP.Saturation_UpperSat_hn) * rtP.Gain_Gain_h;
    }

    if (ssIsSampleHit(rtS, 1, tid)) {
      rtB.Constant_f[0] = rtP.Constant_Value_h[0];
      rtB.Constant_f[1] = rtP.Constant_Value_h[1];
      rtB.Constant_f[2] = rtP.Constant_Value_h[2];
    }

    if (ssIsContinuousTask(rtS, tid)) {
      eml_TIO_idx = ((rtB.Constant_f[0] * rtB.v_B[0] + rtB.Constant_f[1] *
                      rtB.v_B[1]) + rtB.Constant_f[2] * rtB.v_B[2]) *
        rtB.FromFile2;
      rtB.Gain_o = rtP.Gain1_Gain_l * rt_SATURATE(eml_TIO_idx,
        rtP.Saturation_LowerSat_fi, rtP.Saturation_UpperSat_e) * rtP.Gain_Gain_j;
    }

    if (ssIsSampleHit(rtS, 1, tid)) {
      rtB.Constant_o3[0] = rtP.Constant_Value_gs[0];
      rtB.Constant_o3[1] = rtP.Constant_Value_gs[1];
      rtB.Constant_o3[2] = rtP.Constant_Value_gs[2];
    }

    if (ssIsContinuousTask(rtS, tid)) {
      eml_TIO_idx = ((rtB.Constant_o3[0] * rtB.v_B[0] + rtB.Constant_o3[1] *
                      rtB.v_B[1]) + rtB.Constant_o3[2] * rtB.v_B[2]) *
        rtB.FromFile2;
      rtB.Gain_p = rtP.Gain1_Gain_n * rt_SATURATE(eml_TIO_idx,
        rtP.Saturation_LowerSat_c, rtP.Saturation_UpperSat_f) * rtP.Gain_Gain_b;
    }

    if (ssIsSampleHit(rtS, 1, tid)) {
      rtB.Constant_b[0] = rtP.Constant_Value_cq[0];
      rtB.Constant_b[1] = rtP.Constant_Value_cq[1];
      rtB.Constant_b[2] = rtP.Constant_Value_cq[2];
    }

    if (ssIsContinuousTask(rtS, tid)) {
      eml_TIO_idx = ((rtB.Constant_b[0] * rtB.v_B[0] + rtB.Constant_b[1] *
                      rtB.v_B[1]) + rtB.Constant_b[2] * rtB.v_B[2]) *
        rtB.FromFile2;
      rtB.Gain_c = rtP.Gain1_Gain_d * rt_SATURATE(eml_TIO_idx,
        rtP.Saturation_LowerSat_n, rtP.Saturation_UpperSat_p) * rtP.Gain_Gain_cl;
    }

    if (ssIsSampleHit(rtS, 1, tid)) {
      rtB.Constant_g[0] = rtP.Constant_Value_k[0];
      rtB.Constant_g[1] = rtP.Constant_Value_k[1];
      rtB.Constant_g[2] = rtP.Constant_Value_k[2];
    }
    ...
    if (ssIsContinuousTask(rtS, tid)) {
      eml_TIO_idx = ((rtB.Constant_g[0] * rtB.v_B[0] + rtB.Constant_g[1] *
        ...
        rtB.FromFile2;
      rtB.Gain_b = rtP.Gain1_Gain_f * rt_SATURATE(eml_TIO_idx,
        rtP.Saturation_LowerSat_b, rtP.Saturation_UpperSat_ci) * rtP.Gain_Gain_n;
    }

    if (ssIsSampleHit(rtS, 1, tid)) {
      rtB.Constant_i[0] = rtP.Constant_Value_hh[0];
      rtB.Constant_i[1] = rtP.Constant_Value_hh[1];
      rtB.Constant_i[2] = rtP.Constant_Value_hh[2];
    }

    if (ssIsContinuousTask(rtS, tid)) {
      eml_TIO_idx = ((rtB.Constant_i[0] * rtB.v_B[0] + rtB.Constant_i[1] *
                      rtB.v_B[1]) + rtB.Constant_i[2] * rtB.v_B[2]) *
        rtB.FromFile2;
      rtB.Gain_bb = rtP.Gain1_Gain_i * rt_SATURATE(eml_TIO_idx,
        rtP.Saturation_LowerSat_g, rtP.Saturation_UpperSat_j) * rtP.Gain_Gain_l;
      if (ssIsSpecialSampleHit(rtS,4,0,tid)) {
        rtB.TmpRTBAtScope11Inport1[0] = rtB.Gain_g;
        rtB.TmpRTBAtScope11Inport1[1] = rtB.Gain_o;
        rtB.TmpRTBAtScope11Inport1[2] = rtB.Gain_p;
        rtB.TmpRTBAtScope11Inport1[3] = rtB.Gain_c;
        rtB.TmpRTBAtScope11Inport1[4] = rtB.Gain_b;
        rtB.TmpRTBAtScope11Inport1[5] = rtB.Gain_bb;
      }
    }
    ...
    if (ssIsContinuousTask(rtS, tid)) {
      rtB.Gain1[0] = rtP.Gain1_Gain_l1 * rtB.Gain_g;
      rtB.Gain1[1] = rtP.Gain1_Gain_l1 * rtB.Gain_o;
      rtB.Gain1[2] = rtP.Gain1_Gain_l1 * rtB.Gain_p;
      rtB.Gain1[3] = rtP.Gain1_Gain_l1 * rtB.Gain_c;
      rtB.Gain1[4] = rtP.Gain1_Gain_l1 * rtB.Gain_b;
      rtB.Gain1[5] = rtP.Gain1_Gain_l1 * rtB.Gain_bb;
      if (ssIsSpecialSampleHit(rtS,4,0,tid)) {
        for (i = 0; i < 6; i++) {
    ...
    if (ssIsContinuousTask(rtS, tid)) {
      ...
      eml_TIO_idx = adcs_v15_integral_Power_norm_j(&rtB.r_ECEF[0]);
      ...
      rtB.Gain2_o = rtP.Gain2_Gain_l * rtB.AddingSolarPower1;
      if (ssIsSpecialSampleHit(rtS,4,0,tid)) {
        rtB.TmpRTBAtScope13Inport1 = rtB.Gain2_o;
      }
    }
    ...
    if (ssIsContinuousTask(rtS, tid)) {
      if (rtB.Clock_i < 0.15) {
        rtB.Batt_cap = 2000.0;
        rtB.current = 0.0;
        rtB.VBat = adcs_v15_integral_Power_isro_battery(200.0, 0.0, 0.08);
      } else if (rtB.Gain2_o < 0.0) {
        rtB.current = rtB.Gain2_o / (rtP.SFunction_p1_f * 2.0 *
          rtB.IntegerDelay4);
        rtB.Batt_cap = rtB.Gain2_o / (21.6 * rtB.IntegerDelay4) +
          rtB.IntegerDelay3;
        rtB.VBat = adcs_v15_integral_Power_isro_battery(2200.0 - rtB.Batt_cap,
          rtB.current, 0.08);
        ...
        rtB.VBat = adcs_v15_integral_Power_isro_battery(2200.0 -
    ...
    if (ssIsContinuousTask(rtS, tid)) {
      rtB.Integrator_a = rtX.Integrator_CSTATE_c;
    }
...
{
  {
    ...
    if (ssIsSampleHit(rtS, 2, tid)) {
      rtDWork.IntegerDelay1_X_a[0] = rtB.w_l[0];
      rtDWork.IntegerDelay1_X_a[1] = rtB.w_l[1];
      rtDWork.IntegerDelay1_X_a[2] = rtB.w_l[2];
      rtDWork.IntegerDelay_X_n[0] = rtB.q_BO_est[0];
      rtDWork.IntegerDelay_X_n[1] = rtB.q_BO_est[1];
      rtDWork.IntegerDelay_X_n[2] = rtB.q_BO_est[2];
      rtDWork.IntegerDelay_X_n[3] = rtB.q_BO_est[3];
      for (loopVar_i = 0; loopVar_i < 299; loopVar_i++) {
        rtDWork.IntegerDelay_X_c[loopVar_i] = rtDWork.IntegerDelay_X_c[loopVar_i
          + 1];
      }

      rtDWork.IntegerDelay_X_c[299] = rtB.light_est;
    }

    if (ssIsSampleHit(rtS, 2, tid)) {
      rtDWork.UnitDelay1_DSTATE_p = rtB.N;
      rtDWork.UnitDelay_DSTATE = rtB.t_now;
      rtDWork.IntegerDelay_X_c4[0] = rtB.TmpRTBAtControlLawInport1[0];
      rtDWork.UnitDelay1_DSTATE[0] = rtB.ieu[0];
      rtDWork.TmpRTBAtProductInport2_Buffer0[0] = rtB.Gain2[0];
      rtDWork.IntegerDelay_X_c4[1] = rtB.TmpRTBAtControlLawInport1[1];
      rtDWork.UnitDelay1_DSTATE[1] = rtB.ieu[1];
      rtDWork.TmpRTBAtProductInport2_Buffer0[1] = rtB.Gain2[1];
      rtDWork.IntegerDelay_X_c4[2] = rtB.TmpRTBAtControlLawInport1[2];
...
{
  if (adcs_v15_integral_Power_gblFrFInfo[0].tuDataMatrix != (NULL)) {
    rt_FREE(adcs_v15_integral_Power_gblFrFInfo[0].tuDataMatrix);
  }

  if (adcs_v15_integral_Power_gblFrFInfo[1].tuDataMatrix != (NULL)) {
    rt_FREE(adcs_v15_integral_Power_gblFrFInfo[1].tuDataMatrix);
  }

  if (adcs_v15_integral_Power_gblFrFInfo[2].tuDataMatrix != (NULL)) {
    rt_FREE(adcs_v15_integral_Power_gblFrFInfo[2].tuDataMatrix);
  }

  if (adcs_v15_integral_Power_gblFrFInfo[3].tuDataMatrix != (NULL)) {
    rt_FREE(adcs_v15_integral_Power_gblFrFInfo[3].tuDataMatrix);
  }

  if (adcs_v15_integral_Power_gblFrFInfo[4].tuDataMatrix != (NULL)) {
    rt_FREE(adcs_v15_integral_Power_gblFrFInfo[4].tuDataMatrix);
  }

  if (adcs_v15_integral_Power_gblFrFInfo[5].tuDataMatrix != (NULL)) {
    rt_FREE(adcs_v15_integral_Power_gblFrFInfo[5].tuDataMatrix);
  }

  if (adcs_v15_integral_Power_gblFrFInfo[6].tuDataMatrix != (NULL)) {
    rt_FREE(adcs_v15_integral_Power_gblFrFInfo[6].tuDataMatrix);
  }
...
void MdlInitializeSizes(void)
{
  ...
  ssSetNumBlocks(rtS, 346);
  ssSetNumBlockIO(rtS, 181);
  ssSetNumBlockParams(rtS, 188);
}
...
{
  ssSetChecksumVal(rtS, 0, 1884956362U);
  ssSetChecksumVal(rtS, 1, 2495746211U);
  ssSetChecksumVal(rtS, 2, 3225586550U);
  ssSetChecksumVal(rtS, 3, 2067649426U);
}
...
SimStruct * raccel_register_model(void)
{
  ...
  ssSetModelName(rtS, "adcs_v15_integral_Power");
  ssSetPath(rtS, "adcs_v15_integral_Power");
  ssSetTStart(rtS, 0.0);
  ...
  {
    {
      ...
      static const char_T *rt_LoggedStateBlockNames[] = {
        "adcs_v15_integral_Power/Integrator",
        "adcs_v15_integral_Power/PowerD0D/battery_DOD/Integrator",
        "adcs_v15_integral_Power/PowerD0D/Integer Delay",
        "adcs_v15_integral_Power/PowerD0D/Integer Delay3",
        "adcs_v15_integral_Power/PowerD0D/Integer Delay2",
        "adcs_v15_integral_Power/PowerD0D/Integer Delay1",
        "adcs_v15_integral_Power/PowerD0D/Integer Delay4",
        "adcs_v15_integral_Power/q -> w/Integer Delay1",
        "adcs_v15_integral_Power/q -> w/Integer Delay",
        "adcs_v15_integral_Power/q -> w/Subsystem6/Integer Delay",
        "adcs_v15_integral_Power/Control Law/Integer Delay",
        "adcs_v15_integral_Power/Control Law/Unit Delay1",
        "adcs_v15_integral_Power/Control Law/Switching Algorithm/Unit Delay1",
        "adcs_v15_integral_Power/Control Law/Switching Algorithm/Unit Delay"
      };
      ...
      rt_LoggedStateSignalPtrs[7] = (void*)&rtDWork.IntegerDelay1_X_a[0];
      rt_LoggedStateSignalPtrs[8] = (void*)&rtDWork.IntegerDelay_X_n[0];
      rt_LoggedStateSignalPtrs[9] = (void*)&rtDWork.IntegerDelay_X_c[0];
      rt_LoggedStateSignalPtrs[10] = (void*)&rtDWork.IntegerDelay_X_c4[0];
      rt_LoggedStateSignalPtrs[11] = (void*)&rtDWork.UnitDelay1_DSTATE[0];
      rt_LoggedStateSignalPtrs[12] = (void*)&rtDWork.UnitDelay1_DSTATE_p;
  ...
  rtP.Saturation_UpperSat_d = rtInf;
  rtP.Saturation_UpperSat_h = rtInf;
  rtP.Saturation_UpperSat_a = rtInf;
  rtP.Saturation_UpperSat_b = rtInf;
  rtP.Saturation_UpperSat_c = rtInf;
  return rtS;
}

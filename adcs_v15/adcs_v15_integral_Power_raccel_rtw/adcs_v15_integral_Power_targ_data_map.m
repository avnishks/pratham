  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% rtP.RandomNumber_StdDev_b
	  section.data(34).logicalSrcIdx = 33;
	  section.data(34).dtTransOffset = 45;
	
	  ;% rtP.RandomNumber_Seed_d
	  ...
	  ;% rtP.RandomNumber_Seed_j
	  section.data(55).logicalSrcIdx = 54;
	  section.data(55).dtTransOffset = 70;
	
	  ;% rtP.MatrixGain_Gain_e
	  ...
	  ;% rtP.IntegerDelay_InitialCondition_o
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% rtDWork.IntegerDelay1_X_a
	  section.data(6).logicalSrcIdx = 5;
	  section.data(6).dtTransOffset = 5;
	
	  ;% rtDWork.IntegerDelay_X_n
	  section.data(7).logicalSrcIdx = 6;
	  section.data(7).dtTransOffset = 8;
	
	  ;% rtDWork.IntegerDelay_X_c
	  section.data(8).logicalSrcIdx = 7;
	  section.data(8).dtTransOffset = 12;
	
	  ;% rtDWork.IntegerDelay_X_c4
	  section.data(9).logicalSrcIdx = 8;
	  ...
	  ;% rtDWork.FromFile_PWORK_f.PrevTimePtr
	  ...
	  ;% rtDWork.Scope1_PWORK_a.LoggedData
	  ...
	  ;% rtDWork.Scope_PWORK_n.LoggedData
	  ...
	  ;% rtDWork.Scope1_PWORK_lz.LoggedData
	  section.data(59).logicalSrcIdx = 79;
	  section.data(59).dtTransOffset = 58;
	
	  ;% rtDWork.Scope2_PWORK_l.LoggedData
	  section.data(60).logicalSrcIdx = 80;
	  section.data(60).dtTransOffset = 59;
	
	  ;% rtDWork.Scope3_PWORK_d.LoggedData
	  section.data(61).logicalSrcIdx = 81;
	  section.data(61).dtTransOffset = 60;
	
	  ;% rtDWork.Scope6_PWORK_l.LoggedData
	  section.data(62).logicalSrcIdx = 82;
	  section.data(62).dtTransOffset = 61;
	
	  ;% rtDWork.Scope_PWORK_m.LoggedData
	  section.data(63).logicalSrcIdx = 83;
	  section.data(63).dtTransOffset = 62;
	
	  ;% rtDWork.Scope1_PWORK_lt.LoggedData
	  ...
	  ;% rtDWork.FromFile_PWORK_i.PrevTimePtr
	  ...
	  ;% rtDWork.Scope_PWORK_a.LoggedData
	  section.data(69).logicalSrcIdx = 89;
	  section.data(69).dtTransOffset = 68;
	
	  ;% rtDWork.Scope1_PWORK_d.LoggedData
	  ...
	  ;% rtDWork.is_active_c7_adcs_v15_integral_Power
	  section.data(1).logicalSrcIdx = 103;
	  section.data(1).dtTransOffset = 0;
	
	  ;% rtDWork.is_active_c27_adcs_v15_integral_Power
	  section.data(2).logicalSrcIdx = 104;
	  section.data(2).dtTransOffset = 1;
	
	  ;% rtDWork.is_active_c6_adcs_v15_integral_Power
	  section.data(3).logicalSrcIdx = 105;
	  section.data(3).dtTransOffset = 2;
	
	  ;% rtDWork.is_active_c1_adcs_v15_integral_Power
	  section.data(4).logicalSrcIdx = 106;
	  section.data(4).dtTransOffset = 3;
	
	  ;% rtDWork.is_active_c4_adcs_v15_integral_Power
	  section.data(5).logicalSrcIdx = 107;
	  section.data(5).dtTransOffset = 4;
	
	  ;% rtDWork.is_active_c22_adcs_v15_integral_Power
	  section.data(6).logicalSrcIdx = 108;
	  section.data(6).dtTransOffset = 5;
	
	  ;% rtDWork.is_active_c12_adcs_v15_integral_Power
	  section.data(7).logicalSrcIdx = 109;
	  section.data(7).dtTransOffset = 6;
	
	  ;% rtDWork.is_active_c25_adcs_v15_integral_Power
	  section.data(8).logicalSrcIdx = 110;
	  section.data(8).dtTransOffset = 7;
	
	  ;% rtDWork.is_active_c11_adcs_v15_integral_Power
	  section.data(9).logicalSrcIdx = 111;
	  section.data(9).dtTransOffset = 8;
	
	  ;% rtDWork.is_active_c30_adcs_v15_integral_Power
	  section.data(10).logicalSrcIdx = 112;
	  section.data(10).dtTransOffset = 9;
	
	  ;% rtDWork.is_active_c28_adcs_v15_integral_Power
	  section.data(11).logicalSrcIdx = 113;
	  section.data(11).dtTransOffset = 10;
	
	  ;% rtDWork.is_active_c26_adcs_v15_integral_Power
	  section.data(12).logicalSrcIdx = 114;
	  section.data(12).dtTransOffset = 11;
	
	  ;% rtDWork.is_active_c31_adcs_v15_integral_Power
	  section.data(13).logicalSrcIdx = 115;
	  section.data(13).dtTransOffset = 12;
	
	  ;% rtDWork.is_active_c19_adcs_v15_integral_Power
	  section.data(14).logicalSrcIdx = 116;
	  section.data(14).dtTransOffset = 13;
	
	  ;% rtDWork.is_active_c5_adcs_v15_integral_Power
	  section.data(15).logicalSrcIdx = 117;
	  section.data(15).dtTransOffset = 14;
	
	  ;% rtDWork.is_active_c8_adcs_v15_integral_Power
	  section.data(16).logicalSrcIdx = 118;
	  section.data(16).dtTransOffset = 15;
	
	  ;% rtDWork.is_active_c9_adcs_v15_integral_Power
	  section.data(17).logicalSrcIdx = 119;
	  section.data(17).dtTransOffset = 16;
	
	  ;% rtDWork.is_active_c20_adcs_v15_integral_Power
	  section.data(18).logicalSrcIdx = 120;
	  section.data(18).dtTransOffset = 17;
	
	  ;% rtDWork.is_active_c16_adcs_v15_integral_Power
	  section.data(19).logicalSrcIdx = 121;
	  section.data(19).dtTransOffset = 18;
	
	  ;% rtDWork.is_active_c29_adcs_v15_integral_Power
	  section.data(20).logicalSrcIdx = 122;
	  section.data(20).dtTransOffset = 19;
	
	  ;% rtDWork.is_active_c2_adcs_v15_integral_Power
	  section.data(21).logicalSrcIdx = 123;
	  section.data(21).dtTransOffset = 20;
	
	  ;% rtDWork.is_active_c10_adcs_v15_integral_Power
	  section.data(22).logicalSrcIdx = 124;
	  section.data(22).dtTransOffset = 21;
	
	  ;% rtDWork.is_active_c24_adcs_v15_integral_Power
	  section.data(23).logicalSrcIdx = 125;
	  section.data(23).dtTransOffset = 22;
	
	  ;% rtDWork.is_active_c13_adcs_v15_integral_Power
	  section.data(24).logicalSrcIdx = 126;
	  section.data(24).dtTransOffset = 23;
	
	  ;% rtDWork.is_active_c23_adcs_v15_integral_Power
	  ...
	  ;% rtDWork.doneDoubleBufferReInit_ib
	  ...
	  ;% rtDWork.doneDoubleBufferReInit_o5
	  ...
	  ;% rtDWork.doneDoubleBufferReInit_cu
	  ...
	  ;% rtDWork.doneDoubleBufferReInit_lv
	  ...
	  ;% rtDWork.doneDoubleBufferReInit_gg
	  ...
	  ;% rtDWork.doneDoubleBufferReInit_ij
	  ...
	  ;% rtDWork.doneDoubleBufferReInit_gs
	  ...
	  ;% rtDWork.doneDoubleBufferReInit_l0
	  ...
	  ;% rtDWork.doneDoubleBufferReInit_nz
  ...
  targMap.checksum0 = 1884956362;
  targMap.checksum1 = 2495746211;
  targMap.checksum2 = 3225586550;
  targMap.checksum3 = 2067649426;

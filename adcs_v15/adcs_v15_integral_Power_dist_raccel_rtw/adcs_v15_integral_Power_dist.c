#include <math.h>
#include "adcs_v15_integral_Power_dist.h"
#include "adcs_v15_integral_Power_dist_private.h"
#include "adcs_v15_integral_Power_dist_dt.h"
...
FrFInfo adcs_v15_integral_Power_dist_gblFrFInfo[7];

#include "simstruc.h"
#include "fixedpoint.h"

#define adcs_v15_integral_Power_dist_Snum (6.0)
#define adcs_v15_integral_Power_dist_s_MAGMETER_WEIGHT (0.9)

#define adcs_v15_integral_Power_dist_check_time (10000.0)
#define adcs_v15_integral_Power_dist_tol_q4 (0.85)
#define adcs_v15_integral_Power_dist_tol_w (0.004)
#define adcs_v15_integral_Power_dist_tolw_n2d (0.01)

#define adcs_v15_integral_Power_dist_s_FRAME_SIZE (2.0)
...
static real_T adcs_v15_integral_Power_dist_norm(const real_T eml_x[3]);
static real_T adcs_v15_integral_Power_dist_dot(const real_T eml_a[3], const
  real_T eml_b[3]);
static real_T adcs_v15_integral_Power_dist_norm_k(const real_T eml_x[3]);
static void adcs_v15_integral_Power_dist_c11_adcs_v15_integral_Power_dist(void);
static real_T adcs_v15_integral_Power_dist_dot_b(const real_T eml_a[3], const
  real_T eml_b[3]);
static real_T adcs_v15_integral_Power_dist_dot_l(const real_T eml_a[3], const
  real_T eml_b[3]);
static real_T adcs_v15_integral_Power_dist_dot_o(const real_T eml_a[3], const
  real_T eml_b[3]);
static real_T adcs_v15_integral_Power_dist_dot_g(const real_T eml_a[3], const
  real_T eml_b[3]);
static real_T adcs_v15_integral_Power_dist_norm_l(const real_T eml_x[3]);
static real_T adcs_v15_integral_Power_dist_norm_j(const real_T eml_x[3]);
static real_T adcs_v15_integral_Power_dist_isro_battery(real_T eml_x, real_T
...
static void adcs_v15_integral_Power_dist_c11_adcs_v15_integral_Power_dist(void)
{
  ...
  memcpy((void *)&eml_m_SUN[0], (void *)&rtB.TmpRTBAtQuESTInport2[0], 30U *
         sizeof(real_T));
  eml_b_0 = muDoubleScalarCos(rtP.SFunction_p4_b * 3.1415926535897931E+000 /
    180.0);
  ...
  eml_b_0 = 0.0;
  for (eml_i = 1; eml_i <= (int32_T)adcs_v15_integral_Power_dist_Snum; eml_i++)
  {
  ...
  if (eml_b_0 == adcs_v15_integral_Power_dist_Snum) {
    eml_i = 0;
  } else {
    eml_i = 1;
  }
  ...
  if (eml_i == 1) {
    ...
    while (1) {
      ...
      if (!(adcs_v15_integral_Power_dist_norm(eml_m_SUN_2) == 0.0)) {
        break;
      }

      eml_b_0++;
      eml_i = (int32_T)eml_idx[(int32_T)(adcs_v15_integral_Power_dist_Snum -
        eml_b_0) - 1];
    }
    ...
    while (1) {
      ...
      if (!((adcs_v15_integral_Power_dist_norm(eml_m_SUN_0) == 0.0) ||
            (adcs_v15_integral_Power_dist_norm(eml_m_SUN_1) == 0.0))) {
        break;
      }
    ...
    eml_b_0 = muDoubleScalarSqrt(adcs_v15_integral_Power_dist_dot(&rtB.v_Sun1[0],
      &rtB.v_Sun1[0]));
    ...
    eml_b_0 = adcs_v15_integral_Power_dist_norm_k(eml_b);
    eml_b[0] /= eml_b_0;
    eml_b[1] /= eml_b_0;
    eml_b[2] /= eml_b_0;
    ...
    eml_b_0 = adcs_v15_integral_Power_dist_norm_k(eml_r);
    eml_r[0] /= eml_b_0;
    eml_r[1] /= eml_b_0;
    eml_r[2] /= eml_b_0;
    ...
    tmp_0[0] = (rtB.TmpRTBAtQuESTInport1[1] * rtB.v_O_g[2] -
      ...
      adcs_v15_integral_Power_dist_s_MAGMETER_WEIGHT + (eml_ssvalues[1] *
    ...
    tmp_0[1] = (rtB.TmpRTBAtQuESTInport1[2] * rtB.v_O_g[0] -
      ...
      adcs_v15_integral_Power_dist_s_MAGMETER_WEIGHT + (eml_ssvalues[2] *
    ...
    tmp_0[2] = (rtB.TmpRTBAtQuESTInport1[0] * rtB.v_O_g[1] -
      ...
      adcs_v15_integral_Power_dist_s_MAGMETER_WEIGHT + (eml_ssvalues[0] *
      rtB.v_O[1] - eml_ssvalues[1] * rtB.v_O[0]) * 9.9999999999999978E-002;
    eml_b_1[2] = eml_b[2] + eml_r[2];
    eml_b_0 = (0.9 * adcs_v15_integral_Power_dist_dot(&rtB.TmpRTBAtQuESTInport1
                [0], &rtB.v_O_g[0]) + 9.9999999999999978E-002 *
               adcs_v15_integral_Power_dist_dot(eml_ssvalues, &rtB.v_O[0])) *
      (1.0 + adcs_v15_integral_Power_dist_dot(eml_b, eml_r)) +
      adcs_v15_integral_Power_dist_dot(eml_b_2, tmp_0);
    ...
    if (eml_b_0 > 0.0) {
      ...
      rtB.q_BO_est[3] = (eml_maxval + eml_b_0) * (1.0 +
        adcs_v15_integral_Power_dist_dot(eml_b, eml_r)) * eml_k_q_triad;
    } else {
      eml_k_q_triad = 1.0 / (muDoubleScalarSqrt((eml_maxval - eml_b_0) *
        eml_maxval * (1.0 + adcs_v15_integral_Power_dist_dot(eml_b, eml_r))) *
        2.0);
      ...
      rtB.q_BO_est[3] = (1.0 + adcs_v15_integral_Power_dist_dot(eml_b, eml_r)) *
...
void adcs_v15_integral_Power_dist_QuEST_Init(void)
{
  rtDWork.is_active_c11_adcs_v15_integral_Power_dist = 0U;
}

void adcs_v15_integral_Power_dist_QuEST(void)
{
  adcs_v15_integral_Power_dist_c11_adcs_v15_integral_Power_dist();
}
...
{
  {
    ...
    rtDWork.is_active_c7_adcs_v15_integral_Power_dist = 0U;
    rtDWork.is_active_c29_adcs_v15_integral_Power_dist = 0U;
    rtDWork.is_active_c5_adcs_v15_integral_Power_dist = 0U;
    rtDWork.is_active_c4_adcs_v15_integral_Power_dist = 0U;
    rtDWork.is_active_c22_adcs_v15_integral_Power_dist = 0U;
    rtDWork.is_active_c25_adcs_v15_integral_Power_dist = 0U;
    rtDWork.is_active_c12_adcs_v15_integral_Power_dist = 0U;
    adcs_v15_integral_Power_dist_QuEST_Init();
    rtDWork.IntegerDelay1_X_k[0] = rtP.IntegerDelay1_InitialCondition_f[0];
    rtDWork.IntegerDelay1_X_k[1] = rtP.IntegerDelay1_InitialCondition_f[1];
    rtDWork.IntegerDelay1_X_k[2] = rtP.IntegerDelay1_InitialCondition_f[2];
    rtDWork.IntegerDelay_X_g[0] = rtP.IntegerDelay_InitialCondition_l;
    rtDWork.IntegerDelay_X_g[1] = rtP.IntegerDelay_InitialCondition_l;
    rtDWork.IntegerDelay_X_g[2] = rtP.IntegerDelay_InitialCondition_l;
    rtDWork.IntegerDelay_X_g[3] = rtP.IntegerDelay_InitialCondition_l;
    rtDWork.is_active_c27_adcs_v15_integral_Power_dist = 0U;
    for (i = 0; i < 300; i++) {
      rtDWork.IntegerDelay_X_l[i] = rtP.IntegerDelay_InitialCondition_f;
    }

    rtDWork.is_active_c6_adcs_v15_integral_Power_dist = 0U;
    rtDWork.is_active_c10_adcs_v15_integral_Power_dist = 0U;
    rtDWork.is_active_c23_adcs_v15_integral_Power_dist = 0U;
    rtDWork.is_active_c13_adcs_v15_integral_Power_dist = 0U;
    rtDWork.UnitDelay1_DSTATE_m = rtP.UnitDelay1_X0_n;
    rtDWork.UnitDelay_DSTATE = rtP.UnitDelay_X0;
    rtDWork.is_active_c24_adcs_v15_integral_Power_dist = 0U;
    rtDWork.is_active_c1_adcs_v15_integral_Power_dist = 0U;
    rtDWork.IntegerDelay_X_a[0] = rtP.IntegerDelay_InitialCondition_p;
    rtDWork.UnitDelay1_DSTATE[0] = rtP.UnitDelay1_X0[0];
    rtDWork.TmpRTBAtProductInport2_Buffer0[0] = rtP.TmpRTBAtProductInport2_X0;
    rtDWork.IntegerDelay_X_a[1] = rtP.IntegerDelay_InitialCondition_p;
    rtDWork.UnitDelay1_DSTATE[1] = rtP.UnitDelay1_X0[1];
    rtDWork.TmpRTBAtProductInport2_Buffer0[1] = rtP.TmpRTBAtProductInport2_X0;
    rtDWork.IntegerDelay_X_a[2] = rtP.IntegerDelay_InitialCondition_p;
    rtDWork.UnitDelay1_DSTATE[2] = rtP.UnitDelay1_X0[2];
    rtDWork.TmpRTBAtProductInport2_Buffer0[2] = rtP.TmpRTBAtProductInport2_X0;
    rtDWork.is_active_c2_adcs_v15_integral_Power_dist = 0U;
    rtDWork.is_active_c9_adcs_v15_integral_Power_dist = 0U;
    rtDWork.is_active_c20_adcs_v15_integral_Power_dist = 0U;
    rtDWork.is_active_c16_adcs_v15_integral_Power_dist = 0U;
    rtDWork.is_active_c8_adcs_v15_integral_Power_dist = 0U;
    ...
    rtDWork.is_active_c30_adcs_v15_integral_Power_dist = 0U;
    rtDWork.is_active_c28_adcs_v15_integral_Power_dist = 0U;
    rtDWork.is_active_c19_adcs_v15_integral_Power_dist = 0U;
    rtDWork.is_active_c31_adcs_v15_integral_Power_dist = 0U;
    ...
    rtDWork.is_active_c26_adcs_v15_integral_Power_dist = 0U;
    rtX.Integrator_CSTATE_n = rtP.Integrator_IC_b;
  }
}
...
{
  {
...

    {
      ...
      if ((result=rt_ReadFromfileMatFile("SGP_120k.mat",7,
            &adcs_v15_integral_Power_dist_gblFrFInfo[0])) != (NULL)) {
        ssSetErrorStatus(rtS, result);
        return;
      }

      rtDWork.FromFile_PWORK.PrevTimePtr = (void *)
        adcs_v15_integral_Power_dist_gblFrFInfo[0].tuDataMatrix;
    }
...

    {
      ...
      if ((result=rt_ReadFromfileMatFile("Bi_120k.mat",4,
            &adcs_v15_integral_Power_dist_gblFrFInfo[1])) != (NULL)) {
        ssSetErrorStatus(rtS, result);
        return;
      }

      rtDWork.FromFile1_PWORK.PrevTimePtr = (void *)
        adcs_v15_integral_Power_dist_gblFrFInfo[1].tuDataMatrix;
    }

    rtB.Constant_m[0] = rtP.Constant_Value_j[0];
    rtB.Constant_m[1] = rtP.Constant_Value_j[1];
    rtB.Constant_m[2] = rtP.Constant_Value_j[2];

    {
      const char *result;
      if ((result=rt_ReadFromfileMatFile("Si_120k.mat",4,
            &adcs_v15_integral_Power_dist_gblFrFInfo[2])) != (NULL)) {
        ssSetErrorStatus(rtS, result);
        return;
      }

      rtDWork.FromFile_PWORK_g.PrevTimePtr = (void *)
        adcs_v15_integral_Power_dist_gblFrFInfo[2].tuDataMatrix;
    }

    {
      const char *result;
      if ((result=rt_ReadFromfileMatFile("light_120k.mat",2,
            &adcs_v15_integral_Power_dist_gblFrFInfo[3])) != (NULL)) {
        ssSetErrorStatus(rtS, result);
        return;
      }

      rtDWork.FromFile2_PWORK.PrevTimePtr = (void *)
        adcs_v15_integral_Power_dist_gblFrFInfo[3].tuDataMatrix;
    }
    ...
    rtDWork.RandSeed_l = tseed;
    rtDWork.NextOutput_l = rt_NormalRand(&rtDWork.RandSeed_l) *
      rtP.RandomNumber_StdDev_l + rtP.RandomNumber_Mean_l;
    rtB.Constant_b[0] = rtP.Constant_Value_od[0];
    rtB.Constant_b[1] = rtP.Constant_Value_od[1];
    rtB.Constant_b[2] = rtP.Constant_Value_od[2];
    ...
    rtDWork.NextOutput_n = rt_NormalRand(&rtDWork.RandSeed_g) *
      rtP.RandomNumber_StdDev_k + rtP.RandomNumber_Mean_m;
    rtB.Constant_e[0] = rtP.Constant_Value_os[0];
    rtB.Constant_e[1] = rtP.Constant_Value_os[1];
    rtB.Constant_e[2] = rtP.Constant_Value_os[2];
    if (rtIsNaN(rtP.RandomNumber_Seed_k) || rtIsInf(rtP.RandomNumber_Seed_k)) {
      tmp = 0.0;
    } else {
      tmp = muDoubleScalarRem(muDoubleScalarFloor(rtP.RandomNumber_Seed_k),
        4.294967296E+009);
    }
    ...
    rtDWork.NextOutput_m = rt_NormalRand(&rtDWork.RandSeed_m) *
      rtP.RandomNumber_StdDev_g + rtP.RandomNumber_Mean_i;
    rtB.Constant_k[0] = rtP.Constant_Value_b[0];
    rtB.Constant_k[1] = rtP.Constant_Value_b[1];
    rtB.Constant_k[2] = rtP.Constant_Value_b[2];
    if (rtIsNaN(rtP.RandomNumber_Seed_b) || rtIsInf(rtP.RandomNumber_Seed_b)) {
      tmp = 0.0;
    } else {
      tmp = muDoubleScalarRem(muDoubleScalarFloor(rtP.RandomNumber_Seed_b),
        4.294967296E+009);
    }
    ...
    rtDWork.RandSeed_le = tseed;
    rtDWork.NextOutput_n1 = rt_NormalRand(&rtDWork.RandSeed_le) *
      rtP.RandomNumber_StdDev_c + rtP.RandomNumber_Mean_lt;
    rtB.Constant_o[0] = rtP.Constant_Value_l[0];
    rtB.Constant_o[1] = rtP.Constant_Value_l[1];
    rtB.Constant_o[2] = rtP.Constant_Value_l[2];
    ...
    rtDWork.RandSeed_f = tseed;
    rtDWork.NextOutput_ma = rt_NormalRand(&rtDWork.RandSeed_f) *
      rtP.RandomNumber_StdDev_i + rtP.RandomNumber_Mean_j;
    rtB.Constant_mx[0] = rtP.Constant_Value_e[0];
    rtB.Constant_mx[1] = rtP.Constant_Value_e[1];
    rtB.Constant_mx[2] = rtP.Constant_Value_e[2];
    if (rtIsNaN(rtP.RandomNumber_Seed_e2) || rtIsInf(rtP.RandomNumber_Seed_e2))
    {
      tmp = 0.0;
    } else {
      tmp = muDoubleScalarRem(muDoubleScalarFloor(rtP.RandomNumber_Seed_e2),
        4.294967296E+009);
    }
    ...
    rtDWork.RandSeed_o = tseed;
    rtDWork.NextOutput_d = rt_NormalRand(&rtDWork.RandSeed_o) *
      rtP.RandomNumber_StdDev_n + rtP.RandomNumber_Mean_n;

    {
      const char *result;
      if ((result=rt_ReadFromfileMatFile("Si_120k.mat",4,
            &adcs_v15_integral_Power_dist_gblFrFInfo[4])) != (NULL)) {
        ssSetErrorStatus(rtS, result);
        return;
      }

      rtDWork.FromFile_PWORK_b.PrevTimePtr = (void *)
        adcs_v15_integral_Power_dist_gblFrFInfo[4].tuDataMatrix;
    }

    {
      const char *result;
      if ((result=rt_ReadFromfileMatFile("SGP_est_120k.mat",7,
            &adcs_v15_integral_Power_dist_gblFrFInfo[5])) != (NULL)) {
        ssSetErrorStatus(rtS, result);
        return;
      }

      rtDWork.FromFile2_PWORK_c.PrevTimePtr = (void *)
        adcs_v15_integral_Power_dist_gblFrFInfo[5].tuDataMatrix;
    }

    {
      const char *result;
      if ((result=rt_ReadFromfileMatFile("Bi8_est_120k.mat",4,
            &adcs_v15_integral_Power_dist_gblFrFInfo[6])) != (NULL)) {
        ssSetErrorStatus(rtS, result);
        return;
      }

      rtDWork.FromFile3_PWORK.PrevTimePtr = (void *)
        adcs_v15_integral_Power_dist_gblFrFInfo[6].tuDataMatrix;
    }
    ...
    rtB.Constant_i = rtP.Constant_Value_km;
...
void MdlOutputs(int_T tid)
{
...

  {
    ...
    static real_T tmp_6[9] = { 1.7007470856000001E-001, -0.00071033134,
      -0.00059844292, -0.00071033134, 0.1715993471, -0.00240388659,
      -0.00059844292, -0.00240388659, 0.1585857207 };

    static real_T tmp_7[9] = { 5.8799513739451559E+000, 2.4655987494540597E-002,
    ...
    if (ssIsContinuousTask(rtS, tid)) {
...

      {
        ...
        if (adcs_v15_integral_Power_dist_gblFrFInfo[0].nptsPerSignal == 1) {
          {
            int_T i1;
          ...
          pU = pStart + adcs_v15_integral_Power_dist_gblFrFInfo[0].nptsPerSignal
            - 2;
          if (time <= pStart[0]) {
            pT = pStart;
          } else if (time >= pU[0]) {
          ...
          pU = pT + adcs_v15_integral_Power_dist_gblFrFInfo[0].nptsPerSignal;
          if (pT[0] == pT[1]) {
            {
              int_T i1;
              real_T *y0 = rtB.FromFile;
              for (i1=0; i1 < 6; i1++) {
                ...
                pU += adcs_v15_integral_Power_dist_gblFrFInfo[0].nptsPerSignal;
              }
            }
          } else {
      ...
      eml_B = muDoubleScalarSqrt(adcs_v15_integral_Power_dist_dot_b(eml_oy,
        eml_oy));
      eml_oy[0] /= eml_B;
      eml_oy[1] /= eml_B;
      eml_oy[2] /= eml_B;
      eml_B = muDoubleScalarSqrt(adcs_v15_integral_Power_dist_dot_b(eml_r, eml_r));
      ...
      eml_B = muDoubleScalarSqrt(adcs_v15_integral_Power_dist_dot_b(eml_v, eml_v));
      ...
      rtB.modw = muDoubleScalarSqrt(adcs_v15_integral_Power_dist_dot_b
    ...
    if (ssIsContinuousTask(rtS, tid)) {
      {
        ...
        if (adcs_v15_integral_Power_dist_gblFrFInfo[1].nptsPerSignal == 1) {
          rtb_Product[0] = pT[1];
          rtb_Product[1] = pT[2];
          rtb_Product[2] = pT[3];
        } else {
          pU = pStart + adcs_v15_integral_Power_dist_gblFrFInfo[1].nptsPerSignal
            - 2;
          if (time <= pStart[0]) {
            pT = pStart;
          } else if (time >= pU[0]) {
          ...
          pU = pT + adcs_v15_integral_Power_dist_gblFrFInfo[1].nptsPerSignal;
          if (pT[0] == pT[1]) {
            rtb_Product[0] = pU[ (time < pT[0]) ? 0 : 1 ];
            pU += adcs_v15_integral_Power_dist_gblFrFInfo[1].nptsPerSignal;
      ...
      for (i = 0; i < 3; i++) {
        rtB.v_B_j[i] = 0.0;
        rtB.v_B_j[i] = eml_v_0[i] * rtB.Gain[0] + rtB.v_B_j[i];
        rtB.v_B_j[i] = eml_v_0[i + 3] * rtB.Gain[1] + rtB.v_B_j[i];
        rtB.v_B_j[i] = eml_v_0[i + 6] * rtB.Gain[2] + rtB.v_B_j[i];
      }
    }
    ...
    if (ssIsContinuousTask(rtS, tid)) {
      rtB.Sum1[0] = (rtB.Buffer + rtB.v_B_j[0]) + rtB.Constant;
      rtB.Sum1[1] = (rtB.Buffer + rtB.v_B_j[1]) + rtB.Constant;
      rtB.Sum1[2] = (rtB.Buffer + rtB.v_B_j[2]) + rtB.Constant;
    ...
    if (ssIsContinuousTask(rtS, tid)) {
      {
        ...
        real_T time = ssGetTaskTime(rtS,tid);
        const real_T *pU = (NULL);
        const real_T *pT = (const real_T *) rtDWork.FromFile_PWORK_g.PrevTimePtr;
        if (initBasePtr == TRUE) {
          pStart = (real_T *) rtDWork.FromFile_PWORK_g.PrevTimePtr;
          initBasePtr = FALSE;
        }

        if (adcs_v15_integral_Power_dist_gblFrFInfo[2].nptsPerSignal == 1) {
          rtB.FromFile_l[0] = pT[1];
          rtB.FromFile_l[1] = pT[2];
          rtB.FromFile_l[2] = pT[3];
        } else {
          pU = pStart + adcs_v15_integral_Power_dist_gblFrFInfo[2].nptsPerSignal
            - 2;
          if (time <= pStart[0]) {
            pT = pStart;
          } else if (time >= pU[0]) {
          ...
          rtDWork.FromFile_PWORK_g.PrevTimePtr = (void *) pT;
          pU = pT + adcs_v15_integral_Power_dist_gblFrFInfo[2].nptsPerSignal;
          if (pT[0] == pT[1]) {
            rtB.FromFile_l[0] = pU[ (time < pT[0]) ? 0 : 1 ];
            pU += adcs_v15_integral_Power_dist_gblFrFInfo[2].nptsPerSignal;
            rtB.FromFile_l[1] = pU[ (time < pT[0]) ? 0 : 1 ];
            pU += adcs_v15_integral_Power_dist_gblFrFInfo[2].nptsPerSignal;
            rtB.FromFile_l[2] = pU[ (time < pT[0]) ? 0 : 1 ];
          } else {
            real_T f = (pT[1]-time)/(pT[1]-pT[0]);
            if (pU[0] == pU[1]) {
              rtB.FromFile_l[0] = pU[0];
            } else {
              rtB.FromFile_l[0] = f*pU[0]+(1.0-f)*pU[1];
            }

            pU += adcs_v15_integral_Power_dist_gblFrFInfo[2].nptsPerSignal;
            if (pU[0] == pU[1]) {
              rtB.FromFile_l[1] = pU[0];
            } else {
              rtB.FromFile_l[1] = f*pU[0]+(1.0-f)*pU[1];
            }

            pU += adcs_v15_integral_Power_dist_gblFrFInfo[2].nptsPerSignal;
            if (pU[0] == pU[1]) {
              rtB.FromFile_l[2] = pU[0];
            } else {
              rtB.FromFile_l[2] = f*pU[0]+(1.0-f)*pU[1];
            }
          }
        }
      }
      ...
      for (i = 0; i < 3; i++) {
        rtB.v_B[i] = 0.0;
        rtB.v_B[i] = eml_v_0[i] * rtB.FromFile_l[0] + rtB.v_B[i];
        rtB.v_B[i] = eml_v_0[i + 3] * rtB.FromFile_l[1] + rtB.v_B[i];
        rtB.v_B[i] = eml_v_0[i + 6] * rtB.FromFile_l[2] + rtB.v_B[i];
      }
...

      {
        ...
        if (adcs_v15_integral_Power_dist_gblFrFInfo[3].nptsPerSignal == 1) {
          rtB.FromFile2 = pT[1];
        } else {
          pU = pStart + adcs_v15_integral_Power_dist_gblFrFInfo[3].nptsPerSignal
            - 2;
          if (time <= pStart[0]) {
            pT = pStart;
          } else if (time >= pU[0]) {
          ...
          pU = pT + adcs_v15_integral_Power_dist_gblFrFInfo[3].nptsPerSignal;
          if (pT[0] == pT[1]) {
      ...
      rtb_Gain = rtP.Gain_Gain_f * rt_SATURATE(rtb_jxi, rtP.Saturation_LowerSat,
        rtP.Saturation_UpperSat);
    }

    if (ssIsSampleHit(rtS, 1, tid)) {
      rtB.Sum_l = rtP.MatrixGain_Gain_f * rtDWork.NextOutput_l +
        rtP.Constant_Value_jh;

      {
        rtB.Buffer_b = rtB.Sum_l;
      }
    }

    if (ssIsContinuousTask(rtS, tid)) {
      rtb_jxi = rtb_Gain + rtB.Buffer_b;
    ...
    if (ssIsContinuousTask(rtS, tid)) {
      ...
      rtb_jxi *= rtB.FromFile2;
      rtb_Gain_l = rtP.Gain_Gain_fy * rt_SATURATE(rtb_jxi,
        rtP.Saturation_LowerSat_a, rtP.Saturation_UpperSat_e);
    }

    if (ssIsSampleHit(rtS, 1, tid)) {
      rtB.Sum_c = rtP.MatrixGain_Gain_o * rtDWork.NextOutput_n +
        rtP.Constant_Value_k;

      {
        rtB.Buffer_o = rtB.Sum_c;
      }
    }

    if (ssIsContinuousTask(rtS, tid)) {
      rtb_jxi = rtb_Gain_l + rtB.Buffer_o;
      rtB.ADC_l = rtP.ADC_Interval_h * muDoubleScalarRound((rtb_jxi/
        (rtP.ADC_Interval_h)));
    }
    ...
    if (ssIsContinuousTask(rtS, tid)) {
      ...
      rtb_jxi *= rtB.FromFile2;
      rtb_Gain_b = rtP.Gain_Gain_a * rt_SATURATE(rtb_jxi,
        rtP.Saturation_LowerSat_h, rtP.Saturation_UpperSat_k);
    }

    if (ssIsSampleHit(rtS, 1, tid)) {
      rtB.Sum_e = rtP.MatrixGain_Gain_h * rtDWork.NextOutput_m +
        rtP.Constant_Value_jd;

      {
        rtB.Buffer_m = rtB.Sum_e;
      }
    }

    if (ssIsContinuousTask(rtS, tid)) {
      rtb_jxi = rtb_Gain_b + rtB.Buffer_m;
      rtB.ADC_h = rtP.ADC_Interval_a * muDoubleScalarRound((rtb_jxi/
        (rtP.ADC_Interval_a)));
    }
    ...
    if (ssIsContinuousTask(rtS, tid)) {
      ...
      rtb_jxi *= rtB.FromFile2;
      rtb_Gain_c = rtP.Gain_Gain_k * rt_SATURATE(rtb_jxi,
        rtP.Saturation_LowerSat_l, rtP.Saturation_UpperSat_h);
    }

    if (ssIsSampleHit(rtS, 1, tid)) {
      rtB.Sum_h = rtP.MatrixGain_Gain_k * rtDWork.NextOutput_n1 +
        rtP.Constant_Value_i;

      {
        rtB.Buffer_c = rtB.Sum_h;
      }
    }

    if (ssIsContinuousTask(rtS, tid)) {
      rtb_jxi = rtb_Gain_c + rtB.Buffer_c;
      rtB.ADC_hj = rtP.ADC_Interval_b * muDoubleScalarRound((rtb_jxi/
        (rtP.ADC_Interval_b)));
    }
    ...
    if (ssIsContinuousTask(rtS, tid)) {
      ...
      rtb_jxi *= rtB.FromFile2;
      rtb_Gain_f = rtP.Gain_Gain_e * rt_SATURATE(rtb_jxi,
        rtP.Saturation_LowerSat_e, rtP.Saturation_UpperSat_c);
    }

    if (ssIsSampleHit(rtS, 1, tid)) {
      rtB.Sum_a = rtP.MatrixGain_Gain_m * rtDWork.NextOutput_ma +
        rtP.Constant_Value_c;

      {
        rtB.Buffer_g = rtB.Sum_a;
      }
    }

    if (ssIsContinuousTask(rtS, tid)) {
      rtb_jxi = rtb_Gain_f + rtB.Buffer_g;
      rtB.ADC_j = rtP.ADC_Interval_k * muDoubleScalarRound((rtb_jxi/
        (rtP.ADC_Interval_k)));
    }
    ...
    if (ssIsContinuousTask(rtS, tid)) {
      rtb_jxi = (rtB.Constant_mx[0] * rtB.v_B[0] + rtB.Constant_mx[1] * rtB.v_B
                 [1]) + rtB.Constant_mx[2] * rtB.v_B[2];
      rtb_jxi *= rtB.FromFile2;
      rtb_Gain_lb = rtP.Gain_Gain_fg * rt_SATURATE(rtb_jxi,
        rtP.Saturation_LowerSat_c, rtP.Saturation_UpperSat_ck);
    }

    if (ssIsSampleHit(rtS, 1, tid)) {
      rtB.Sum_k = rtP.MatrixGain_Gain_j * rtDWork.NextOutput_d +
        rtP.Constant_Value_d;

      {
        rtB.Buffer_d = rtB.Sum_k;
      }
    }

    if (ssIsContinuousTask(rtS, tid)) {
      rtb_jxi = rtb_Gain_lb + rtB.Buffer_d;
      rtB.ADC_o = rtP.ADC_Interval_hc * muDoubleScalarRound((rtb_jxi/
        (rtP.ADC_Interval_hc)));
      rtB.m_SUN[0] = rtB.Constant_m[0];
      rtB.m_SUN[1] = rtB.Constant_m[1];
      rtB.m_SUN[2] = rtB.Constant_m[2];
      rtB.m_SUN[5] = rtB.Constant_b[0];
      rtB.m_SUN[6] = rtB.Constant_b[1];
      rtB.m_SUN[7] = rtB.Constant_b[2];
      rtB.m_SUN[10] = rtB.Constant_e[0];
      rtB.m_SUN[11] = rtB.Constant_e[1];
      rtB.m_SUN[12] = rtB.Constant_e[2];
      rtB.m_SUN[15] = rtB.Constant_k[0];
      rtB.m_SUN[16] = rtB.Constant_k[1];
      rtB.m_SUN[17] = rtB.Constant_k[2];
      rtB.m_SUN[20] = rtB.Constant_o[0];
      rtB.m_SUN[21] = rtB.Constant_o[1];
      rtB.m_SUN[22] = rtB.Constant_o[2];
      rtB.m_SUN[25] = rtB.Constant_mx[0];
      rtB.m_SUN[26] = rtB.Constant_mx[1];
      rtB.m_SUN[27] = rtB.Constant_mx[2];
      for (i = 0; i < 6; i++) {
        rtB.m_SUN[3 + 5 * i] = 0.0;
      }
      ...
      rtB.m_SUN[14] = rtB.ADC_h;
      rtB.m_SUN[19] = rtB.ADC_hj;
      rtB.m_SUN[24] = rtB.ADC_j;
      rtB.m_SUN[29] = rtB.ADC_o;
      for (i = 0; i < 6; i++) {
    ...
    if (ssIsSampleHit(rtS, 2, tid)) {
      {
        ...
        real_T time = ssGetTaskTime(rtS,tid);
        const real_T *pU = (NULL);
        const real_T *pT = (const real_T *) rtDWork.FromFile_PWORK_b.PrevTimePtr;
        if (initBasePtr == TRUE) {
          pStart = (real_T *) rtDWork.FromFile_PWORK_b.PrevTimePtr;
          initBasePtr = FALSE;
        }

        if (adcs_v15_integral_Power_dist_gblFrFInfo[4].nptsPerSignal == 1) {
          rtB.FromFile_e[0] = pT[1];
          rtB.FromFile_e[1] = pT[2];
          rtB.FromFile_e[2] = pT[3];
        } else {
          pU = pStart + adcs_v15_integral_Power_dist_gblFrFInfo[4].nptsPerSignal
            - 2;
          if (time <= pStart[0]) {
            pT = pStart;
          } else if (time >= pU[0]) {
          ...
          rtDWork.FromFile_PWORK_b.PrevTimePtr = (void *) pT;
          pU = pT + adcs_v15_integral_Power_dist_gblFrFInfo[4].nptsPerSignal;
          if (pT[0] == pT[1]) {
            rtB.FromFile_e[0] = pU[ (time < pT[0]) ? 0 : 1 ];
            pU += adcs_v15_integral_Power_dist_gblFrFInfo[4].nptsPerSignal;
...

      {
        ...
        if (initBasePtr == TRUE) {
          pStart = (real_T *) rtDWork.FromFile2_PWORK_c.PrevTimePtr;
          initBasePtr = FALSE;
        }

        if (adcs_v15_integral_Power_dist_gblFrFInfo[5].nptsPerSignal == 1) {
          {
            int_T i1;
            real_T *y0 = rtB.FromFile2_o;
            for (i1=0; i1 < 6; i1++) {
              y0[i1] = pT[i1 + 1];
            }
          }
        } else {
          pU = pStart + adcs_v15_integral_Power_dist_gblFrFInfo[5].nptsPerSignal
            - 2;
          if (time <= pStart[0]) {
            pT = pStart;
          } else if (time >= pU[0]) {
          ...
          rtDWork.FromFile2_PWORK_c.PrevTimePtr = (void *) pT;
          pU = pT + adcs_v15_integral_Power_dist_gblFrFInfo[5].nptsPerSignal;
          if (pT[0] == pT[1]) {
            {
              int_T i1;
              real_T *y0 = rtB.FromFile2_o;
              for (i1=0; i1 < 6; i1++) {
                y0[i1] = pU[ (time < pT[0]) ? 0 : 1 ];
                pU += adcs_v15_integral_Power_dist_gblFrFInfo[5].nptsPerSignal;
              }
            }
          } else {
            real_T f = (pT[1]-time)/(pT[1]-pT[0]);
...

      {
        ...
        if (adcs_v15_integral_Power_dist_gblFrFInfo[6].nptsPerSignal == 1) {
          rtB.FromFile3[0] = pT[1];
          rtB.FromFile3[1] = pT[2];
          rtB.FromFile3[2] = pT[3];
        } else {
          pU = pStart + adcs_v15_integral_Power_dist_gblFrFInfo[6].nptsPerSignal
            - 2;
          if (time <= pStart[0]) {
            pT = pStart;
          } else if (time >= pU[0]) {
          ...
          pU = pT + adcs_v15_integral_Power_dist_gblFrFInfo[6].nptsPerSignal;
          if (pT[0] == pT[1]) {
            rtB.FromFile3[0] = pU[ (time < pT[0]) ? 0 : 1 ];
            pU += adcs_v15_integral_Power_dist_gblFrFInfo[6].nptsPerSignal;
      ...
      eml_r[0] = rtB.FromFile2_o[0];
      eml_v[0] = rtB.FromFile2_o[3];
      eml_r[1] = rtB.FromFile2_o[1];
      eml_v[1] = rtB.FromFile2_o[4];
      eml_r[2] = rtB.FromFile2_o[2];
      eml_v[2] = rtB.FromFile2_o[5];
      eml_oy[0] = eml_v[1] * eml_r[2] - eml_v[2] * eml_r[1];
      eml_oy[1] = eml_v[2] * eml_r[0] - eml_v[0] * eml_r[2];
      eml_oy[2] = eml_v[0] * eml_r[1] - eml_v[1] * eml_r[0];
      eml_TIO_idx = muDoubleScalarSqrt(adcs_v15_integral_Power_dist_dot_l(eml_oy,
        eml_oy));
      eml_oy[0] /= eml_TIO_idx;
      eml_oy[1] /= eml_TIO_idx;
      eml_oy[2] /= eml_TIO_idx;
      eml_TIO_idx = muDoubleScalarSqrt(adcs_v15_integral_Power_dist_dot_l(eml_r,
        eml_r));
      ...
      eml_v[1] = eml_oy[2] * eml_r[0] - eml_oy[0] * eml_r[2];
      eml_v[2] = eml_oy[0] * eml_r[1] - eml_oy[1] * eml_r[0];
      eml_TIO_idx = muDoubleScalarSqrt(adcs_v15_integral_Power_dist_dot_l(eml_v,
        eml_v));
      eml_v[0] /= eml_TIO_idx;
      eml_v[1] /= eml_TIO_idx;
      eml_v[2] /= eml_TIO_idx;
      ...
      for (i = 0; i < 3; i++) {
        ...
        eml_r[i] = rtB.FromFile2_o[i];
        eml_v[i] = rtB.FromFile2_o[i + 3];
      }

      eml_oy[0] = eml_v[1] * eml_r[2] - eml_v[2] * eml_r[1];
      eml_oy[1] = eml_v[2] * eml_r[0] - eml_v[0] * eml_r[2];
      eml_oy[2] = eml_v[0] * eml_r[1] - eml_v[1] * eml_r[0];
      eml_TIO_idx = muDoubleScalarSqrt(adcs_v15_integral_Power_dist_dot_o(eml_oy,
        eml_oy));
      eml_oy[0] /= eml_TIO_idx;
      eml_oy[1] /= eml_TIO_idx;
      eml_oy[2] /= eml_TIO_idx;
      eml_TIO_idx = muDoubleScalarSqrt(adcs_v15_integral_Power_dist_dot_o(eml_r,
        eml_r));
      eml_r[0] = (-eml_r[0]) / eml_TIO_idx;
      eml_r[1] = (-eml_r[1]) / eml_TIO_idx;
      eml_r[2] = (-eml_r[2]) / eml_TIO_idx;
      ...
      eml_v[1] = eml_oy[2] * eml_r[0] - eml_oy[0] * eml_r[2];
      eml_v[2] = eml_oy[0] * eml_r[1] - eml_oy[1] * eml_r[0];
      eml_TIO_idx = muDoubleScalarSqrt(adcs_v15_integral_Power_dist_dot_o(eml_v,
        eml_v));
      eml_v[0] /= eml_TIO_idx;
      eml_v[1] /= eml_TIO_idx;
      eml_v[2] /= eml_TIO_idx;
      ...
      for (i = 0; i < 3; i++) {
        rtB.v_O[i] = 0.0;
        rtB.v_O[i] = eml_v_0[i] * rtB.FromFile_e[0] + rtB.v_O[i];
        rtB.v_O[i] = eml_v_0[i + 3] * rtB.FromFile_e[1] + rtB.v_O[i];
        rtB.v_O[i] = eml_v_0[i + 6] * rtB.FromFile_e[2] + rtB.v_O[i];
      }

      adcs_v15_integral_Power_dist_QuEST();
    ...
    if (ssIsSampleHit(rtS, 2, tid)) {
      rtB.IntegerDelay1_a[0] = rtDWork.IntegerDelay1_X_k[0];
      rtB.IntegerDelay1_a[1] = rtDWork.IntegerDelay1_X_k[1];
      rtB.IntegerDelay1_a[2] = rtDWork.IntegerDelay1_X_k[2];
      rtB.IntegerDelay_g[0] = rtDWork.IntegerDelay_X_g[0];
      eml_q_idx = (rtB.q_BO_est[0] + rtB.IntegerDelay_g[0]) / 2.0;
      rtB.IntegerDelay_g[1] = rtDWork.IntegerDelay_X_g[1];
      eml_TIO_idx_0 = (rtB.q_BO_est[1] + rtB.IntegerDelay_g[1]) / 2.0;
      rtB.IntegerDelay_g[2] = rtDWork.IntegerDelay_X_g[2];
      eml_q_idx_0 = (rtB.q_BO_est[2] + rtB.IntegerDelay_g[2]) / 2.0;
      rtB.IntegerDelay_g[3] = rtDWork.IntegerDelay_X_g[3];
      eml_B = (rtB.q_BO_est[3] + rtB.IntegerDelay_g[3]) / 2.0;
      eml_r[0] = eml_q_idx;
      ...
      eml_TIO_idx_0 = (rtB.q_BO_est[0] - rtB.IntegerDelay_g[0]) /
        adcs_v15_integral_Power_dist_s_FRAME_SIZE;
      eml_q_idx_0 = (rtB.q_BO_est[1] - rtB.IntegerDelay_g[1]) /
        adcs_v15_integral_Power_dist_s_FRAME_SIZE;
      eml_TIO_idx = (rtB.q_BO_est[2] - rtB.IntegerDelay_g[2]) /
        adcs_v15_integral_Power_dist_s_FRAME_SIZE;
      for (i = 0; i < 3; i++) {
      ...
      eml_x = 2.0 / (adcs_v15_integral_Power_dist_s_FRAME_SIZE +
                     rtP.SFunction_p2_j);
      ...
      rtB.IntegerDelay_i = rtDWork.IntegerDelay_X_l[0];
      rtB.y = (1.0 - rtB.light_est) + rtB.IntegerDelay_i;
      if (rtB.y > 1.0) {
        rtB.y = 1.0;
      }
    ...
    if (ssIsSampleHit(rtS, 2, tid)) {
      ...
      rtB.IntegerDelay_n[0] = rtDWork.IntegerDelay_X_a[0];
      rtB.dB[0] = (rtB.TmpRTBAtControlLawInport1[0] - rtB.IntegerDelay_n[0]) /
        adcs_v15_integral_Power_dist_s_FRAME_SIZE;
      rtB.B[0] = (rtB.TmpRTBAtControlLawInport1[0] + rtB.IntegerDelay_n[0]) /
        2.0;
      rtB.IntegerDelay_n[1] = rtDWork.IntegerDelay_X_a[1];
      rtB.dB[1] = (rtB.TmpRTBAtControlLawInport1[1] - rtB.IntegerDelay_n[1]) /
        adcs_v15_integral_Power_dist_s_FRAME_SIZE;
      rtB.B[1] = (rtB.TmpRTBAtControlLawInport1[1] + rtB.IntegerDelay_n[1]) /
        2.0;
      rtB.IntegerDelay_n[2] = rtDWork.IntegerDelay_X_a[2];
      rtB.dB[2] = (rtB.TmpRTBAtControlLawInport1[2] - rtB.IntegerDelay_n[2]) /
        adcs_v15_integral_Power_dist_s_FRAME_SIZE;
      rtB.B[2] = (rtB.TmpRTBAtControlLawInport1[2] + rtB.IntegerDelay_n[2]) /
        2.0;
      ...
      rtB.UnitDelay1_b = rtDWork.UnitDelay1_DSTATE_m;
    }
    ...
    if (ssIsSampleHit(rtS, 2, tid)) {
      ...
      eml_TIO_idx = (rtB.Product[0] * rtB.Product[0] + rtB.Product[1] *
                     rtB.Product[1]) + rtB.Product[2] * rtB.Product[2];
      eml_TIO_idx = muDoubleScalarSqrt(eml_TIO_idx);
      if ((eml_TIO_idx < adcs_v15_integral_Power_dist_tol_w) && (rtB.light_est *
           rtB.y == 1.0)) {
        eml_b_2 = true;
      } else {
        eml_b_2 = false;
      ...
      rtB.P[0] = (real_T)(muDoubleScalarAbs(rtB.q_BO_est[3]) >
                          adcs_v15_integral_Power_dist_tol_q4) + 0.1;
      rtB.P[1] = (real_T)(eml_TIO_idx < adcs_v15_integral_Power_dist_tol_w);
      rtB.P[2] = (real_T)(rtB.light_est * rtB.y == 1.0) + 0.3;
      rtB.N = rtB.UnitDelay1_b;
      ...
      if ((eml_b_2 == 1) && (rtB.UnitDelay1_b == 0.0)) {
        rtB.N = 1.0;
        rtB.t_now = rtB.TmpRTBAtgatepulseInport4;
      }

      if (((eml_TIO_idx > adcs_v15_integral_Power_dist_tolw_n2d) == 1) &&
          (rtB.UnitDelay1_b == 1.0) && (rtB.TmpRTBAtgatepulseInport4 >
           rtB.UnitDelay + adcs_v15_integral_Power_dist_check_time)) {
        rtB.N = 0.0;
        rtB.t_now = rtB.TmpRTBAtgatepulseInport4;
      }
      ...
      eml_TIO_idx_0 = rtP.Gain1_Gain_d * rt_SATURATE(eml_r[0],
      ...
      eml_TIO_idx_0 = rtP.Gain1_Gain_d * rt_SATURATE(eml_r[1],
        rtP.MomentSaturation_LowerSat, rtP.MomentSaturation_UpperSat);
      eml_TIO_idx_0 = rt_SATURATE(eml_TIO_idx_0, rtP.PowerSaturation_LowerSat,
        rtP.PowerSaturation_UpperSat);
      eml_r[1] = eml_TIO_idx_0;
      eml_TIO_idx_0 = rtP.Gain1_Gain_d * rt_SATURATE(eml_r[2],
        rtP.MomentSaturation_LowerSat, rtP.MomentSaturation_UpperSat);
      eml_TIO_idx_0 = rt_SATURATE(eml_TIO_idx_0, rtP.PowerSaturation_LowerSat,
        rtP.PowerSaturation_UpperSat);
    ...
    if (ssIsContinuousTask(rtS, tid) && ssIsSpecialSampleHit(rtS,4,0,tid)) {
      rtB.TmpRTBAtToWorkspace12Inport1[0] = rtB.v_B_j[0];
      rtB.TmpRTBAtToWorkspace12Inport1[1] = rtB.v_B_j[1];
      rtB.TmpRTBAtToWorkspace12Inport1[2] = rtB.v_B_j[2];
    }
    ...
    if (ssIsContinuousTask(rtS, tid) && ssIsSpecialSampleHit(rtS,4,0,tid)) {
      rtB.TmpRTBAtToWorkspace20Inport1[0] = rtB.FromFile_l[0];
      rtB.TmpRTBAtToWorkspace20Inport1[1] = rtB.FromFile_l[1];
      rtB.TmpRTBAtToWorkspace20Inport1[2] = rtB.FromFile_l[2];
    }
    ...
    if (ssIsSampleHit(rtS, 1, tid)) {
      rtB.Gain_i[0] = rtP.Gain_Gain_j * rtP.Constant_Value_oe[0];
      rtB.Gain_i[1] = rtP.Gain_Gain_j * rtP.Constant_Value_oe[1];
      rtB.Gain_i[2] = rtP.Gain_Gain_j * rtP.Constant_Value_oe[2];
    ...
    if (ssIsContinuousTask(rtS, tid)) {
      ...
      rtb_jxi = rtb_Product[1] * rtB.v_B_j[2];
      rtB.Sum_m[0] = rtb_jxi - rtb_Product[2] * rtB.v_B_j[1];
      rtB.Sum_m[1] = rtb_Product[2] * rtB.v_B_j[0] - rtb_Product[0] * rtB.v_B_j
        [2];
      rtB.Sum_m[2] = rtb_Product[0] * rtB.v_B_j[1] - rtb_Product[1] * rtB.v_B_j
        [0];
      if (ssIsSpecialSampleHit(rtS,4,0,tid)) {
        rtB.TmpRTBAtToWorkspace9Inport1[0] = rtB.Sum_m[0];
        rtB.TmpRTBAtToWorkspace9Inport1[1] = rtB.Sum_m[1];
        rtB.TmpRTBAtToWorkspace9Inport1[2] = rtB.Sum_m[2];
      }
    }
    ...
    if (ssIsContinuousTask(rtS, tid)) {
      rtB.Sum_h1[0] = (muDoubleScalarSin(rtP.SineWave_Freq * ssGetTaskTime(rtS,
        tid) + rtP.SineWave_Phase) * rtP.SineWave_Amp + rtP.SineWave_Bias) +
        rtB.Sum_m[0];
      rtB.Sum_h1[1] = (muDoubleScalarSin(rtP.SineWave1_Freq * ssGetTaskTime(rtS,
        tid) + rtP.SineWave1_Phase) * rtP.SineWave1_Amp + rtP.SineWave1_Bias) +
        rtB.Sum_m[1];
      rtB.Sum_h1[2] = (muDoubleScalarSin(rtP.SineWave2_Freq * ssGetTaskTime(rtS,
        tid) + rtP.SineWave2_Phase) * rtP.SineWave2_Amp + rtP.SineWave2_Bias) +
        rtB.Sum_m[2];
      eml_r[0] = rtB.xN[4];
      eml_r[1] = rtB.xN[5];
      eml_r[2] = rtB.xN[6];
      for (i = 0; i < 3; i++) {
        eml_b[i] = tmp_6[i + 6] * eml_r[2] + (tmp_6[i + 3] * eml_r[1] + tmp_6[i]
          * eml_r[0]);
      }
      ...
      eml_TIO_idx_0 = rtB.Sum_h1[0] - (eml_r[1] * eml_b[2] - eml_r[2] * eml_b[1]);
      eml_q_idx_0 = rtB.Sum_h1[1] - (eml_r[2] * eml_b[0] - eml_r[0] * eml_b[2]);
      eml_TIO_idx = rtB.Sum_h1[2] - (eml_r[0] * eml_b[1] - eml_r[1] * eml_b[0]);
      for (i = 0; i < 4; i++) {
      ...
      for (i = 0; i < 3; i++) {
        eml_v[i] = tmp_7[i + 6] * eml_TIO_idx + (tmp_7[i + 3] * eml_q_idx_0 +
          tmp_7[i] * eml_TIO_idx_0);
      }
      ...
      eml_TIO_idx = (eml_r_B[0] * eml_r_B[0] + eml_r_B[1] * eml_r_B[1]) +
        eml_r_B[2] * eml_r_B[2];
      for (i = 0; i < 3; i++) {
        eml_b_0[i] = tmp_6[i + 6] * eml_r_B[2] + (tmp_6[i + 3] * eml_r_B[1] +
          tmp_6[i] * eml_r_B[0]);
      }

      eml_TIO_idx = muDoubleScalarPower(muDoubleScalarSqrt(eml_TIO_idx), 5.0);
      rtB.tau[0] = (eml_r_B[1] * eml_b_0[2] - eml_r_B[2] * eml_b_0[1]) *
        1.195975098E+015 / eml_TIO_idx;
      rtB.tau[1] = (eml_r_B[2] * eml_b_0[0] - eml_r_B[0] * eml_b_0[2]) *
        1.195975098E+015 / eml_TIO_idx;
      rtB.tau[2] = (eml_r_B[0] * eml_b_0[1] - eml_r_B[1] * eml_b_0[0]) *
        1.195975098E+015 / eml_TIO_idx;
    ...
    if (ssIsContinuousTask(rtS, tid)) {
      ...
      eml_TIO_idx = muDoubleScalarSqrt(adcs_v15_integral_Power_dist_dot_g
        (&rtB.v_B_d[0], &rtB.v_B_d[0]));
      eml_r[0] = rtB.v_B_d[0] / eml_TIO_idx;
      eml_r[1] = rtB.v_B_d[1] / eml_TIO_idx;
      eml_r[2] = rtB.v_B_d[2] / eml_TIO_idx;
      eml_x = 0.0;
      memset((void *)&eml_b_1[0], (int32_T)0.0, 18U * sizeof(real_T));
      eml_b_1[0] = 6.7600000000000007E-002;
      eml_b_1[1] = 0.0;
      eml_b_1[2] = 0.0;
      eml_b_1[3] = 0.0;
      eml_b_1[4] = 6.7600000000000007E-002;
      eml_b_1[5] = 0.0;
      eml_b_1[6] = 0.0;
      eml_b_1[7] = 0.0;
      eml_b_1[8] = 6.7600000000000007E-002;
      eml_b_1[9] = -6.7600000000000007E-002;
      eml_b_1[10] = 0.0;
      eml_b_1[11] = 0.0;
      eml_b_1[12] = 0.0;
      eml_b_1[13] = -6.7600000000000007E-002;
      eml_b_1[14] = 0.0;
      eml_b_1[15] = 0.0;
      eml_b_1[16] = 0.0;
      eml_b_1[17] = -6.7600000000000007E-002;
      for (i = 0; i < 6; i++) {
        eml_b_3[0] = eml_b_1[3 * i];
        eml_b_3[1] = eml_b_1[3 * i + 1];
        eml_b_3[2] = eml_b_1[3 * i + 2];
        eml_B = adcs_v15_integral_Power_dist_dot_g(eml_b_3, eml_r);
        if (eml_B > 0.0) {
          eml_x += eml_B;
        }
      }

      eml_TIO_idx = -0.5 * rtP.SFunction_p1 * rtB.Constant_i * eml_x *
    ...
    if (ssIsContinuousTask(rtS, tid)) {
      if (adcs_v15_integral_Power_dist_norm_l(&rtB.v_B[0]) == 0.0) {
        rtB.solar_drag[0] = 1.0;
        rtB.solar_drag[1] = 0.0;
        rtB.solar_drag[2] = 0.0;
      } else {
        eml_TIO_idx = adcs_v15_integral_Power_dist_norm_l(&rtB.v_B[0]);
      ...
      for (i = 0; i < 6; i++) {
        eml_r[0] = eml_b_1[3 * i];
        eml_r[1] = eml_b_1[3 * i + 1];
        eml_r[2] = eml_b_1[3 * i + 2];
      ...
      rtb_jxi = rtB.VectorfromCoMtoCoP_inBodyframeyettobefinalized2[1] *
        rtB.solar_drag[0];
      rtB.Sum_p[0] = rtB.VectorfromCoMtoCoP_inBodyframeyettobefinalized2[1] *
        rtB.solar_drag[2] - rtB.VectorfromCoMtoCoP_inBodyframeyettobefinalized2
        [2] * rtB.solar_drag[1];
      rtB.Sum_p[1] = rtB.VectorfromCoMtoCoP_inBodyframeyettobefinalized2[2] *
        rtB.solar_drag[0] - rtB.VectorfromCoMtoCoP_inBodyframeyettobefinalized2
        [0] * rtB.solar_drag[2];
      rtB.Sum_p[2] = rtB.VectorfromCoMtoCoP_inBodyframeyettobefinalized2[0] *
        rtB.solar_drag[1] - rtb_jxi;
      rtB.Sum_e1[0] = (rtB.tau[0] + rtB.u_aero[0]) + rtB.Sum_p[0];
      rtB.Sum_e1[1] = (rtB.tau[1] + rtB.u_aero[1]) + rtB.Sum_p[1];
      rtB.Sum_e1[2] = (rtB.tau[2] + rtB.u_aero[2]) + rtB.Sum_p[2];
      if (ssIsSpecialSampleHit(rtS,3,0,tid)) {
        rtB.TmpRTBAtw_real2Inport1[0] = rtB.Sum_e1[0];
        rtB.TmpRTBAtw_real2Inport1[1] = rtB.Sum_e1[1];
        rtB.TmpRTBAtw_real2Inport1[2] = rtB.Sum_e1[2];
      }
    }
    ...
    if (ssIsContinuousTask(rtS, tid) && ssIsSpecialSampleHit(rtS,3,0,tid)) {
      rtB.TmpRTBAtw_real4Inport1[0] = rtB.Sum_p[0];
      rtB.TmpRTBAtw_real4Inport1[1] = rtB.Sum_p[1];
      rtB.TmpRTBAtw_real4Inport1[2] = rtB.Sum_p[2];
    }
    ...
    if (ssIsSampleHit(rtS, 1, tid)) {
      rtB.Constant_g[0] = rtP.Constant_Value_eb[0];
      rtB.Constant_g[1] = rtP.Constant_Value_eb[1];
      rtB.Constant_g[2] = rtP.Constant_Value_eb[2];
    }
    ...
    if (ssIsContinuousTask(rtS, tid)) {
      ...
      rtB.Gain_f = rtP.Gain1_Gain * rt_SATURATE(eml_TIO_idx,
        rtP.Saturation_LowerSat_cn, rtP.Saturation_UpperSat_es) *
        rtP.Gain_Gain_l;
    }

    if (ssIsSampleHit(rtS, 1, tid)) {
      rtB.Constant_a[0] = rtP.Constant_Value_lz[0];
      rtB.Constant_a[1] = rtP.Constant_Value_lz[1];
      rtB.Constant_a[2] = rtP.Constant_Value_lz[2];
    }
    ...
    if (ssIsContinuousTask(rtS, tid)) {
      eml_TIO_idx = ((rtB.Constant_a[0] * rtB.v_B[0] + rtB.Constant_a[1] *
        ...
        rtB.FromFile2;
      rtB.Gain_d = rtP.Gain1_Gain_m * rt_SATURATE(eml_TIO_idx,
        rtP.Saturation_LowerSat_i, rtP.Saturation_UpperSat_d) * rtP.Gain_Gain_p;
    }

    if (ssIsSampleHit(rtS, 1, tid)) {
      rtB.Constant_j[0] = rtP.Constant_Value_n[0];
      rtB.Constant_j[1] = rtP.Constant_Value_n[1];
      rtB.Constant_j[2] = rtP.Constant_Value_n[2];
    }

    if (ssIsContinuousTask(rtS, tid)) {
      eml_TIO_idx = ((rtB.Constant_j[0] * rtB.v_B[0] + rtB.Constant_j[1] *
                      rtB.v_B[1]) + rtB.Constant_j[2] * rtB.v_B[2]) *
        rtB.FromFile2;
      rtB.Gain_it = rtP.Gain1_Gain_l * rt_SATURATE(eml_TIO_idx,
        rtP.Saturation_LowerSat_lu, rtP.Saturation_UpperSat_b) * rtP.Gain_Gain_h;
    }

    if (ssIsSampleHit(rtS, 1, tid)) {
      rtB.Constant_h[0] = rtP.Constant_Value_f[0];
      rtB.Constant_h[1] = rtP.Constant_Value_f[1];
      rtB.Constant_h[2] = rtP.Constant_Value_f[2];
    }

    if (ssIsContinuousTask(rtS, tid)) {
      eml_TIO_idx = ((rtB.Constant_h[0] * rtB.v_B[0] + rtB.Constant_h[1] *
                      rtB.v_B[1]) + rtB.Constant_h[2] * rtB.v_B[2]) *
        rtB.FromFile2;
      rtB.Gain_g = rtP.Gain1_Gain_e * rt_SATURATE(eml_TIO_idx,
        rtP.Saturation_LowerSat_b, rtP.Saturation_UpperSat_hv) *
        rtP.Gain_Gain_lg;
    }

    if (ssIsSampleHit(rtS, 1, tid)) {
      rtB.Constant_a0[0] = rtP.Constant_Value_ebv[0];
      rtB.Constant_a0[1] = rtP.Constant_Value_ebv[1];
      rtB.Constant_a0[2] = rtP.Constant_Value_ebv[2];
    }

    if (ssIsContinuousTask(rtS, tid)) {
      eml_TIO_idx = ((rtB.Constant_a0[0] * rtB.v_B[0] + rtB.Constant_a0[1] *
                      rtB.v_B[1]) + rtB.Constant_a0[2] * rtB.v_B[2]) *
        rtB.FromFile2;
      rtB.Gain_p = rtP.Gain1_Gain_o * rt_SATURATE(eml_TIO_idx,
        rtP.Saturation_LowerSat_k, rtP.Saturation_UpperSat_dg) * rtP.Gain_Gain_n;
    }

    if (ssIsSampleHit(rtS, 1, tid)) {
      rtB.Constant_mg[0] = rtP.Constant_Value_dm[0];
      rtB.Constant_mg[1] = rtP.Constant_Value_dm[1];
      rtB.Constant_mg[2] = rtP.Constant_Value_dm[2];
    }

    if (ssIsContinuousTask(rtS, tid)) {
      eml_TIO_idx = ((rtB.Constant_mg[0] * rtB.v_B[0] + rtB.Constant_mg[1] *
                      rtB.v_B[1]) + rtB.Constant_mg[2] * rtB.v_B[2]) *
        rtB.FromFile2;
      rtB.Gain_o = rtP.Gain1_Gain_j * rt_SATURATE(eml_TIO_idx,
        rtP.Saturation_LowerSat_d, rtP.Saturation_UpperSat_du) * rtP.Gain_Gain_g;
      if (ssIsSpecialSampleHit(rtS,4,0,tid)) {
        rtB.TmpRTBAtScope11Inport1[0] = rtB.Gain_f;
        rtB.TmpRTBAtScope11Inport1[1] = rtB.Gain_d;
        rtB.TmpRTBAtScope11Inport1[2] = rtB.Gain_it;
        rtB.TmpRTBAtScope11Inport1[3] = rtB.Gain_g;
        rtB.TmpRTBAtScope11Inport1[4] = rtB.Gain_p;
        rtB.TmpRTBAtScope11Inport1[5] = rtB.Gain_o;
      }
    }
    ...
    if (ssIsContinuousTask(rtS, tid)) {
      rtB.Gain1[0] = rtP.Gain1_Gain_oy * rtB.Gain_f;
      rtB.Gain1[1] = rtP.Gain1_Gain_oy * rtB.Gain_d;
      rtB.Gain1[2] = rtP.Gain1_Gain_oy * rtB.Gain_it;
      rtB.Gain1[3] = rtP.Gain1_Gain_oy * rtB.Gain_g;
      rtB.Gain1[4] = rtP.Gain1_Gain_oy * rtB.Gain_p;
      rtB.Gain1[5] = rtP.Gain1_Gain_oy * rtB.Gain_o;
      if (ssIsSpecialSampleHit(rtS,4,0,tid)) {
        for (i = 0; i < 6; i++) {
    ...
    if (ssIsContinuousTask(rtS, tid)) {
      ...
      eml_TIO_idx = adcs_v15_integral_Power_dist_norm_j(&rtB.r_ECEF[0]);
      ...
      rtB.Gain2_h = rtP.Gain2_Gain_m * rtB.AddingSolarPower1;
      if (ssIsSpecialSampleHit(rtS,4,0,tid)) {
        rtB.TmpRTBAtScope13Inport1 = rtB.Gain2_h;
      }
    }
    ...
    if (ssIsContinuousTask(rtS, tid)) {
      if (rtB.Clock_o < 0.15) {
        rtB.Batt_cap = 2000.0;
        rtB.current = 0.0;
        rtB.VBat = adcs_v15_integral_Power_dist_isro_battery(200.0, 0.0, 0.08);
      } else if (rtB.Gain2_h < 0.0) {
        rtB.current = rtB.Gain2_h / (rtP.SFunction_p1_e * 2.0 *
          rtB.IntegerDelay4);
        rtB.Batt_cap = rtB.Gain2_h / (21.6 * rtB.IntegerDelay4) +
          rtB.IntegerDelay3;
        rtB.VBat = adcs_v15_integral_Power_dist_isro_battery(2200.0 -
    ...
    if (ssIsContinuousTask(rtS, tid)) {
      rtB.Integrator_c = rtX.Integrator_CSTATE_n;
    }
...
{
  {
    ...
    if (ssIsSampleHit(rtS, 2, tid)) {
      rtDWork.IntegerDelay1_X_k[0] = rtB.w_l[0];
      rtDWork.IntegerDelay1_X_k[1] = rtB.w_l[1];
      rtDWork.IntegerDelay1_X_k[2] = rtB.w_l[2];
      ...
      for (loopVar_i = 0; loopVar_i < 299; loopVar_i++) {
        rtDWork.IntegerDelay_X_l[loopVar_i] = rtDWork.IntegerDelay_X_l[loopVar_i
          + 1];
      }

      rtDWork.IntegerDelay_X_l[299] = rtB.light_est;
    }

    if (ssIsSampleHit(rtS, 2, tid)) {
      rtDWork.UnitDelay1_DSTATE_m = rtB.N;
      rtDWork.UnitDelay_DSTATE = rtB.t_now;
      rtDWork.IntegerDelay_X_a[0] = rtB.TmpRTBAtControlLawInport1[0];
      rtDWork.UnitDelay1_DSTATE[0] = rtB.ieu[0];
      rtDWork.TmpRTBAtProductInport2_Buffer0[0] = rtB.Gain2[0];
      rtDWork.IntegerDelay_X_a[1] = rtB.TmpRTBAtControlLawInport1[1];
      rtDWork.UnitDelay1_DSTATE[1] = rtB.ieu[1];
      rtDWork.TmpRTBAtProductInport2_Buffer0[1] = rtB.Gain2[1];
      rtDWork.IntegerDelay_X_a[2] = rtB.TmpRTBAtControlLawInport1[2];
...
{
  {
    ...
    ((StateDerivatives *) ssGetdX(rtS))->Integrator_CSTATE_n = rtB.current;
  }
}
...
{
  if (adcs_v15_integral_Power_dist_gblFrFInfo[0].tuDataMatrix != (NULL)) {
    rt_FREE(adcs_v15_integral_Power_dist_gblFrFInfo[0].tuDataMatrix);
  }

  if (adcs_v15_integral_Power_dist_gblFrFInfo[1].tuDataMatrix != (NULL)) {
    rt_FREE(adcs_v15_integral_Power_dist_gblFrFInfo[1].tuDataMatrix);
  }

  if (adcs_v15_integral_Power_dist_gblFrFInfo[2].tuDataMatrix != (NULL)) {
    rt_FREE(adcs_v15_integral_Power_dist_gblFrFInfo[2].tuDataMatrix);
  }

  if (adcs_v15_integral_Power_dist_gblFrFInfo[3].tuDataMatrix != (NULL)) {
    rt_FREE(adcs_v15_integral_Power_dist_gblFrFInfo[3].tuDataMatrix);
  }

  if (adcs_v15_integral_Power_dist_gblFrFInfo[4].tuDataMatrix != (NULL)) {
    rt_FREE(adcs_v15_integral_Power_dist_gblFrFInfo[4].tuDataMatrix);
  }

  if (adcs_v15_integral_Power_dist_gblFrFInfo[5].tuDataMatrix != (NULL)) {
    rt_FREE(adcs_v15_integral_Power_dist_gblFrFInfo[5].tuDataMatrix);
  }

  if (adcs_v15_integral_Power_dist_gblFrFInfo[6].tuDataMatrix != (NULL)) {
    rt_FREE(adcs_v15_integral_Power_dist_gblFrFInfo[6].tuDataMatrix);
  }
...
void MdlInitializeSizes(void)
{
  ...
  ssSetNumBlocks(rtS, 349);
  ssSetNumBlockIO(rtS, 181);
  ssSetNumBlockParams(rtS, 200);
}
...
{
  ssSetChecksumVal(rtS, 0, 3558220221U);
  ssSetChecksumVal(rtS, 1, 1999991981U);
  ssSetChecksumVal(rtS, 2, 2261420796U);
  ssSetChecksumVal(rtS, 3, 789110634U);
}
...
SimStruct * raccel_register_model(void)
{
  ...
  ssSetModelName(rtS, "adcs_v15_integral_Power_dist");
  ssSetPath(rtS, "adcs_v15_integral_Power_dist");
  ssSetTStart(rtS, 0.0);
  ...
  {
    {
      ...
      static const char_T *rt_LoggedStateBlockNames[] = {
        "adcs_v15_integral_Power_dist/Integrator",
        "adcs_v15_integral_Power_dist/PowerD0D/battery_DOD/Integrator",
        "adcs_v15_integral_Power_dist/PowerD0D/Integer Delay",
        "adcs_v15_integral_Power_dist/PowerD0D/Integer Delay3",
        "adcs_v15_integral_Power_dist/PowerD0D/Integer Delay2",
        "adcs_v15_integral_Power_dist/PowerD0D/Integer Delay1",
        "adcs_v15_integral_Power_dist/PowerD0D/Integer Delay4",
        "adcs_v15_integral_Power_dist/q -> w/Integer Delay1",
        "adcs_v15_integral_Power_dist/q -> w/Integer Delay",
        "adcs_v15_integral_Power_dist/q -> w/Subsystem6/Integer Delay",
        "adcs_v15_integral_Power_dist/Control Law/Integer Delay",
        "adcs_v15_integral_Power_dist/Control Law/Unit Delay1",
        "adcs_v15_integral_Power_dist/Control Law/Switching Algorithm/Unit Delay1",
        "adcs_v15_integral_Power_dist/Control Law/Switching Algorithm/Unit Delay"
      };
      ...
      rt_LoggedStateSignalPtrs[1] = (void*)&rtX.Integrator_CSTATE_n;
      ...
      rt_LoggedStateSignalPtrs[7] = (void*)&rtDWork.IntegerDelay1_X_k[0];
      rt_LoggedStateSignalPtrs[8] = (void*)&rtDWork.IntegerDelay_X_g[0];
      rt_LoggedStateSignalPtrs[9] = (void*)&rtDWork.IntegerDelay_X_l[0];
      rt_LoggedStateSignalPtrs[10] = (void*)&rtDWork.IntegerDelay_X_a[0];
  ...
  rtP.Saturation_UpperSat_k = rtInf;
  rtP.Saturation_UpperSat_h = rtInf;
  rtP.Saturation_UpperSat_c = rtInf;
  rtP.Saturation_UpperSat_ck = rtInf;
  return rtS;
}

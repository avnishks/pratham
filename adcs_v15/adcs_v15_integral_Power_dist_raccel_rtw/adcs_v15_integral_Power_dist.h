#ifndef RTW_HEADER_adcs_v15_integral_Power_dist_h_
#define RTW_HEADER_adcs_v15_integral_Power_dist_h_
#ifndef adcs_v15_integral_Power_dist_COMMON_INCLUDES_
# define adcs_v15_integral_Power_dist_COMMON_INCLUDES_
#include <stdio.h>
#include <stdlib.h>
#include <stddef.h>
#include <string.h>
...
#include "adcs_v15_integral_Power_dist_types.h"
#define MODEL_NAME                     adcs_v15_integral_Power_dist
...
typedef struct {
  ...
  real_T Constant_h[3];
  real_T Gain_g;
  real_T Constant_a0[3];
  real_T Gain_p;
  real_T Constant_mg[3];
  real_T Gain_o;
  ...
  real_T IntegerDelay_g[4];
  real_T IntegerDelay_i;
  real_T Product[3];
  real_T w_l[3];
  real_T w[3];
  real_T y;
...
typedef struct {
  ...
  real_T IntegerDelay1_X_k[3];
  real_T IntegerDelay_X_g[4];
  real_T IntegerDelay_X_l[300];
  real_T IntegerDelay_X_a[3];
  ...
  real_T NextOutput_n;
  real_T NextOutput_m;
  real_T NextOutput_n1;
  real_T NextOutput_ma;
  real_T NextOutput_d;
  ...
  uint8_T is_active_c7_adcs_v15_integral_Power_dist;
  uint8_T is_active_c27_adcs_v15_integral_Power_dist;
  uint8_T is_active_c6_adcs_v15_integral_Power_dist;
  uint8_T is_active_c1_adcs_v15_integral_Power_dist;
  uint8_T is_active_c4_adcs_v15_integral_Power_dist;
  uint8_T is_active_c22_adcs_v15_integral_Power_dist;
  uint8_T is_active_c12_adcs_v15_integral_Power_dist;
  uint8_T is_active_c25_adcs_v15_integral_Power_dist;
  uint8_T is_active_c11_adcs_v15_integral_Power_dist;
  uint8_T is_active_c30_adcs_v15_integral_Power_dist;
  uint8_T is_active_c28_adcs_v15_integral_Power_dist;
  uint8_T is_active_c26_adcs_v15_integral_Power_dist;
  uint8_T is_active_c31_adcs_v15_integral_Power_dist;
  uint8_T is_active_c19_adcs_v15_integral_Power_dist;
  uint8_T is_active_c5_adcs_v15_integral_Power_dist;
  uint8_T is_active_c8_adcs_v15_integral_Power_dist;
  uint8_T is_active_c9_adcs_v15_integral_Power_dist;
  uint8_T is_active_c20_adcs_v15_integral_Power_dist;
  uint8_T is_active_c16_adcs_v15_integral_Power_dist;
  uint8_T is_active_c29_adcs_v15_integral_Power_dist;
  uint8_T is_active_c2_adcs_v15_integral_Power_dist;
  uint8_T is_active_c10_adcs_v15_integral_Power_dist;
  uint8_T is_active_c24_adcs_v15_integral_Power_dist;
  uint8_T is_active_c13_adcs_v15_integral_Power_dist;
  uint8_T is_active_c23_adcs_v15_integral_Power_dist;
  boolean_T isStable;
  ...
  boolean_T isStable_hh;
  boolean_T doneDoubleBufferReInit_kp;
  boolean_T isStable_bw;
  boolean_T doneDoubleBufferReInit_hp;
  boolean_T isStable_nc;
  boolean_T doneDoubleBufferReInit_f;
  boolean_T isStable_ck;
  boolean_T doneDoubleBufferReInit_j;
  boolean_T isStable_o;
  boolean_T doneDoubleBufferReInit_p;
  boolean_T isStable_hr;
  boolean_T doneDoubleBufferReInit_o2;
  boolean_T isStable_ow;
  boolean_T doneDoubleBufferReInit_pg;
  boolean_T isStable_p;
  boolean_T doneDoubleBufferReInit_m;
  boolean_T isStable_n3;
  boolean_T doneDoubleBufferReInit_fx;
  boolean_T isStable_j;
  boolean_T doneDoubleBufferReInit_or;
  boolean_T isStable_p5;
  boolean_T doneDoubleBufferReInit_ea;
  boolean_T isStable_ci;
  boolean_T doneDoubleBufferReInit_b;
  boolean_T isStable_na;
  boolean_T doneDoubleBufferReInit_d;
  boolean_T isStable_cy;
  boolean_T doneDoubleBufferReInit_mo;
  boolean_T isStable_m;
  boolean_T doneDoubleBufferReInit_i;
  boolean_T isStable_je;
  boolean_T doneDoubleBufferReInit_n;
  boolean_T isStable_nf;
  boolean_T doneDoubleBufferReInit_kb;
  boolean_T isStable_cyj;
  boolean_T doneDoubleBufferReInit_pd;
  boolean_T isStable_ca;
...
struct Parameters_ {
  ...
  real_T Gain_Gain_k;
  real_T RandomNumber_Mean_lt;
  real_T RandomNumber_StdDev_c;
  real_T RandomNumber_Seed_b;
  ...
  real_T SineWave1_Amp;
  real_T SineWave1_Bias;
  real_T SineWave1_Freq;
  real_T SineWave1_Phase;
  real_T SineWave2_Amp;
  real_T SineWave2_Bias;
  real_T SineWave2_Freq;
  real_T SineWave2_Phase;
  real_T Constant_Value_km;
  real_T VectorfromCoMtoCoP_inBodyframeyettobefinalized2_Value[3];
  real_T PWM_Interval;
  real_T Gain2_Gain;
  real_T Constant_Value_eb[3];
  real_T Saturation_UpperSat_es;
  real_T Saturation_LowerSat_cn;
  real_T Gain1_Gain;
  real_T Gain_Gain_l;
  real_T Constant_Value_lz[3];
  ...
  real_T Saturation_UpperSat_hv;
  real_T Saturation_LowerSat_b;
  real_T Gain1_Gain_e;
  real_T Gain_Gain_lg;
  real_T Constant_Value_ebv[3];
  real_T Saturation_UpperSat_dg;
  real_T Saturation_LowerSat_k;
  real_T Gain1_Gain_o;
  real_T Gain_Gain_n;
  real_T Constant_Value_dm[3];
  real_T Saturation_UpperSat_du;
  real_T Saturation_LowerSat_d;
  real_T Gain1_Gain_j;
  real_T Gain_Gain_g;
  real_T Gain1_Gain_oy;
  ...
  real_T SFunction_p4_b;
  real_T SFunction_p2_j;
  real_T IntegerDelay1_InitialCondition_f[3];
  real_T IntegerDelay_InitialCondition_l;
  real_T IntegerDelay_InitialCondition_f;
};

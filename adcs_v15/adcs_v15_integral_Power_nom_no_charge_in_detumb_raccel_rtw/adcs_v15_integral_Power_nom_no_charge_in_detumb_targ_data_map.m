  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% rtP.RandomNumber_StdDev_a4
	  section.data(34).logicalSrcIdx = 33;
	  section.data(34).dtTransOffset = 45;
	
	  ;% rtP.RandomNumber_Seed_od
	  ...
	  ;% rtP.RandomNumber_StdDev_h
	  section.data(54).logicalSrcIdx = 53;
	  section.data(54).dtTransOffset = 69;
	
	  ;% rtP.RandomNumber_Seed_m
	  ...
	  ;% rtP.Constant_Value_ix
	  section.data(81).logicalSrcIdx = 80;
	  section.data(81).dtTransOffset = 104;
	
	  ;% rtP.Saturation_UpperSat_id
	  ...
	  ;% rtP.Saturation_UpperSat_kh
	  section.data(92).logicalSrcIdx = 91;
	  section.data(92).dtTransOffset = 121;
	
	  ;% rtP.Saturation_LowerSat_fk
	  ...
	  ;% rtP.Constant_Value_bn
	  section.data(101).logicalSrcIdx = 100;
	  section.data(101).dtTransOffset = 132;
	
	  ;% rtP.Saturation_UpperSat_aj
	  ...
	  ;% rtP.IntegerDelay_InitialCondition_k
	  ...
	  ;% rtP.IntegerDelay1_InitialCondition_j
	  section.data(139).logicalSrcIdx = 138;
	  section.data(139).dtTransOffset = 182;
	
	  ;% rtP.IntegerDelay_InitialCondition_n
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% rtDWork.FromFile_PWORK_m.PrevTimePtr
	  ...
	  ;% rtDWork.Scope2_PWORK_m.LoggedData
	  ...
	  ;% rtDWork.Scope3_PWORK_l.LoggedData
	  section.data(62).logicalSrcIdx = 82;
	  section.data(62).dtTransOffset = 61;
	
	  ;% rtDWork.Scope6_PWORK_a.LoggedData
	  section.data(63).logicalSrcIdx = 83;
	  section.data(63).dtTransOffset = 62;
	
	  ;% rtDWork.Scope_PWORK_l.LoggedData
	  section.data(64).logicalSrcIdx = 84;
	  section.data(64).dtTransOffset = 63;
	
	  ;% rtDWork.Scope1_PWORK_ei.LoggedData
	  section.data(65).logicalSrcIdx = 85;
	  section.data(65).dtTransOffset = 64;
	
	  ;% rtDWork.Scope2_PWORK_h.LoggedData
	  section.data(66).logicalSrcIdx = 86;
	  section.data(66).dtTransOffset = 65;
	
	  ;% rtDWork.FromFile_PWORK_a.PrevTimePtr
	  ...
	  ;% rtDWork.Scope_PWORK_k.LoggedData
	  section.data(70).logicalSrcIdx = 90;
	  section.data(70).dtTransOffset = 69;
	
	  ;% rtDWork.Scope1_PWORK_o.LoggedData
	  ...
	  ;% rtDWork.is_active_c7_adcs_v15_integral_Power_nom_no_charge_in_detumb
	  section.data(1).logicalSrcIdx = 105;
	  section.data(1).dtTransOffset = 0;
	
	  ;% rtDWork.is_active_c27_adcs_v15_integral_Power_nom_no_charge_in_detumb
	  section.data(2).logicalSrcIdx = 106;
	  section.data(2).dtTransOffset = 1;
	
	  ;% rtDWork.is_active_c6_adcs_v15_integral_Power_nom_no_charge_in_detumb
	  section.data(3).logicalSrcIdx = 107;
	  section.data(3).dtTransOffset = 2;
	
	  ;% rtDWork.is_active_c1_adcs_v15_integral_Power_nom_no_charge_in_detumb
	  section.data(4).logicalSrcIdx = 108;
	  section.data(4).dtTransOffset = 3;
	
	  ;% rtDWork.is_active_c4_adcs_v15_integral_Power_nom_no_charge_in_detumb
	  section.data(5).logicalSrcIdx = 109;
	  section.data(5).dtTransOffset = 4;
	
	  ;% rtDWork.is_active_c22_adcs_v15_integral_Power_nom_no_charge_in_detumb
	  section.data(6).logicalSrcIdx = 110;
	  section.data(6).dtTransOffset = 5;
	
	  ;% rtDWork.is_active_c12_adcs_v15_integral_Power_nom_no_charge_in_detumb
	  section.data(7).logicalSrcIdx = 111;
	  section.data(7).dtTransOffset = 6;
	
	  ;% rtDWork.is_active_c25_adcs_v15_integral_Power_nom_no_charge_in_detumb
	  section.data(8).logicalSrcIdx = 112;
	  section.data(8).dtTransOffset = 7;
	
	  ;% rtDWork.is_active_c11_adcs_v15_integral_Power_nom_no_charge_in_detumb
	  section.data(9).logicalSrcIdx = 113;
	  section.data(9).dtTransOffset = 8;
	
	  ;% rtDWork.is_active_c30_adcs_v15_integral_Power_nom_no_charge_in_detumb
	  section.data(10).logicalSrcIdx = 114;
	  section.data(10).dtTransOffset = 9;
	
	  ;% rtDWork.is_active_c28_adcs_v15_integral_Power_nom_no_charge_in_detumb
	  section.data(11).logicalSrcIdx = 115;
	  section.data(11).dtTransOffset = 10;
	
	  ;% rtDWork.is_active_c26_adcs_v15_integral_Power_nom_no_charge_in_detumb
	  section.data(12).logicalSrcIdx = 116;
	  section.data(12).dtTransOffset = 11;
	
	  ;% rtDWork.is_active_c31_adcs_v15_integral_Power_nom_no_charge_in_detumb
	  section.data(13).logicalSrcIdx = 117;
	  section.data(13).dtTransOffset = 12;
	
	  ;% rtDWork.is_active_c19_adcs_v15_integral_Power_nom_no_charge_in_detumb
	  section.data(14).logicalSrcIdx = 118;
	  section.data(14).dtTransOffset = 13;
	
	  ;% rtDWork.is_active_c5_adcs_v15_integral_Power_nom_no_charge_in_detumb
	  section.data(15).logicalSrcIdx = 119;
	  section.data(15).dtTransOffset = 14;
	
	  ;% rtDWork.is_active_c8_adcs_v15_integral_Power_nom_no_charge_in_detumb
	  section.data(16).logicalSrcIdx = 120;
	  section.data(16).dtTransOffset = 15;
	
	  ;% rtDWork.is_active_c9_adcs_v15_integral_Power_nom_no_charge_in_detumb
	  section.data(17).logicalSrcIdx = 121;
	  section.data(17).dtTransOffset = 16;
	
	  ;% rtDWork.is_active_c20_adcs_v15_integral_Power_nom_no_charge_in_detumb
	  section.data(18).logicalSrcIdx = 122;
	  section.data(18).dtTransOffset = 17;
	
	  ;% rtDWork.is_active_c16_adcs_v15_integral_Power_nom_no_charge_in_detumb
	  section.data(19).logicalSrcIdx = 123;
	  section.data(19).dtTransOffset = 18;
	
	  ;% rtDWork.is_active_c29_adcs_v15_integral_Power_nom_no_charge_in_detumb
	  section.data(20).logicalSrcIdx = 124;
	  section.data(20).dtTransOffset = 19;
	
	  ;% rtDWork.is_active_c2_adcs_v15_integral_Power_nom_no_charge_in_detumb
	  section.data(21).logicalSrcIdx = 125;
	  section.data(21).dtTransOffset = 20;
	
	  ;% rtDWork.is_active_c10_adcs_v15_integral_Power_nom_no_charge_in_detumb
	  section.data(22).logicalSrcIdx = 126;
	  section.data(22).dtTransOffset = 21;
	
	  ;% rtDWork.is_active_c24_adcs_v15_integral_Power_nom_no_charge_in_detumb
	  section.data(23).logicalSrcIdx = 127;
	  section.data(23).dtTransOffset = 22;
	
	  ;% rtDWork.is_active_c13_adcs_v15_integral_Power_nom_no_charge_in_detumb
	  section.data(24).logicalSrcIdx = 128;
	  section.data(24).dtTransOffset = 23;
	
	  ;% rtDWork.is_active_c23_adcs_v15_integral_Power_nom_no_charge_in_detumb
	  ...
	  ;% rtDWork.doneDoubleBufferReInit_cx
	  ...
	  ;% rtDWork.doneDoubleBufferReInit_c5
	  ...
	  ;% rtDWork.doneDoubleBufferReInit_lz
	  ...
	  ;% rtDWork.doneDoubleBufferReInit_hf
	  ...
	  ;% rtDWork.doneDoubleBufferReInit_ix
	  ...
	  ;% rtDWork.doneDoubleBufferReInit_eg
	  ...
	  ;% rtDWork.doneDoubleBufferReInit_nw
	  section.data(36).logicalSrcIdx = 165;
	  section.data(36).dtTransOffset = 35;
	
	  ;% rtDWork.isStable_cq
	  section.data(37).logicalSrcIdx = 166;
	  section.data(37).dtTransOffset = 36;
	
	  ;% rtDWork.doneDoubleBufferReInit_hx
	  section.data(38).logicalSrcIdx = 167;
	  section.data(38).dtTransOffset = 37;
	
	  ;% rtDWork.isStable_hi
	  section.data(39).logicalSrcIdx = 168;
	  section.data(39).dtTransOffset = 38;
	
	  ;% rtDWork.doneDoubleBufferReInit_ab
	  section.data(40).logicalSrcIdx = 169;
	  section.data(40).dtTransOffset = 39;
	
	  ;% rtDWork.isStable_i4
	  section.data(41).logicalSrcIdx = 170;
	  section.data(41).dtTransOffset = 40;
	
	  ;% rtDWork.doneDoubleBufferReInit_in
	  section.data(42).logicalSrcIdx = 171;
	  section.data(42).dtTransOffset = 41;
	
	  ;% rtDWork.isStable_go
	  section.data(43).logicalSrcIdx = 172;
	  section.data(43).dtTransOffset = 42;
	
	  ;% rtDWork.doneDoubleBufferReInit_im
	  section.data(44).logicalSrcIdx = 173;
	  section.data(44).dtTransOffset = 43;
	
	  ;% rtDWork.isStable_fj
	  section.data(45).logicalSrcIdx = 174;
	  section.data(45).dtTransOffset = 44;
	
	  ;% rtDWork.doneDoubleBufferReInit_p
	  section.data(46).logicalSrcIdx = 175;
	  section.data(46).dtTransOffset = 45;
	
	  ;% rtDWork.isStable_lw
	  section.data(47).logicalSrcIdx = 176;
	  section.data(47).dtTransOffset = 46;
	
	  ;% rtDWork.doneDoubleBufferReInit_g
	  section.data(48).logicalSrcIdx = 177;
	  section.data(48).dtTransOffset = 47;
	
	  ;% rtDWork.isStable_o
	  section.data(49).logicalSrcIdx = 178;
	  section.data(49).dtTransOffset = 48;
	
	  ;% rtDWork.doneDoubleBufferReInit_cr
	  section.data(50).logicalSrcIdx = 179;
	  section.data(50).dtTransOffset = 49;
  ...
  targMap.checksum0 = 489618712;
  targMap.checksum1 = 3211103825;
  targMap.checksum2 = 4166444227;
  targMap.checksum3 = 770552099;

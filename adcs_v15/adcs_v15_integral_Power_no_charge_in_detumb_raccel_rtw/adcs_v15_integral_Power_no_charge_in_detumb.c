...
#include "adcs_v15_integral_Power_no_charge_in_detumb_dt.h"
...
FrFInfo adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[7];

#include "simstruc.h"
#include "fixedpoint.h"

#define adcs_v15_integral_Power_no_charge_in_detumb_Snum (6.0)
#define adcs_v15_integral_Power_no_charge_in_detumb_s_MAGMETER_WEIGHT (0.9)

#define adcs_v15_integral_Power_no_charge_in_detumb_check_time (10000.0)
#define adcs_v15_integral_Power_no_charge_in_detumb_tol_q4 (0.85)
#define adcs_v15_integral_Power_no_charge_in_detumb_tol_w (0.004)
#define adcs_v15_integral_Power_no_charge_in_detumb_tolw_n2d (0.01)

#define adcs_v15_integral_Power_no_charge_in_detumb_s_FRAME_SIZE (2.0)
...
static real_T adcs_v15_integral_Power_no_charge_in_detumb_norm(const real_T
  eml_x[3]);
static real_T adcs_v15_integral_Power_no_charge_in_detumb_dot(const real_T
  eml_a[3], const real_T eml_b[3]);
static real_T adcs_v15_integral_Power_no_charge_in_detumb_norm_k(const real_T
  eml_x[3]);
static void
  adcs_v15_integral_Power_no_charge_in_detumb_c11_adcs_v15_integral_Power_no_charge_in_detumb
  (void);
static real_T adcs_v15_integral_Power_no_charge_in_detumb_dot_b(const real_T
  eml_a[3], const real_T eml_b[3]);
static real_T adcs_v15_integral_Power_no_charge_in_detumb_dot_l(const real_T
  eml_a[3], const real_T eml_b[3]);
static real_T adcs_v15_integral_Power_no_charge_in_detumb_dot_o(const real_T
  eml_a[3], const real_T eml_b[3]);
static real_T adcs_v15_integral_Power_no_charge_in_detumb_dot_g(const real_T
  eml_a[3], const real_T eml_b[3]);
static real_T adcs_v15_integral_Power_no_charge_in_detumb_norm_l(const real_T
  eml_x[3]);
static real_T adcs_v15_integral_Power_no_charge_in_detumb_norm_j(const real_T
  eml_x[3]);
static real_T adcs_v15_integral_Power_no_charge_in_detumb_isro_battery(real_T
  eml_x, real_T eml_current, real_T eml_internal_resistance);
  ...
  (void)
{
  ...
  memcpy((void *)&eml_m_SUN[0], (void *)&rtB.TmpRTBAtQuESTInport2[0], 30U *
         sizeof(real_T));
  eml_b_0 = muDoubleScalarCos(rtP.SFunction_p4_h * 3.1415926535897931E+000 /
    180.0);
  ...
  for (eml_i = 1; eml_i <= (int32_T)
       adcs_v15_integral_Power_no_charge_in_detumb_Snum; eml_i++) {
    if (eml_values[eml_i - 1] < 2.5) {
      eml_b_0++;
    }
  }

  if (eml_b_0 == adcs_v15_integral_Power_no_charge_in_detumb_Snum) {
    eml_i = 0;
  } else {
    eml_i = 1;
  }
  ...
  if (eml_i == 1) {
    ...
    while (1) {
      ...
      if (!(adcs_v15_integral_Power_no_charge_in_detumb_norm(eml_m_SUN_2) == 0.0))
      {
        break;
      }
      ...
      eml_i = (int32_T)eml_idx[(int32_T)
        (adcs_v15_integral_Power_no_charge_in_detumb_Snum - eml_b_0) - 1];
    }
    ...
    while (1) {
      ...
      if (!((adcs_v15_integral_Power_no_charge_in_detumb_norm(eml_m_SUN_0) ==
             0.0) || (adcs_v15_integral_Power_no_charge_in_detumb_norm
                      (eml_m_SUN_1) == 0.0))) {
        break;
      }
    ...
    eml_b_0 = muDoubleScalarSqrt(adcs_v15_integral_Power_no_charge_in_detumb_dot
                                 (&rtB.v_Sun1[0], &rtB.v_Sun1[0]));
    ...
    eml_b_0 = adcs_v15_integral_Power_no_charge_in_detumb_norm_k(eml_b);
    eml_b[0] /= eml_b_0;
    eml_b[1] /= eml_b_0;
    eml_b[2] /= eml_b_0;
    eml_r[0] = rtB.v_O_b[1] * rtB.v_O[2] - rtB.v_O_b[2] * rtB.v_O[1];
    eml_r[1] = rtB.v_O_b[2] * rtB.v_O[0] - rtB.v_O_b[0] * rtB.v_O[2];
    eml_r[2] = rtB.v_O_b[0] * rtB.v_O[1] - rtB.v_O_b[1] * rtB.v_O[0];
    eml_b_0 = adcs_v15_integral_Power_no_charge_in_detumb_norm_k(eml_r);
    eml_r[0] /= eml_b_0;
    eml_r[1] /= eml_b_0;
    eml_r[2] /= eml_b_0;
    ...
    tmp_0[0] = (rtB.TmpRTBAtQuESTInport1[1] * rtB.v_O_b[2] -
                rtB.TmpRTBAtQuESTInport1[2] * rtB.v_O_b[1]) *
      adcs_v15_integral_Power_no_charge_in_detumb_s_MAGMETER_WEIGHT +
      (eml_ssvalues[1] * rtB.v_O[2] - eml_ssvalues[2] * rtB.v_O[1]) *
      9.9999999999999978E-002;
    eml_b_1[0] = eml_b[0] + eml_r[0];
    tmp_0[1] = (rtB.TmpRTBAtQuESTInport1[2] * rtB.v_O_b[0] -
                rtB.TmpRTBAtQuESTInport1[0] * rtB.v_O_b[2]) *
      adcs_v15_integral_Power_no_charge_in_detumb_s_MAGMETER_WEIGHT +
      (eml_ssvalues[2] * rtB.v_O[0] - eml_ssvalues[0] * rtB.v_O[2]) *
      9.9999999999999978E-002;
    eml_b_1[1] = eml_b[1] + eml_r[1];
    tmp_0[2] = (rtB.TmpRTBAtQuESTInport1[0] * rtB.v_O_b[1] -
                rtB.TmpRTBAtQuESTInport1[1] * rtB.v_O_b[0]) *
      adcs_v15_integral_Power_no_charge_in_detumb_s_MAGMETER_WEIGHT +
      (eml_ssvalues[0] * rtB.v_O[1] - eml_ssvalues[1] * rtB.v_O[0]) *
      9.9999999999999978E-002;
    eml_b_1[2] = eml_b[2] + eml_r[2];
    eml_b_0 = (0.9 * adcs_v15_integral_Power_no_charge_in_detumb_dot
               (&rtB.TmpRTBAtQuESTInport1[0], &rtB.v_O_b[0]) +
               9.9999999999999978E-002 *
               adcs_v15_integral_Power_no_charge_in_detumb_dot(eml_ssvalues,
                &rtB.v_O[0])) * (1.0 +
      adcs_v15_integral_Power_no_charge_in_detumb_dot(eml_b, eml_r)) +
      adcs_v15_integral_Power_no_charge_in_detumb_dot(eml_b_2, tmp_0);
    tmp[0] = (rtB.TmpRTBAtQuESTInport1[1] * rtB.v_O_b[2] -
              rtB.TmpRTBAtQuESTInport1[2] * rtB.v_O_b[1]) *
      adcs_v15_integral_Power_no_charge_in_detumb_s_MAGMETER_WEIGHT +
      (eml_ssvalues[1] * rtB.v_O[2] - eml_ssvalues[2] * rtB.v_O[1]) *
      9.9999999999999978E-002;
    tmp[1] = (rtB.TmpRTBAtQuESTInport1[2] * rtB.v_O_b[0] -
              rtB.TmpRTBAtQuESTInport1[0] * rtB.v_O_b[2]) *
      adcs_v15_integral_Power_no_charge_in_detumb_s_MAGMETER_WEIGHT +
      (eml_ssvalues[2] * rtB.v_O[0] - eml_ssvalues[0] * rtB.v_O[2]) *
      9.9999999999999978E-002;
    tmp[2] = (rtB.TmpRTBAtQuESTInport1[0] * rtB.v_O_b[1] -
              rtB.TmpRTBAtQuESTInport1[1] * rtB.v_O_b[0]) *
      adcs_v15_integral_Power_no_charge_in_detumb_s_MAGMETER_WEIGHT +
      (eml_ssvalues[0] * rtB.v_O[1] - eml_ssvalues[1] * rtB.v_O[0]) *
      9.9999999999999978E-002;
    eml_nu = adcs_v15_integral_Power_no_charge_in_detumb_dot(eml_b_1, tmp);
    eml_maxval = muDoubleScalarSqrt(eml_b_0 * eml_b_0 + eml_nu * eml_nu);
    if (eml_b_0 > 0.0) {
      eml_k_q_triad = 1.0 / (muDoubleScalarSqrt((eml_maxval + eml_b_0) *
        eml_maxval * (1.0 + adcs_v15_integral_Power_no_charge_in_detumb_dot
                      (eml_b, eml_r))) * 2.0);
      ...
      rtB.q_BO_est[3] = (1.0 + adcs_v15_integral_Power_no_charge_in_detumb_dot
...
void adcs_v15_integral_Power_no_charge_in_detumb_QuEST_Init(void)
{
  rtDWork.is_active_c11_adcs_v15_integral_Power_no_charge_in_detumb = 0U;
}

void adcs_v15_integral_Power_no_charge_in_detumb_QuEST(void)
{
  adcs_v15_integral_Power_no_charge_in_detumb_c11_adcs_v15_integral_Power_no_charge_in_detumb
    ();
}
...
{
  {
    ...
    rtDWork.is_active_c7_adcs_v15_integral_Power_no_charge_in_detumb = 0U;
    rtDWork.is_active_c29_adcs_v15_integral_Power_no_charge_in_detumb = 0U;
    rtDWork.is_active_c5_adcs_v15_integral_Power_no_charge_in_detumb = 0U;
    rtDWork.is_active_c4_adcs_v15_integral_Power_no_charge_in_detumb = 0U;
    rtDWork.is_active_c22_adcs_v15_integral_Power_no_charge_in_detumb = 0U;
    rtDWork.is_active_c25_adcs_v15_integral_Power_no_charge_in_detumb = 0U;
    rtDWork.is_active_c12_adcs_v15_integral_Power_no_charge_in_detumb = 0U;
    adcs_v15_integral_Power_no_charge_in_detumb_QuEST_Init();
    rtDWork.IntegerDelay1_X_f[0] = rtP.IntegerDelay1_InitialCondition_c[0];
    rtDWork.IntegerDelay1_X_f[1] = rtP.IntegerDelay1_InitialCondition_c[1];
    rtDWork.IntegerDelay1_X_f[2] = rtP.IntegerDelay1_InitialCondition_c[2];
    rtDWork.IntegerDelay_X_k[0] = rtP.IntegerDelay_InitialCondition_c;
    rtDWork.IntegerDelay_X_k[1] = rtP.IntegerDelay_InitialCondition_c;
    rtDWork.IntegerDelay_X_k[2] = rtP.IntegerDelay_InitialCondition_c;
    rtDWork.IntegerDelay_X_k[3] = rtP.IntegerDelay_InitialCondition_c;
    rtDWork.is_active_c27_adcs_v15_integral_Power_no_charge_in_detumb = 0U;
    for (i = 0; i < 300; i++) {
      rtDWork.IntegerDelay_X_p[i] = rtP.IntegerDelay_InitialCondition_l;
    }

    rtDWork.is_active_c6_adcs_v15_integral_Power_no_charge_in_detumb = 0U;
    rtDWork.is_active_c10_adcs_v15_integral_Power_no_charge_in_detumb = 0U;
    rtDWork.is_active_c23_adcs_v15_integral_Power_no_charge_in_detumb = 0U;
    rtDWork.is_active_c13_adcs_v15_integral_Power_no_charge_in_detumb = 0U;
    rtDWork.UnitDelay1_DSTATE_m = rtP.UnitDelay1_X0_e;
    rtDWork.UnitDelay_DSTATE = rtP.UnitDelay_X0;
    rtDWork.is_active_c24_adcs_v15_integral_Power_no_charge_in_detumb = 0U;
    rtDWork.is_active_c1_adcs_v15_integral_Power_no_charge_in_detumb = 0U;
    rtDWork.IntegerDelay_X_o[0] = rtP.IntegerDelay_InitialCondition_j;
    rtDWork.UnitDelay1_DSTATE[0] = rtP.UnitDelay1_X0[0];
    rtDWork.TmpRTBAtProductInport2_Buffer0[0] = rtP.TmpRTBAtProductInport2_X0;
    rtDWork.IntegerDelay_X_o[1] = rtP.IntegerDelay_InitialCondition_j;
    rtDWork.UnitDelay1_DSTATE[1] = rtP.UnitDelay1_X0[1];
    rtDWork.TmpRTBAtProductInport2_Buffer0[1] = rtP.TmpRTBAtProductInport2_X0;
    rtDWork.IntegerDelay_X_o[2] = rtP.IntegerDelay_InitialCondition_j;
    rtDWork.UnitDelay1_DSTATE[2] = rtP.UnitDelay1_X0[2];
    rtDWork.TmpRTBAtProductInport2_Buffer0[2] = rtP.TmpRTBAtProductInport2_X0;
    rtDWork.is_active_c9_adcs_v15_integral_Power_no_charge_in_detumb = 0U;
    rtDWork.is_active_c20_adcs_v15_integral_Power_no_charge_in_detumb = 0U;
    rtDWork.is_active_c16_adcs_v15_integral_Power_no_charge_in_detumb = 0U;
    rtDWork.is_active_c8_adcs_v15_integral_Power_no_charge_in_detumb = 0U;
    rtDWork.is_active_c2_adcs_v15_integral_Power_no_charge_in_detumb = 0U;
    rtDWork.TmpRTBAtProductInport2_Buffer0_p = rtP.TmpRTBAtProductInport2_X0_p;
    ...
    rtDWork.TmpRTBAtProduct1Inport1_Buffer0 = rtP.TmpRTBAtProduct1Inport1_X0;
    rtDWork.is_active_c30_adcs_v15_integral_Power_no_charge_in_detumb = 0U;
    rtDWork.is_active_c28_adcs_v15_integral_Power_no_charge_in_detumb = 0U;
    rtDWork.is_active_c19_adcs_v15_integral_Power_no_charge_in_detumb = 0U;
    rtDWork.is_active_c31_adcs_v15_integral_Power_no_charge_in_detumb = 0U;
    ...
    rtDWork.is_active_c26_adcs_v15_integral_Power_no_charge_in_detumb = 0U;
    rtX.Integrator_CSTATE_c = rtP.Integrator_IC_a;
  }
}
...
{
  {
...

    {
      ...
      if ((result=rt_ReadFromfileMatFile("SGP_120k.mat",7,
            &adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[0])) !=
          (NULL)) {
      ...
      rtDWork.FromFile_PWORK.PrevTimePtr = (void *)
        adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[0].tuDataMatrix;
    }
...

    {
      ...
      if ((result=rt_ReadFromfileMatFile("Bi_120k.mat",4,
            &adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[1])) !=
          (NULL)) {
        ssSetErrorStatus(rtS, result);
        return;
      }
      ...
      rtDWork.FromFile1_PWORK.PrevTimePtr = (void *)
        adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[1].tuDataMatrix;
    }
...

    {
      ...
      if ((result=rt_ReadFromfileMatFile("Si_120k.mat",4,
            &adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[2])) !=
          (NULL)) {
        ssSetErrorStatus(rtS, result);
        return;
      }

      rtDWork.FromFile_PWORK_h.PrevTimePtr = (void *)
        adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[2].tuDataMatrix;
    }

    {
      const char *result;
      if ((result=rt_ReadFromfileMatFile("light_120k.mat",2,
            &adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[3])) !=
          (NULL)) {
        ssSetErrorStatus(rtS, result);
        return;
      }
      ...
      rtDWork.FromFile2_PWORK.PrevTimePtr = (void *)
        adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[3].tuDataMatrix;
    }
    ...
    rtDWork.RandSeed_k = tseed;
    rtDWork.NextOutput_i = rt_NormalRand(&rtDWork.RandSeed_k) *
      rtP.RandomNumber_StdDev_f + rtP.RandomNumber_Mean_e;
    rtB.Constant_pv[0] = rtP.Constant_Value_g[0];
    rtB.Constant_pv[1] = rtP.Constant_Value_g[1];
    rtB.Constant_pv[2] = rtP.Constant_Value_g[2];
    ...
    rtDWork.RandSeed_kh = tseed;
    rtDWork.NextOutput_j = rt_NormalRand(&rtDWork.RandSeed_kh) *
      rtP.RandomNumber_StdDev_p + rtP.RandomNumber_Mean_o;
    rtB.Constant_b[0] = rtP.Constant_Value_m[0];
    rtB.Constant_b[1] = rtP.Constant_Value_m[1];
    rtB.Constant_b[2] = rtP.Constant_Value_m[2];
    ...
    rtDWork.NextOutput_b = rt_NormalRand(&rtDWork.RandSeed_e) *
      rtP.RandomNumber_StdDev_ff + rtP.RandomNumber_Mean_om;
    rtB.Constant_h[0] = rtP.Constant_Value_h[0];
    rtB.Constant_h[1] = rtP.Constant_Value_h[1];
    rtB.Constant_h[2] = rtP.Constant_Value_h[2];
    if (rtIsNaN(rtP.RandomNumber_Seed_n) || rtIsInf(rtP.RandomNumber_Seed_n)) {
      tmp = 0.0;
    } else {
      tmp = muDoubleScalarRem(muDoubleScalarFloor(rtP.RandomNumber_Seed_n),
        4.294967296E+009);
    }
    ...
    rtDWork.NextOutput_c = rt_NormalRand(&rtDWork.RandSeed_b) *
      rtP.RandomNumber_StdDev_j + rtP.RandomNumber_Mean_i;
    rtB.Constant_l[0] = rtP.Constant_Value_k[0];
    rtB.Constant_l[1] = rtP.Constant_Value_k[1];
    rtB.Constant_l[2] = rtP.Constant_Value_k[2];
    if (rtIsNaN(rtP.RandomNumber_Seed_p) || rtIsInf(rtP.RandomNumber_Seed_p)) {
      tmp = 0.0;
    } else {
      tmp = muDoubleScalarRem(muDoubleScalarFloor(rtP.RandomNumber_Seed_p),
        4.294967296E+009);
    }
    ...
    rtDWork.NextOutput_h = rt_NormalRand(&rtDWork.RandSeed_a) *
      rtP.RandomNumber_StdDev_jw + rtP.RandomNumber_Mean_c;
    rtB.Constant_e[0] = rtP.Constant_Value_c[0];
    rtB.Constant_e[1] = rtP.Constant_Value_c[1];
    rtB.Constant_e[2] = rtP.Constant_Value_c[2];
    if (rtIsNaN(rtP.RandomNumber_Seed_ne) || rtIsInf(rtP.RandomNumber_Seed_ne))
    {
      tmp = 0.0;
    } else {
      tmp = muDoubleScalarRem(muDoubleScalarFloor(rtP.RandomNumber_Seed_ne),
        4.294967296E+009);
    }
    ...
    rtDWork.RandSeed_m = tseed;
    rtDWork.NextOutput_d = rt_NormalRand(&rtDWork.RandSeed_m) *
      rtP.RandomNumber_StdDev_i + rtP.RandomNumber_Mean_g;

    {
      const char *result;
      if ((result=rt_ReadFromfileMatFile("Si_120k.mat",4,
            &adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[4])) !=
          (NULL)) {
        ssSetErrorStatus(rtS, result);
        return;
      }

      rtDWork.FromFile_PWORK_o.PrevTimePtr = (void *)
        adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[4].tuDataMatrix;
    }

    {
      const char *result;
      if ((result=rt_ReadFromfileMatFile("SGP_est_120k.mat",7,
            &adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[5])) !=
          (NULL)) {
        ssSetErrorStatus(rtS, result);
        return;
      }

      rtDWork.FromFile2_PWORK_b.PrevTimePtr = (void *)
        adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[5].tuDataMatrix;
    }

    {
      const char *result;
      if ((result=rt_ReadFromfileMatFile("Bi8_est_120k.mat",4,
            &adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[6])) !=
          (NULL)) {
        ssSetErrorStatus(rtS, result);
        return;
      }
      ...
      rtDWork.FromFile3_PWORK.PrevTimePtr = (void *)
        adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[6].tuDataMatrix;
    }
    ...
    rtB.Constant_j = rtP.Constant_Value_i;
    ...
    rtB.TmpRTBAtProductInport2_l = rtP.TmpRTBAtProductInport2_X0_p;
    rtB.TmpRTBAtAddingPowerConsumedInport3 =
      rtP.TmpRTBAtAddingPowerConsumedInport3_X0;
    rtB.TmpRTBAtProduct1Inport1 = rtP.TmpRTBAtProduct1Inport1_X0;
...

    {
      ...
      rtDWork.ToWorkspace1_PWORK_c.LoggedData = rt_CreateLogVar(
        ssGetRTWLogInfo(rtS),
        ssGetTFinal(rtS),
        0.0,
        (&ssGetErrorStatus(rtS)),
        ...
        0.1,
        1);
      if (rtDWork.ToWorkspace1_PWORK_c.LoggedData == (NULL))
        return;
    }

    {
      ...
      rtDWork.ToWorkspace2_PWORK_j.LoggedData = rt_CreateLogVar(
        ssGetRTWLogInfo(rtS),
        ssGetTFinal(rtS),
        0.0,
        (&ssGetErrorStatus(rtS)),
        ...
        0.1,
        1);
      if (rtDWork.ToWorkspace2_PWORK_j.LoggedData == (NULL))
        return;
    }

    {
      ...
      rtDWork.ToWorkspace3_PWORK_m.LoggedData = rt_CreateLogVar(
        ssGetRTWLogInfo(rtS),
        ssGetTFinal(rtS),
        0.0,
        (&ssGetErrorStatus(rtS)),
        ...
        0.1,
        1);
      if (rtDWork.ToWorkspace3_PWORK_m.LoggedData == (NULL))
        return;
    }

    {
      ...
      rtDWork.ToWorkspace4_PWORK_a.LoggedData = rt_CreateLogVar(
        ssGetRTWLogInfo(rtS),
        ssGetTFinal(rtS),
        0.0,
        (&ssGetErrorStatus(rtS)),
        ...
        0.1,
        1);
      if (rtDWork.ToWorkspace4_PWORK_a.LoggedData == (NULL))
        return;
    }

    {
      ...
      rtDWork.ToWorkspace5_PWORK_i.LoggedData = rt_CreateLogVar(
        ssGetRTWLogInfo(rtS),
        ssGetTFinal(rtS),
        0.0,
        (&ssGetErrorStatus(rtS)),
        ...
        0.1,
        1);
      if (rtDWork.ToWorkspace5_PWORK_i.LoggedData == (NULL))
        return;
    }
  }
...

  {
    ...
    if (ssIsContinuousTask(rtS, tid)) {
...

      {
        ...
        if (adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[0].
            nptsPerSignal == 1) {
          {
            int_T i1;
          ...
          pU = pStart + adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[0]
            .nptsPerSignal - 2;
          if (time <= pStart[0]) {
            pT = pStart;
          } else if (time >= pU[0]) {
          ...
          pU = pT + adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[0].
            nptsPerSignal;
          if (pT[0] == pT[1]) {
            {
              int_T i1;
              ...
              for (i1=0; i1 < 6; i1++) {
                ...
                pU += adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[0].
                  nptsPerSignal;
              }
            }
          } else {
      ...
      eml_B = muDoubleScalarSqrt
        (adcs_v15_integral_Power_no_charge_in_detumb_dot_b(eml_oy, eml_oy));
      eml_oy[0] /= eml_B;
      eml_oy[1] /= eml_B;
      eml_oy[2] /= eml_B;
      eml_B = muDoubleScalarSqrt
        (adcs_v15_integral_Power_no_charge_in_detumb_dot_b(eml_r, eml_r));
      ...
      eml_B = muDoubleScalarSqrt
        (adcs_v15_integral_Power_no_charge_in_detumb_dot_b(eml_v, eml_v));
      ...
      rtB.modw = muDoubleScalarSqrt
        (adcs_v15_integral_Power_no_charge_in_detumb_dot_b(&rtB.w_BOB[0],
          &rtB.w_BOB[0]));
    ...
    if (ssIsContinuousTask(rtS, tid)) {
      {
        ...
        if (adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[1].
            nptsPerSignal == 1) {
          rtb_Product_a[0] = pT[1];
          rtb_Product_a[1] = pT[2];
          rtb_Product_a[2] = pT[3];
        } else {
          pU = pStart + adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[1]
            .nptsPerSignal - 2;
          if (time <= pStart[0]) {
            pT = pStart;
          } else if (time >= pU[0]) {
          ...
          pU = pT + adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[1].
            nptsPerSignal;
          if (pT[0] == pT[1]) {
            rtb_Product_a[0] = pU[ (time < pT[0]) ? 0 : 1 ];
            pU += adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[1].
              nptsPerSignal;
            rtb_Product_a[1] = pU[ (time < pT[0]) ? 0 : 1 ];
            pU += adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[1].
              nptsPerSignal;
            rtb_Product_a[2] = pU[ (time < pT[0]) ? 0 : 1 ];
          } else {
            real_T f = (pT[1]-time)/(pT[1]-pT[0]);
            if (pU[0] == pU[1]) {
              rtb_Product_a[0] = pU[0];
            } else {
              rtb_Product_a[0] = f*pU[0]+(1.0-f)*pU[1];
            }

            pU += adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[1].
              nptsPerSignal;
            if (pU[0] == pU[1]) {
              rtb_Product_a[1] = pU[0];
            } else {
              rtb_Product_a[1] = f*pU[0]+(1.0-f)*pU[1];
            }

            pU += adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[1].
              nptsPerSignal;
            if (pU[0] == pU[1]) {
              rtb_Product_a[2] = pU[0];
            } else {
              rtb_Product_a[2] = f*pU[0]+(1.0-f)*pU[1];
            }
          }
        }
      }

      rtB.Gain[0] = rtP.Gain_Gain * rtb_Product_a[0];
      rtB.Gain[1] = rtP.Gain_Gain * rtb_Product_a[1];
      rtB.Gain[2] = rtP.Gain_Gain * rtb_Product_a[2];
      ...
      for (i = 0; i < 3; i++) {
        rtB.v_B_o[i] = 0.0;
        rtB.v_B_o[i] = eml_v_0[i] * rtB.Gain[0] + rtB.v_B_o[i];
        rtB.v_B_o[i] = eml_v_0[i + 3] * rtB.Gain[1] + rtB.v_B_o[i];
        rtB.v_B_o[i] = eml_v_0[i + 6] * rtB.Gain[2] + rtB.v_B_o[i];
      }
    }

    if (ssIsSampleHit(rtS, 1, tid)) {
      rtB.Constant = rtP.Constant_Value_d;
    }

    if (ssIsContinuousTask(rtS, tid)) {
      rtB.Sum1[0] = (rtB.Buffer + rtB.v_B_o[0]) + rtB.Constant;
      rtB.Sum1[1] = (rtB.Buffer + rtB.v_B_o[1]) + rtB.Constant;
      rtB.Sum1[2] = (rtB.Buffer + rtB.v_B_o[2]) + rtB.Constant;
    ...
    if (ssIsContinuousTask(rtS, tid)) {
      {
        ...
        real_T time = ssGetTaskTime(rtS,tid);
        const real_T *pU = (NULL);
        const real_T *pT = (const real_T *) rtDWork.FromFile_PWORK_h.PrevTimePtr;
        if (initBasePtr == TRUE) {
          pStart = (real_T *) rtDWork.FromFile_PWORK_h.PrevTimePtr;
          initBasePtr = FALSE;
        }

        if (adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[2].
            nptsPerSignal == 1) {
          rtB.FromFile_p[0] = pT[1];
          rtB.FromFile_p[1] = pT[2];
          rtB.FromFile_p[2] = pT[3];
        } else {
          pU = pStart + adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[2]
            .nptsPerSignal - 2;
          if (time <= pStart[0]) {
            pT = pStart;
          } else if (time >= pU[0]) {
          ...
          rtDWork.FromFile_PWORK_h.PrevTimePtr = (void *) pT;
          pU = pT + adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[2].
            nptsPerSignal;
          if (pT[0] == pT[1]) {
            rtB.FromFile_p[0] = pU[ (time < pT[0]) ? 0 : 1 ];
            pU += adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[2].
              nptsPerSignal;
            rtB.FromFile_p[1] = pU[ (time < pT[0]) ? 0 : 1 ];
            pU += adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[2].
              nptsPerSignal;
            rtB.FromFile_p[2] = pU[ (time < pT[0]) ? 0 : 1 ];
          } else {
            real_T f = (pT[1]-time)/(pT[1]-pT[0]);
            if (pU[0] == pU[1]) {
              rtB.FromFile_p[0] = pU[0];
            } else {
              rtB.FromFile_p[0] = f*pU[0]+(1.0-f)*pU[1];
            }

            pU += adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[2].
              nptsPerSignal;
            if (pU[0] == pU[1]) {
              rtB.FromFile_p[1] = pU[0];
            } else {
              rtB.FromFile_p[1] = f*pU[0]+(1.0-f)*pU[1];
            }

            pU += adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[2].
              nptsPerSignal;
            if (pU[0] == pU[1]) {
              rtB.FromFile_p[2] = pU[0];
            } else {
              rtB.FromFile_p[2] = f*pU[0]+(1.0-f)*pU[1];
            }
          }
        }
      }
      ...
      for (i = 0; i < 3; i++) {
        rtB.v_B[i] = 0.0;
        rtB.v_B[i] = eml_v_0[i] * rtB.FromFile_p[0] + rtB.v_B[i];
        rtB.v_B[i] = eml_v_0[i + 3] * rtB.FromFile_p[1] + rtB.v_B[i];
        rtB.v_B[i] = eml_v_0[i + 6] * rtB.FromFile_p[2] + rtB.v_B[i];
      }
...

      {
        ...
        if (adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[3].
            nptsPerSignal == 1) {
          rtB.FromFile2 = pT[1];
        } else {
          pU = pStart + adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[3]
            .nptsPerSignal - 2;
          if (time <= pStart[0]) {
            pT = pStart;
          } else if (time >= pU[0]) {
          ...
          pU = pT + adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[3].
            nptsPerSignal;
          if (pT[0] == pT[1]) {
    ...
    if (ssIsSampleHit(rtS, 1, tid)) {
      rtB.Sum_k = rtP.MatrixGain_Gain_a * rtDWork.NextOutput_i +
        rtP.Constant_Value_b;

      {
        rtB.Buffer_j = rtB.Sum_k;
      }
    }

    if (ssIsContinuousTask(rtS, tid)) {
      rtb_jxi = rtb_Gain + rtB.Buffer_j;
    ...
    if (ssIsContinuousTask(rtS, tid)) {
      rtb_jxi = (rtB.Constant_pv[0] * rtB.v_B[0] + rtB.Constant_pv[1] * rtB.v_B
                 [1]) + rtB.Constant_pv[2] * rtB.v_B[2];
      rtb_jxi *= rtB.FromFile2;
      rtb_Gain_i = rtP.Gain_Gain_c * rt_SATURATE(rtb_jxi,
        rtP.Saturation_LowerSat_k, rtP.Saturation_UpperSat_l);
    }

    if (ssIsSampleHit(rtS, 1, tid)) {
      rtB.Sum_a = rtP.MatrixGain_Gain_o * rtDWork.NextOutput_j +
        rtP.Constant_Value_js;

      {
        rtB.Buffer_f = rtB.Sum_a;
      }
    }

    if (ssIsContinuousTask(rtS, tid)) {
      rtb_jxi = rtb_Gain_i + rtB.Buffer_f;
      rtB.ADC_p = rtP.ADC_Interval_k * muDoubleScalarRound((rtb_jxi/
        (rtP.ADC_Interval_k)));
    }
    ...
    if (ssIsContinuousTask(rtS, tid)) {
      rtb_jxi = (rtB.Constant_b[0] * rtB.v_B[0] + rtB.Constant_b[1] * rtB.v_B[1])
        + rtB.Constant_b[2] * rtB.v_B[2];
      rtb_jxi *= rtB.FromFile2;
      rtb_Gain_d = rtP.Gain_Gain_ce * rt_SATURATE(rtb_jxi,
        rtP.Saturation_LowerSat_i, rtP.Saturation_UpperSat_lo);
    }

    if (ssIsSampleHit(rtS, 1, tid)) {
      rtB.Sum_h = rtP.MatrixGain_Gain_p * rtDWork.NextOutput_b +
    ...
    if (ssIsContinuousTask(rtS, tid)) {
      rtb_jxi = rtb_Gain_d + rtB.Buffer_o;
      rtB.ADC_pc = rtP.ADC_Interval_a * muDoubleScalarRound((rtb_jxi/
        (rtP.ADC_Interval_a)));
    }
    ...
    if (ssIsContinuousTask(rtS, tid)) {
      rtb_jxi = (rtB.Constant_h[0] * rtB.v_B[0] + rtB.Constant_h[1] * rtB.v_B[1])
        + rtB.Constant_h[2] * rtB.v_B[2];
      rtb_jxi *= rtB.FromFile2;
      rtb_Gain_c = rtP.Gain_Gain_n * rt_SATURATE(rtb_jxi,
        rtP.Saturation_LowerSat_d, rtP.Saturation_UpperSat_g);
    }

    if (ssIsSampleHit(rtS, 1, tid)) {
      rtB.Sum_o = rtP.MatrixGain_Gain_m * rtDWork.NextOutput_c +
        rtP.Constant_Value_n;

      {
        rtB.Buffer_g = rtB.Sum_o;
      }
    }

    if (ssIsContinuousTask(rtS, tid)) {
      rtb_jxi = rtb_Gain_c + rtB.Buffer_g;
      rtB.ADC_i = rtP.ADC_Interval_i * muDoubleScalarRound((rtb_jxi/
        (rtP.ADC_Interval_i)));
    }
    ...
    if (ssIsContinuousTask(rtS, tid)) {
      ...
      rtb_jxi *= rtB.FromFile2;
      rtb_Gain_n = rtP.Gain_Gain_d * rt_SATURATE(rtb_jxi,
        rtP.Saturation_LowerSat_n, rtP.Saturation_UpperSat_j);
    }

    if (ssIsSampleHit(rtS, 1, tid)) {
      rtB.Sum_n = rtP.MatrixGain_Gain_ox * rtDWork.NextOutput_h +
        rtP.Constant_Value_e;

      {
        rtB.Buffer_fu = rtB.Sum_n;
      }
    }

    if (ssIsContinuousTask(rtS, tid)) {
      rtb_jxi = rtb_Gain_n + rtB.Buffer_fu;
      rtB.ADC_l = rtP.ADC_Interval_ip * muDoubleScalarRound((rtb_jxi/
        (rtP.ADC_Interval_ip)));
    }
    ...
    if (ssIsContinuousTask(rtS, tid)) {
      ...
      rtb_jxi *= rtB.FromFile2;
      rtb_Gain_dg = rtP.Gain_Gain_a * rt_SATURATE(rtb_jxi,
        rtP.Saturation_LowerSat_g, rtP.Saturation_UpperSat_e);
    }

    if (ssIsSampleHit(rtS, 1, tid)) {
      rtB.Sum_g = rtP.MatrixGain_Gain_ma * rtDWork.NextOutput_d +
        rtP.Constant_Value_md;

      {
        rtB.Buffer_p = rtB.Sum_g;
      }
    }

    if (ssIsContinuousTask(rtS, tid)) {
      rtb_jxi = rtb_Gain_dg + rtB.Buffer_p;
      rtB.ADC_f = rtP.ADC_Interval_ky * muDoubleScalarRound((rtb_jxi/
        (rtP.ADC_Interval_ky)));
      rtB.m_SUN[0] = rtB.Constant_p[0];
      rtB.m_SUN[1] = rtB.Constant_p[1];
      rtB.m_SUN[2] = rtB.Constant_p[2];
      rtB.m_SUN[5] = rtB.Constant_pv[0];
      rtB.m_SUN[6] = rtB.Constant_pv[1];
      rtB.m_SUN[7] = rtB.Constant_pv[2];
      rtB.m_SUN[10] = rtB.Constant_b[0];
      rtB.m_SUN[11] = rtB.Constant_b[1];
      rtB.m_SUN[12] = rtB.Constant_b[2];
      rtB.m_SUN[15] = rtB.Constant_h[0];
      rtB.m_SUN[16] = rtB.Constant_h[1];
      rtB.m_SUN[17] = rtB.Constant_h[2];
      rtB.m_SUN[20] = rtB.Constant_l[0];
      rtB.m_SUN[21] = rtB.Constant_l[1];
      rtB.m_SUN[22] = rtB.Constant_l[2];
      rtB.m_SUN[25] = rtB.Constant_e[0];
      rtB.m_SUN[26] = rtB.Constant_e[1];
      rtB.m_SUN[27] = rtB.Constant_e[2];
      for (i = 0; i < 6; i++) {
        rtB.m_SUN[3 + 5 * i] = 0.0;
      }

      rtB.m_SUN[4] = rtB.ADC;
      rtB.m_SUN[9] = rtB.ADC_p;
      rtB.m_SUN[14] = rtB.ADC_pc;
      rtB.m_SUN[19] = rtB.ADC_i;
      rtB.m_SUN[24] = rtB.ADC_l;
      rtB.m_SUN[29] = rtB.ADC_f;
      for (i = 0; i < 6; i++) {
    ...
    if (ssIsSampleHit(rtS, 2, tid)) {
      {
        ...
        real_T time = ssGetTaskTime(rtS,tid);
        const real_T *pU = (NULL);
        const real_T *pT = (const real_T *) rtDWork.FromFile_PWORK_o.PrevTimePtr;
        if (initBasePtr == TRUE) {
          pStart = (real_T *) rtDWork.FromFile_PWORK_o.PrevTimePtr;
          initBasePtr = FALSE;
        }

        if (adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[4].
            nptsPerSignal == 1) {
          rtB.FromFile_k[0] = pT[1];
          rtB.FromFile_k[1] = pT[2];
          rtB.FromFile_k[2] = pT[3];
        } else {
          pU = pStart + adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[4]
            .nptsPerSignal - 2;
          if (time <= pStart[0]) {
            pT = pStart;
          } else if (time >= pU[0]) {
          ...
          rtDWork.FromFile_PWORK_o.PrevTimePtr = (void *) pT;
          pU = pT + adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[4].
            nptsPerSignal;
          if (pT[0] == pT[1]) {
            rtB.FromFile_k[0] = pU[ (time < pT[0]) ? 0 : 1 ];
            pU += adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[4].
              nptsPerSignal;
            rtB.FromFile_k[1] = pU[ (time < pT[0]) ? 0 : 1 ];
            pU += adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[4].
              nptsPerSignal;
            rtB.FromFile_k[2] = pU[ (time < pT[0]) ? 0 : 1 ];
          } else {
            real_T f = (pT[1]-time)/(pT[1]-pT[0]);
            if (pU[0] == pU[1]) {
              rtB.FromFile_k[0] = pU[0];
            } else {
              rtB.FromFile_k[0] = f*pU[0]+(1.0-f)*pU[1];
            }

            pU += adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[4].
              nptsPerSignal;
            if (pU[0] == pU[1]) {
              rtB.FromFile_k[1] = pU[0];
            } else {
              rtB.FromFile_k[1] = f*pU[0]+(1.0-f)*pU[1];
            }

            pU += adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[4].
              nptsPerSignal;
            if (pU[0] == pU[1]) {
              rtB.FromFile_k[2] = pU[0];
            } else {
              rtB.FromFile_k[2] = f*pU[0]+(1.0-f)*pU[1];
            }
          }
        }
      }

      {
        ...
        if (initBasePtr == TRUE) {
          pStart = (real_T *) rtDWork.FromFile2_PWORK_b.PrevTimePtr;
          initBasePtr = FALSE;
        }

        if (adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[5].
            nptsPerSignal == 1) {
          {
            int_T i1;
            real_T *y0 = rtB.FromFile2_b;
            for (i1=0; i1 < 6; i1++) {
              y0[i1] = pT[i1 + 1];
            }
          }
        } else {
          pU = pStart + adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[5]
            .nptsPerSignal - 2;
          if (time <= pStart[0]) {
            pT = pStart;
          } else if (time >= pU[0]) {
          ...
          rtDWork.FromFile2_PWORK_b.PrevTimePtr = (void *) pT;
          pU = pT + adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[5].
            nptsPerSignal;
          if (pT[0] == pT[1]) {
            {
              int_T i1;
              ...
              for (i1=0; i1 < 6; i1++) {
                y0[i1] = pU[ (time < pT[0]) ? 0 : 1 ];
                pU += adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[5].
                  nptsPerSignal;
              }
            }
          } else {
...

      {
        ...
        if (adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[6].
            nptsPerSignal == 1) {
          rtB.FromFile3[0] = pT[1];
          rtB.FromFile3[1] = pT[2];
          rtB.FromFile3[2] = pT[3];
        } else {
          pU = pStart + adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[6]
            .nptsPerSignal - 2;
          if (time <= pStart[0]) {
            pT = pStart;
          } else if (time >= pU[0]) {
          ...
          pU = pT + adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[6].
            nptsPerSignal;
          if (pT[0] == pT[1]) {
            rtB.FromFile3[0] = pU[ (time < pT[0]) ? 0 : 1 ];
            pU += adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[6].
              nptsPerSignal;
      ...
      eml_r[0] = rtB.FromFile2_b[0];
      eml_v[0] = rtB.FromFile2_b[3];
      eml_r[1] = rtB.FromFile2_b[1];
      eml_v[1] = rtB.FromFile2_b[4];
      eml_r[2] = rtB.FromFile2_b[2];
      eml_v[2] = rtB.FromFile2_b[5];
      eml_oy[0] = eml_v[1] * eml_r[2] - eml_v[2] * eml_r[1];
      eml_oy[1] = eml_v[2] * eml_r[0] - eml_v[0] * eml_r[2];
      eml_oy[2] = eml_v[0] * eml_r[1] - eml_v[1] * eml_r[0];
      eml_TIO_idx = muDoubleScalarSqrt
        (adcs_v15_integral_Power_no_charge_in_detumb_dot_l(eml_oy, eml_oy));
      eml_oy[0] /= eml_TIO_idx;
      eml_oy[1] /= eml_TIO_idx;
      eml_oy[2] /= eml_TIO_idx;
      eml_TIO_idx = muDoubleScalarSqrt
        (adcs_v15_integral_Power_no_charge_in_detumb_dot_l(eml_r, eml_r));
      ...
      eml_v[2] = eml_oy[0] * eml_r[1] - eml_oy[1] * eml_r[0];
      eml_TIO_idx = muDoubleScalarSqrt
        (adcs_v15_integral_Power_no_charge_in_detumb_dot_l(eml_v, eml_v));
      eml_v[0] /= eml_TIO_idx;
      eml_v[1] /= eml_TIO_idx;
      eml_v[2] /= eml_TIO_idx;
      eml_v_0[0] = eml_v[0];
      ...
      for (i = 0; i < 3; i++) {
        rtB.v_O_b[i] = 0.0;
        rtB.v_O_b[i] = eml_v_0[i] * rtB.FromFile3[0] + rtB.v_O_b[i];
        rtB.v_O_b[i] = eml_v_0[i + 3] * rtB.FromFile3[1] + rtB.v_O_b[i];
        rtB.v_O_b[i] = eml_v_0[i + 6] * rtB.FromFile3[2] + rtB.v_O_b[i];
        eml_r[i] = rtB.FromFile2_b[i];
        eml_v[i] = rtB.FromFile2_b[i + 3];
      }
      ...
      eml_oy[2] = eml_v[0] * eml_r[1] - eml_v[1] * eml_r[0];
      eml_TIO_idx = muDoubleScalarSqrt
        (adcs_v15_integral_Power_no_charge_in_detumb_dot_o(eml_oy, eml_oy));
      eml_oy[0] /= eml_TIO_idx;
      eml_oy[1] /= eml_TIO_idx;
      eml_oy[2] /= eml_TIO_idx;
      eml_TIO_idx = muDoubleScalarSqrt
        (adcs_v15_integral_Power_no_charge_in_detumb_dot_o(eml_r, eml_r));
      eml_r[0] = (-eml_r[0]) / eml_TIO_idx;
      eml_r[1] = (-eml_r[1]) / eml_TIO_idx;
      eml_r[2] = (-eml_r[2]) / eml_TIO_idx;
      eml_v[0] = eml_oy[1] * eml_r[2] - eml_oy[2] * eml_r[1];
      ...
      eml_v[2] = eml_oy[0] * eml_r[1] - eml_oy[1] * eml_r[0];
      eml_TIO_idx = muDoubleScalarSqrt
        (adcs_v15_integral_Power_no_charge_in_detumb_dot_o(eml_v, eml_v));
      eml_v[0] /= eml_TIO_idx;
      eml_v[1] /= eml_TIO_idx;
      eml_v[2] /= eml_TIO_idx;
      eml_v_0[0] = eml_v[0];
      ...
      for (i = 0; i < 3; i++) {
        rtB.v_O[i] = 0.0;
        rtB.v_O[i] = eml_v_0[i] * rtB.FromFile_k[0] + rtB.v_O[i];
        rtB.v_O[i] = eml_v_0[i + 3] * rtB.FromFile_k[1] + rtB.v_O[i];
        rtB.v_O[i] = eml_v_0[i + 6] * rtB.FromFile_k[2] + rtB.v_O[i];
      }

      adcs_v15_integral_Power_no_charge_in_detumb_QuEST();
    ...
    if (ssIsSampleHit(rtS, 2, tid)) {
      rtB.IntegerDelay1_k[0] = rtDWork.IntegerDelay1_X_f[0];
      rtB.IntegerDelay1_k[1] = rtDWork.IntegerDelay1_X_f[1];
      rtB.IntegerDelay1_k[2] = rtDWork.IntegerDelay1_X_f[2];
      rtB.IntegerDelay_l[0] = rtDWork.IntegerDelay_X_k[0];
      eml_q_idx = (rtB.q_BO_est[0] + rtB.IntegerDelay_l[0]) / 2.0;
      rtB.IntegerDelay_l[1] = rtDWork.IntegerDelay_X_k[1];
      eml_TIO_idx_0 = (rtB.q_BO_est[1] + rtB.IntegerDelay_l[1]) / 2.0;
      rtB.IntegerDelay_l[2] = rtDWork.IntegerDelay_X_k[2];
      eml_q_idx_0 = (rtB.q_BO_est[2] + rtB.IntegerDelay_l[2]) / 2.0;
      rtB.IntegerDelay_l[3] = rtDWork.IntegerDelay_X_k[3];
      eml_B = (rtB.q_BO_est[3] + rtB.IntegerDelay_l[3]) / 2.0;
      eml_r[0] = eml_q_idx;
      ...
      eml_TIO_idx_0 = (rtB.q_BO_est[0] - rtB.IntegerDelay_l[0]) /
        adcs_v15_integral_Power_no_charge_in_detumb_s_FRAME_SIZE;
      eml_q_idx_0 = (rtB.q_BO_est[1] - rtB.IntegerDelay_l[1]) /
        adcs_v15_integral_Power_no_charge_in_detumb_s_FRAME_SIZE;
      eml_TIO_idx = (rtB.q_BO_est[2] - rtB.IntegerDelay_l[2]) /
        adcs_v15_integral_Power_no_charge_in_detumb_s_FRAME_SIZE;
      for (i = 0; i < 3; i++) {
      ...
      for (i = 0; i < 3; i++) {
        rtB.w[i] = ((eml_v_0[i + 3] * eml_q_idx_0 + eml_v_0[i] * eml_TIO_idx_0)
                    + eml_v_0[i + 6] * eml_TIO_idx) / eml_B;
      }

      eml_x = 2.0 / (adcs_v15_integral_Power_no_charge_in_detumb_s_FRAME_SIZE +
                     rtP.SFunction_p2_l);
      ...
      rtB.IntegerDelay_e = rtDWork.IntegerDelay_X_p[0];
      rtB.y = (1.0 - rtB.light_est) + rtB.IntegerDelay_e;
      if (rtB.y > 1.0) {
        rtB.y = 1.0;
      }
    ...
    if (ssIsSampleHit(rtS, 2, tid)) {
      eml_TIO_idx_0 = (rtB.Product[0] * rtB.Product[0] + rtB.Product[1] *
                       rtB.Product[1]) + rtB.Product[2] * rtB.Product[2];
      if (eml_TIO_idx_0 < 0.0) {
        rtB.Fcn = -muDoubleScalarSqrt(-eml_TIO_idx_0);
      } else {
        rtB.Fcn = muDoubleScalarSqrt(eml_TIO_idx_0);
      }

      rtB.IntegerDelay_c[0] = rtDWork.IntegerDelay_X_o[0];
      rtB.dB[0] = (rtB.TmpRTBAtControlLawInport1[0] - rtB.IntegerDelay_c[0]) /
        adcs_v15_integral_Power_no_charge_in_detumb_s_FRAME_SIZE;
      rtB.B[0] = (rtB.TmpRTBAtControlLawInport1[0] + rtB.IntegerDelay_c[0]) /
        2.0;
      rtB.IntegerDelay_c[1] = rtDWork.IntegerDelay_X_o[1];
      rtB.dB[1] = (rtB.TmpRTBAtControlLawInport1[1] - rtB.IntegerDelay_c[1]) /
        adcs_v15_integral_Power_no_charge_in_detumb_s_FRAME_SIZE;
      rtB.B[1] = (rtB.TmpRTBAtControlLawInport1[1] + rtB.IntegerDelay_c[1]) /
        2.0;
      rtB.IntegerDelay_c[2] = rtDWork.IntegerDelay_X_o[2];
      rtB.dB[2] = (rtB.TmpRTBAtControlLawInport1[2] - rtB.IntegerDelay_c[2]) /
        adcs_v15_integral_Power_no_charge_in_detumb_s_FRAME_SIZE;
      rtB.B[2] = (rtB.TmpRTBAtControlLawInport1[2] + rtB.IntegerDelay_c[2]) /
        2.0;
      ...
      for (i = 0; i < 3; i++) {
        ...
        rtB.UnitDelay1[i] = rtDWork.UnitDelay1_DSTATE[i];
      }
      ...
      rtB.UnitDelay1_a = rtDWork.UnitDelay1_DSTATE_m;
    }
    ...
    if (ssIsSampleHit(rtS, 2, tid)) {
      ...
      eml_TIO_idx = (rtB.Product[0] * rtB.Product[0] + rtB.Product[1] *
                     rtB.Product[1]) + rtB.Product[2] * rtB.Product[2];
      eml_TIO_idx = muDoubleScalarSqrt(eml_TIO_idx);
      if ((eml_TIO_idx < adcs_v15_integral_Power_no_charge_in_detumb_tol_w) &&
      ...
      rtB.P[0] = (real_T)(muDoubleScalarAbs(rtB.q_BO_est[3]) >
                          adcs_v15_integral_Power_no_charge_in_detumb_tol_q4) +
        0.1;
      rtB.P[1] = (real_T)(eml_TIO_idx <
                          adcs_v15_integral_Power_no_charge_in_detumb_tol_w);
      rtB.P[2] = (real_T)(rtB.light_est * rtB.y == 1.0) + 0.3;
      rtB.N = rtB.UnitDelay1_a;
      ...
      if ((eml_b_2 == 1) && (rtB.UnitDelay1_a == 0.0)) {
        rtB.N = 1.0;
        rtB.t_now = rtB.TmpRTBAtgatepulseInport4;
      }

      if (((eml_TIO_idx > adcs_v15_integral_Power_no_charge_in_detumb_tolw_n2d) ==
           1) && (rtB.UnitDelay1_a == 1.0) && (rtB.TmpRTBAtgatepulseInport4 >
           rtB.UnitDelay +
           adcs_v15_integral_Power_no_charge_in_detumb_check_time)) {
        rtB.N = 0.0;
        rtB.t_now = rtB.TmpRTBAtgatepulseInport4;
      }

      if (rtB.N >= rtP.Switch_Threshold) {
        eml_r[0] = rtB.m_N[0];
        eml_r[1] = rtB.m_N[1];
        eml_r[2] = rtB.m_N[2];
      } else {
      ...
      eml_TIO_idx_0 = rtP.Gain1_Gain_g * rt_SATURATE(eml_r[0],
        rtP.MomentSaturation_LowerSat, rtP.MomentSaturation_UpperSat);
      eml_TIO_idx_0 = rt_SATURATE(eml_TIO_idx_0, rtP.PowerSaturation_LowerSat,
        rtP.PowerSaturation_UpperSat);
      eml_r[0] = eml_TIO_idx_0;
      eml_TIO_idx_0 = rtP.Gain1_Gain_g * rt_SATURATE(eml_r[1],
        rtP.MomentSaturation_LowerSat, rtP.MomentSaturation_UpperSat);
      eml_TIO_idx_0 = rt_SATURATE(eml_TIO_idx_0, rtP.PowerSaturation_LowerSat,
        rtP.PowerSaturation_UpperSat);
      eml_r[1] = eml_TIO_idx_0;
      eml_TIO_idx_0 = rtP.Gain1_Gain_g * rt_SATURATE(eml_r[2],
        rtP.MomentSaturation_LowerSat, rtP.MomentSaturation_UpperSat);
      eml_TIO_idx_0 = rt_SATURATE(eml_TIO_idx_0, rtP.PowerSaturation_LowerSat,
        rtP.PowerSaturation_UpperSat);
      eml_r[2] = eml_TIO_idx_0;
      if (ssIsSpecialSampleHit(rtS,4,2,tid)) {
      ...
      rtB.TorquerCurrentSaturation[0] = rt_SATURATE(eml_r[0],
        rtP.TorquerCurrentSaturation_LowerSat,
        rtP.TorquerCurrentSaturation_UpperSat);
      rtB.TorquerCurrentSaturation[1] = rt_SATURATE(eml_r[1],
        rtP.TorquerCurrentSaturation_LowerSat,
        rtP.TorquerCurrentSaturation_UpperSat);
      rtB.TorquerCurrentSaturation[2] = rt_SATURATE(eml_r[2],
        rtP.TorquerCurrentSaturation_LowerSat,
        rtP.TorquerCurrentSaturation_UpperSat);
      if (ssIsSpecialSampleHit(rtS,4,2,tid)) {
    ...
    if (ssIsContinuousTask(rtS, tid) && ssIsSpecialSampleHit(rtS,4,0,tid)) {
      rtB.TmpRTBAtToWorkspace12Inport1[0] = rtB.v_B_o[0];
      rtB.TmpRTBAtToWorkspace12Inport1[1] = rtB.v_B_o[1];
      rtB.TmpRTBAtToWorkspace12Inport1[2] = rtB.v_B_o[2];
    }
    ...
    if (ssIsContinuousTask(rtS, tid) && ssIsSpecialSampleHit(rtS,4,0,tid)) {
      rtB.TmpRTBAtToWorkspace20Inport1[0] = rtB.FromFile_p[0];
      rtB.TmpRTBAtToWorkspace20Inport1[1] = rtB.FromFile_p[1];
      rtB.TmpRTBAtToWorkspace20Inport1[2] = rtB.FromFile_p[2];
    }
    ...
    if (ssIsSampleHit(rtS, 2, tid) && ssIsSpecialSampleHit(rtS,4,2,tid)) {
      rtB.TmpRTBAtToWorkspace8Inport1[0] = rtB.v_O_b[0];
      rtB.TmpRTBAtToWorkspace8Inport1[1] = rtB.v_O_b[1];
      rtB.TmpRTBAtToWorkspace8Inport1[2] = rtB.v_O_b[2];
    }
    ...
    if (ssIsSampleHit(rtS, 1, tid)) {
      rtB.Gain_e[0] = rtP.Gain_Gain_l * rtP.Constant_Value_hq[0];
      rtB.Gain_e[1] = rtP.Gain_Gain_l * rtP.Constant_Value_hq[1];
      rtB.Gain_e[2] = rtP.Gain_Gain_l * rtP.Constant_Value_hq[2];
      eml_v_0[0] = muDoubleScalarCos(rtB.Gain_e[2]);
      eml_v_0[3] = muDoubleScalarSin(rtB.Gain_e[2]);
      eml_v_0[6] = 0.0;
      eml_v_0[1] = -muDoubleScalarSin(rtB.Gain_e[2]);
      eml_v_0[4] = muDoubleScalarCos(rtB.Gain_e[2]);
      eml_v_0[7] = 0.0;
      eml_v_0[2] = 0.0;
      eml_v_0[5] = 0.0;
      eml_v_0[8] = 1.0;
      eml_e[0] = muDoubleScalarCos(rtB.Gain_e[1]);
      eml_e[3] = 0.0;
      eml_e[6] = -muDoubleScalarSin(rtB.Gain_e[1]);
      eml_e[1] = 0.0;
      eml_e[4] = 1.0;
      eml_e[7] = 0.0;
      eml_e[2] = muDoubleScalarSin(rtB.Gain_e[1]);
      eml_e[5] = 0.0;
      eml_e[8] = muDoubleScalarCos(rtB.Gain_e[1]);
      for (i = 0; i < 3; i++) {
      ...
      eml_v_0[6] = 0.0;
      eml_v_0[1] = 0.0;
      eml_v_0[4] = muDoubleScalarCos(rtB.Gain_e[0]);
      eml_v_0[7] = muDoubleScalarSin(rtB.Gain_e[0]);
      eml_v_0[2] = 0.0;
      eml_v_0[5] = -muDoubleScalarSin(rtB.Gain_e[0]);
      eml_v_0[8] = muDoubleScalarCos(rtB.Gain_e[0]);
      for (i = 0; i < 3; i++) {
        for (tmp_1 = 0; tmp_1 < 3; tmp_1++) {
    ...
    if (ssIsContinuousTask(rtS, tid)) {
      for (i = 0; i < 3; i++) {
        rtb_Product_a[i] = 0.0;
        rtb_Product_a[i] += rtB.DCM[i] * rtB.TmpRTBAtProductInport2[0];
        rtb_Product_a[i] += rtB.DCM[i + 3] * rtB.TmpRTBAtProductInport2[1];
        rtb_Product_a[i] += rtB.DCM[i + 6] * rtB.TmpRTBAtProductInport2[2];
      }

      rtb_jxi = rtb_Product_a[1] * rtB.v_B_o[2];
      rtB.Sum_c[0] = rtb_jxi - rtb_Product_a[2] * rtB.v_B_o[1];
      rtB.Sum_c[1] = rtb_Product_a[2] * rtB.v_B_o[0] - rtb_Product_a[0] *
        rtB.v_B_o[2];
      rtB.Sum_c[2] = rtb_Product_a[0] * rtB.v_B_o[1] - rtb_Product_a[1] *
        rtB.v_B_o[0];
      if (ssIsSpecialSampleHit(rtS,4,0,tid)) {
        rtB.TmpRTBAtToWorkspace9Inport1[0] = rtB.Sum_c[0];
        rtB.TmpRTBAtToWorkspace9Inport1[1] = rtB.Sum_c[1];
        rtB.TmpRTBAtToWorkspace9Inport1[2] = rtB.Sum_c[2];
      }
    }
    ...
    if (ssIsContinuousTask(rtS, tid)) {
      ...
      for (i = 0; i < 3; i++) {
        rtB.v_B_k[i] = 0.0;
        rtB.v_B_k[i] = eml_v_0[i] * rtB.FromFile[3] + rtB.v_B_k[i];
        rtB.v_B_k[i] = eml_v_0[i + 3] * rtB.FromFile[4] + rtB.v_B_k[i];
        rtB.v_B_k[i] = eml_v_0[i + 6] * rtB.FromFile[5] + rtB.v_B_k[i];
      }

      eml_TIO_idx = muDoubleScalarSqrt
        (adcs_v15_integral_Power_no_charge_in_detumb_dot_g(&rtB.v_B_k[0],
          &rtB.v_B_k[0]));
      eml_r[0] = rtB.v_B_k[0] / eml_TIO_idx;
      eml_r[1] = rtB.v_B_k[1] / eml_TIO_idx;
      eml_r[2] = rtB.v_B_k[2] / eml_TIO_idx;
      eml_x = 0.0;
      ...
      for (i = 0; i < 6; i++) {
        ...
        eml_B = adcs_v15_integral_Power_no_charge_in_detumb_dot_g(eml_b_3, eml_r);
        if (eml_B > 0.0) {
          eml_x += eml_B;
        }
      }

      eml_TIO_idx = -0.5 * rtP.SFunction_p1 * rtB.Constant_j * eml_x *
    ...
    if (ssIsContinuousTask(rtS, tid)) {
      if (adcs_v15_integral_Power_no_charge_in_detumb_norm_l(&rtB.v_B[0]) == 0.0)
      {
        rtB.solar_drag[0] = 1.0;
        rtB.solar_drag[1] = 0.0;
        rtB.solar_drag[2] = 0.0;
      } else {
        eml_TIO_idx = adcs_v15_integral_Power_no_charge_in_detumb_norm_l
          (&rtB.v_B[0]);
      ...
      rtb_jxi = rtB.VectorfromCoMtoCoP_inBodyframeyettobefinalized2[1] *
        rtB.solar_drag[0];
      rtB.Sum_f[0] = rtB.VectorfromCoMtoCoP_inBodyframeyettobefinalized2[1] *
        rtB.solar_drag[2] - rtB.VectorfromCoMtoCoP_inBodyframeyettobefinalized2
        [2] * rtB.solar_drag[1];
      rtB.Sum_f[1] = rtB.VectorfromCoMtoCoP_inBodyframeyettobefinalized2[2] *
        rtB.solar_drag[0] - rtB.VectorfromCoMtoCoP_inBodyframeyettobefinalized2
        [0] * rtB.solar_drag[2];
      rtB.Sum_f[2] = rtB.VectorfromCoMtoCoP_inBodyframeyettobefinalized2[0] *
        rtB.solar_drag[1] - rtb_jxi;
      rtB.Sum_fb[0] = (rtB.tau[0] + rtB.u_aero[0]) + rtB.Sum_f[0];
      rtB.Sum_b[0] = rtB.Sum_fb[0] + rtB.Sum_c[0];
      eml_r[0] = rtB.xN[4];
      rtB.Sum_fb[1] = (rtB.tau[1] + rtB.u_aero[1]) + rtB.Sum_f[1];
      rtB.Sum_b[1] = rtB.Sum_fb[1] + rtB.Sum_c[1];
      eml_r[1] = rtB.xN[5];
      rtB.Sum_fb[2] = (rtB.tau[2] + rtB.u_aero[2]) + rtB.Sum_f[2];
      rtB.Sum_b[2] = rtB.Sum_fb[2] + rtB.Sum_c[2];
      eml_r[2] = rtB.xN[6];
      for (i = 0; i < 3; i++) {
      ...
      eml_TIO_idx_0 = rtB.Sum_b[0] - (eml_r[1] * eml_b_1[2] - eml_r[2] *
        eml_b_1[1]);
      eml_q_idx_0 = rtB.Sum_b[1] - (eml_r[2] * eml_b_1[0] - eml_r[0] * eml_b_1[2]);
      eml_TIO_idx = rtB.Sum_b[2] - (eml_r[0] * eml_b_1[1] - eml_r[1] * eml_b_1[0]);
      for (i = 0; i < 4; i++) {
        eml_x = tmp_2[i + 12] * rtB.xN[3] + (tmp_2[i + 8] * rtB.xN[2] + (tmp_2[i
          + 4] * rtB.xN[1] + tmp_2[i] * rtB.xN[0]));
        tmp_3[i] = eml_x;
      }

      for (i = 0; i < 3; i++) {
        eml_r[i] = tmp_6[i + 6] * eml_TIO_idx + (tmp_6[i + 3] * eml_q_idx_0 +
          tmp_6[i] * eml_TIO_idx_0);
      }
    ...
    if (ssIsContinuousTask(rtS, tid) && ssIsSpecialSampleHit(rtS,3,0,tid)) {
      rtB.TmpRTBAtw_real2Inport1[0] = rtB.Sum_fb[0];
      rtB.TmpRTBAtw_real2Inport1[1] = rtB.Sum_fb[1];
      rtB.TmpRTBAtw_real2Inport1[2] = rtB.Sum_fb[2];
    }
    ...
    if (ssIsContinuousTask(rtS, tid) && ssIsSpecialSampleHit(rtS,3,0,tid)) {
      rtB.TmpRTBAtw_real4Inport1[0] = rtB.Sum_f[0];
      rtB.TmpRTBAtw_real4Inport1[1] = rtB.Sum_f[1];
      rtB.TmpRTBAtw_real4Inport1[2] = rtB.Sum_f[2];
    }
    ...
    if (ssIsSampleHit(rtS, 1, tid)) {
      rtB.Constant_jw[0] = rtP.Constant_Value_m0[0];
      rtB.Constant_jw[1] = rtP.Constant_Value_m0[1];
      rtB.Constant_jw[2] = rtP.Constant_Value_m0[2];
    }

    if (ssIsContinuousTask(rtS, tid)) {
      eml_TIO_idx = ((rtB.Constant_jw[0] * rtB.v_B[0] + rtB.Constant_jw[1] *
                      rtB.v_B[1]) + rtB.Constant_jw[2] * rtB.v_B[2]) *
        rtB.FromFile2;
      rtB.Gain_c = rtP.Gain1_Gain * rt_SATURATE(eml_TIO_idx,
        rtP.Saturation_LowerSat_f, rtP.Saturation_UpperSat_p) * rtP.Gain_Gain_e;
    }

    if (ssIsSampleHit(rtS, 1, tid)) {
      rtB.Constant_g[0] = rtP.Constant_Value_jc[0];
      rtB.Constant_g[1] = rtP.Constant_Value_jc[1];
      rtB.Constant_g[2] = rtP.Constant_Value_jc[2];
    }

    if (ssIsContinuousTask(rtS, tid)) {
      eml_TIO_idx = ((rtB.Constant_g[0] * rtB.v_B[0] + rtB.Constant_g[1] *
                      rtB.v_B[1]) + rtB.Constant_g[2] * rtB.v_B[2]) *
        rtB.FromFile2;
      rtB.Gain_m = rtP.Gain1_Gain_e * rt_SATURATE(eml_TIO_idx,
        rtP.Saturation_LowerSat_e, rtP.Saturation_UpperSat_jz) * rtP.Gain_Gain_m;
    }

    if (ssIsSampleHit(rtS, 1, tid)) {
      rtB.Constant_m[0] = rtP.Constant_Value_l[0];
      rtB.Constant_m[1] = rtP.Constant_Value_l[1];
      rtB.Constant_m[2] = rtP.Constant_Value_l[2];
    }
    ...
    if (ssIsContinuousTask(rtS, tid)) {
      eml_TIO_idx = ((rtB.Constant_m[0] * rtB.v_B[0] + rtB.Constant_m[1] *
        ...
        rtB.FromFile2;
      rtB.Gain_d = rtP.Gain1_Gain_b * rt_SATURATE(eml_TIO_idx,
        rtP.Saturation_LowerSat_m, rtP.Saturation_UpperSat_m) * rtP.Gain_Gain_g;
    }

    if (ssIsSampleHit(rtS, 1, tid)) {
      rtB.Constant_bd[0] = rtP.Constant_Value_mv[0];
      rtB.Constant_bd[1] = rtP.Constant_Value_mv[1];
      rtB.Constant_bd[2] = rtP.Constant_Value_mv[2];
    }

    if (ssIsContinuousTask(rtS, tid)) {
      eml_TIO_idx = ((rtB.Constant_bd[0] * rtB.v_B[0] + rtB.Constant_bd[1] *
                      rtB.v_B[1]) + rtB.Constant_bd[2] * rtB.v_B[2]) *
        rtB.FromFile2;
      rtB.Gain_f = rtP.Gain1_Gain_d * rt_SATURATE(eml_TIO_idx,
        rtP.Saturation_LowerSat_j, rtP.Saturation_UpperSat_g4) * rtP.Gain_Gain_j;
    }

    if (ssIsSampleHit(rtS, 1, tid)) {
      rtB.Constant_a[0] = rtP.Constant_Value_gp[0];
      rtB.Constant_a[1] = rtP.Constant_Value_gp[1];
      rtB.Constant_a[2] = rtP.Constant_Value_gp[2];
    }
    ...
    if (ssIsContinuousTask(rtS, tid)) {
      eml_TIO_idx = ((rtB.Constant_a[0] * rtB.v_B[0] + rtB.Constant_a[1] *
        ...
        rtB.FromFile2;
      rtB.Gain_ck = rtP.Gain1_Gain_be * rt_SATURATE(eml_TIO_idx,
        rtP.Saturation_LowerSat_gk, rtP.Saturation_UpperSat_i) * rtP.Gain_Gain_p;
    }

    if (ssIsSampleHit(rtS, 1, tid)) {
      rtB.Constant_bw[0] = rtP.Constant_Value_d1[0];
      rtB.Constant_bw[1] = rtP.Constant_Value_d1[1];
      rtB.Constant_bw[2] = rtP.Constant_Value_d1[2];
    }

    if (ssIsContinuousTask(rtS, tid)) {
      eml_TIO_idx = ((rtB.Constant_bw[0] * rtB.v_B[0] + rtB.Constant_bw[1] *
                      rtB.v_B[1]) + rtB.Constant_bw[2] * rtB.v_B[2]) *
        rtB.FromFile2;
      rtB.Gain_n = rtP.Gain1_Gain_n * rt_SATURATE(eml_TIO_idx,
        rtP.Saturation_LowerSat_mo, rtP.Saturation_UpperSat_a) * rtP.Gain_Gain_h;
      if (ssIsSpecialSampleHit(rtS,4,0,tid)) {
        rtB.TmpRTBAtScope11Inport1[0] = rtB.Gain_c;
        rtB.TmpRTBAtScope11Inport1[1] = rtB.Gain_m;
        rtB.TmpRTBAtScope11Inport1[2] = rtB.Gain_d;
        rtB.TmpRTBAtScope11Inport1[3] = rtB.Gain_f;
        rtB.TmpRTBAtScope11Inport1[4] = rtB.Gain_ck;
        rtB.TmpRTBAtScope11Inport1[5] = rtB.Gain_n;
      }
    }
    ...
    if (ssIsContinuousTask(rtS, tid)) {
      rtB.Gain1[0] = rtP.Gain1_Gain_p * rtB.Gain_c;
      rtB.Gain1[1] = rtP.Gain1_Gain_p * rtB.Gain_m;
      rtB.Gain1[2] = rtP.Gain1_Gain_p * rtB.Gain_d;
      rtB.Gain1[3] = rtP.Gain1_Gain_p * rtB.Gain_f;
      rtB.Gain1[4] = rtP.Gain1_Gain_p * rtB.Gain_ck;
      rtB.Gain1[5] = rtP.Gain1_Gain_p * rtB.Gain_n;
      if (ssIsSpecialSampleHit(rtS,4,0,tid)) {
        for (i = 0; i < 6; i++) {
    ...
    if (ssIsSampleHit(rtS, 1, tid) && ssIsSpecialSampleHit(rtS,2,1,tid)) {
      rtB.TmpRTBAtProductInport2_l = rtDWork.TmpRTBAtProductInport2_Buffer0_p;
    }

    if (ssIsContinuousTask(rtS, tid)) {
      rtb_Product = rtB.AddingSolarPower * rtB.TmpRTBAtProductInport2_l;
    }
    ...
    if (ssIsSampleHit(rtS, 1, tid)) {
      ...
      if (ssIsSpecialSampleHit(rtS,2,1,tid)) {
        rtB.TmpRTBAtProduct1Inport1 = rtDWork.TmpRTBAtProduct1Inport1_Buffer0;
      }
    }
    ...
    if (ssIsContinuousTask(rtS, tid)) {
      ...
      eml_TIO_idx = adcs_v15_integral_Power_no_charge_in_detumb_norm_j
        (&rtB.r_ECEF[0]);
      ...
      rtB.Downlink_power = (real_T)i * 3.5;
      ...
      rtB.AddingPowerConsumed = ((((((rtB.PowerDistributionLosses +
        ...
        rtB.TmpRTBAtProduct1Inport1 * rtB.Downlink_power;
      ...
      rtB.AddingSolarPower1 = rtb_Product - rtB.pow_drawn;
      rtB.Gain2_i = rtP.Gain2_Gain_a * rtB.AddingSolarPower1;
      if (ssIsSpecialSampleHit(rtS,4,0,tid)) {
        rtB.TmpRTBAtScope13Inport1 = rtB.Gain2_i;
      }
    }
    ...
    if (ssIsContinuousTask(rtS, tid)) {
      if (rtB.Clock_m < 0.15) {
        rtB.Batt_cap = 2000.0;
        rtB.current = 0.0;
        rtB.VBat = adcs_v15_integral_Power_no_charge_in_detumb_isro_battery
          (200.0, 0.0, 0.08);
      } else if (rtB.Gain2_i < 0.0) {
        rtB.current = rtB.Gain2_i / (rtP.SFunction_p1_c * 2.0 *
          rtB.IntegerDelay4);
        rtB.Batt_cap = rtB.Gain2_i / (21.6 * rtB.IntegerDelay4) +
          rtB.IntegerDelay3;
        rtB.VBat = adcs_v15_integral_Power_no_charge_in_detumb_isro_battery
    ...
    if (ssIsSampleHit(rtS, 1, tid)) {
      ...
      if (ssGetLogOutput(rtS)) {
        rt_UpdateLogVar((LogVar *)(LogVar*)
                        (rtDWork.ToWorkspace2_PWORK_j.LoggedData), &rtB.Clock2,
                        0);
      }

      if (ssGetLogOutput(rtS)) {
        rt_UpdateLogVar((LogVar *)(LogVar*)
                        (rtDWork.ToWorkspace3_PWORK_m.LoggedData), &rtB.VBat, 0);
      }
    }

    if (ssIsContinuousTask(rtS, tid)) {
      rtB.Gain_ca = rtP.Gain_Gain_gr * rtB.Gain2_i;
    }

    if (ssIsSampleHit(rtS, 1, tid)) {
      if (ssGetLogOutput(rtS)) {
        rt_UpdateLogVar((LogVar *)(LogVar*)
                        (rtDWork.ToWorkspace4_PWORK_a.LoggedData), &rtB.Gain_ca,
                        0);
      }

      {
        ...
        if (ssGetLogOutput(rtS)) {
          rt_UpdateLogVar((LogVar *)(LogVar*)
                          rtDWork.ToWorkspace5_PWORK_i.LoggedData, u, 0);
        }
      }
    }
    ...
    if (ssIsContinuousTask(rtS, tid)) {
      rtB.Integrator_h = rtX.Integrator_CSTATE_c;
    }
...
{
  {
    ...
    if (ssIsSampleHit(rtS, 2, tid)) {
      rtDWork.IntegerDelay1_X_f[0] = rtB.w_l[0];
      rtDWork.IntegerDelay1_X_f[1] = rtB.w_l[1];
      rtDWork.IntegerDelay1_X_f[2] = rtB.w_l[2];
      rtDWork.IntegerDelay_X_k[0] = rtB.q_BO_est[0];
      rtDWork.IntegerDelay_X_k[1] = rtB.q_BO_est[1];
      rtDWork.IntegerDelay_X_k[2] = rtB.q_BO_est[2];
      rtDWork.IntegerDelay_X_k[3] = rtB.q_BO_est[3];
      for (loopVar_i = 0; loopVar_i < 299; loopVar_i++) {
        rtDWork.IntegerDelay_X_p[loopVar_i] = rtDWork.IntegerDelay_X_p[loopVar_i
          + 1];
      }

      rtDWork.IntegerDelay_X_p[299] = rtB.light_est;
    }

    if (ssIsSampleHit(rtS, 2, tid)) {
      rtDWork.UnitDelay1_DSTATE_m = rtB.N;
      rtDWork.UnitDelay_DSTATE = rtB.t_now;
      rtDWork.IntegerDelay_X_o[0] = rtB.TmpRTBAtControlLawInport1[0];
      rtDWork.UnitDelay1_DSTATE[0] = rtB.ieu[0];
      rtDWork.TmpRTBAtProductInport2_Buffer0[0] = rtB.Gain2[0];
      rtDWork.IntegerDelay_X_o[1] = rtB.TmpRTBAtControlLawInport1[1];
      rtDWork.UnitDelay1_DSTATE[1] = rtB.ieu[1];
      rtDWork.TmpRTBAtProductInport2_Buffer0[1] = rtB.Gain2[1];
      rtDWork.IntegerDelay_X_o[2] = rtB.TmpRTBAtControlLawInport1[2];
      rtDWork.UnitDelay1_DSTATE[2] = rtB.ieu[2];
      rtDWork.TmpRTBAtProductInport2_Buffer0[2] = rtB.Gain2[2];
    }

    if (ssIsSampleHit(rtS, 2, tid)) {
      rtDWork.TmpRTBAtProductInport2_Buffer0_p = rtB.N;
    }
    ...
    if (ssIsSampleHit(rtS, 2, tid)) {
      rtDWork.TmpRTBAtProduct1Inport1_Buffer0 = rtB.N;
    }
...
{
  {
    ...
    ((StateDerivatives *) ssGetdX(rtS))->Integrator_CSTATE_c = rtB.current;
  }
}
...
{
  if (adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[0].tuDataMatrix !=
      (NULL)) {
    rt_FREE(adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[0].
            tuDataMatrix);
  }

  if (adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[1].tuDataMatrix !=
      (NULL)) {
    rt_FREE(adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[1].
            tuDataMatrix);
  }

  if (adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[2].tuDataMatrix !=
      (NULL)) {
    rt_FREE(adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[2].
            tuDataMatrix);
  }

  if (adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[3].tuDataMatrix !=
      (NULL)) {
    rt_FREE(adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[3].
            tuDataMatrix);
  }

  if (adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[4].tuDataMatrix !=
      (NULL)) {
    rt_FREE(adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[4].
            tuDataMatrix);
  }

  if (adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[5].tuDataMatrix !=
      (NULL)) {
    rt_FREE(adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[5].
            tuDataMatrix);
  }

  if (adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[6].tuDataMatrix !=
      (NULL)) {
    rt_FREE(adcs_v15_integral_Power_no_charge_in_detumb_gblFrFInfo[6].
            tuDataMatrix);
  }
...
void MdlInitializeSizes(void)
{
  ...
  ssSetNumBlocks(rtS, 357);
  ssSetNumBlockIO(rtS, 184);
  ssSetNumBlockParams(rtS, 191);
}
...
{
  ssSetChecksumVal(rtS, 0, 724027781U);
  ssSetChecksumVal(rtS, 1, 3795845936U);
  ssSetChecksumVal(rtS, 2, 3972618117U);
  ssSetChecksumVal(rtS, 3, 3137835255U);
}
...
SimStruct * raccel_register_model(void)
{
  ...
  ssSetModelName(rtS, "adcs_v15_integral_Power_no_charge_in_detumb");
  ssSetPath(rtS, "adcs_v15_integral_Power_no_charge_in_detumb");
  ssSetTStart(rtS, 0.0);
  ...
  {
    {
      ...
      static const char_T *rt_LoggedStateBlockNames[] = {
        "adcs_v15_integral_Power_no_charge_in_detumb/Integrator",
        "adcs_v15_integral_Power_no_charge_in_detumb/PowerD0D/battery_DOD/Integrator",
        "adcs_v15_integral_Power_no_charge_in_detumb/PowerD0D/Integer Delay",
        "adcs_v15_integral_Power_no_charge_in_detumb/PowerD0D/Integer Delay3",
        "adcs_v15_integral_Power_no_charge_in_detumb/PowerD0D/Integer Delay2",
        "adcs_v15_integral_Power_no_charge_in_detumb/PowerD0D/Integer Delay1",
        "adcs_v15_integral_Power_no_charge_in_detumb/PowerD0D/Integer Delay4",
        "adcs_v15_integral_Power_no_charge_in_detumb/q -> w/Integer Delay1",
        "adcs_v15_integral_Power_no_charge_in_detumb/q -> w/Integer Delay",
        "adcs_v15_integral_Power_no_charge_in_detumb/q -> w/Subsystem6/Integer Delay",
        "adcs_v15_integral_Power_no_charge_in_detumb/Control Law/Integer Delay",
        "adcs_v15_integral_Power_no_charge_in_detumb/Control Law/Unit Delay1",
        "adcs_v15_integral_Power_no_charge_in_detumb/Control Law/Switching Algorithm/Unit Delay1",
        "adcs_v15_integral_Power_no_charge_in_detumb/Control Law/Switching Algorithm/Unit Delay"
      };
      ...
      rt_LoggedStateSignalPtrs[1] = (void*)&rtX.Integrator_CSTATE_c;
      ...
      rt_LoggedStateSignalPtrs[7] = (void*)&rtDWork.IntegerDelay1_X_f[0];
      rt_LoggedStateSignalPtrs[8] = (void*)&rtDWork.IntegerDelay_X_k[0];
      rt_LoggedStateSignalPtrs[9] = (void*)&rtDWork.IntegerDelay_X_p[0];
      rt_LoggedStateSignalPtrs[10] = (void*)&rtDWork.IntegerDelay_X_o[0];
      rt_LoggedStateSignalPtrs[11] = (void*)&rtDWork.UnitDelay1_DSTATE[0];
      rt_LoggedStateSignalPtrs[12] = (void*)&rtDWork.UnitDelay1_DSTATE_m;
  ...
  rtP.Saturation_UpperSat_lo = rtInf;
  rtP.Saturation_UpperSat_g = rtInf;
  rtP.Saturation_UpperSat_j = rtInf;
  rtP.Saturation_UpperSat_e = rtInf;
  return rtS;
}
